...
FlagComment_200_response::FlagComment_200_response()
{
    m_StatusCode = 0;
...
void FlagComment_200_response::validate()
{
    // TODO: implement validation
}

web::json::value FlagComment_200_response::toJson() const
{
...
bool FlagComment_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void FlagComment_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FlagComment_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
int32_t FlagComment_200_response::getStatusCode() const
{
    return m_StatusCode;
}

void FlagComment_200_response::setStatusCode(int32_t value)
{
    m_StatusCode = value;
    m_StatusCodeIsSet = true;
}

bool FlagComment_200_response::statusCodeIsSet() const
{
    return m_StatusCodeIsSet;
}

void FlagComment_200_response::unsetStatusCode()
{
    m_StatusCodeIsSet = false;
}
...
bool FlagComment_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void FlagComment_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t FlagComment_200_response::getCode() const
{
    return m_Code;
}


void FlagComment_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool FlagComment_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void FlagComment_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t FlagComment_200_response::getReason() const
{
    return m_Reason;
}


void FlagComment_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool FlagComment_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void FlagComment_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
bool FlagComment_200_response::isWasUnapproved() const
{
    return m_WasUnapproved;
}

void FlagComment_200_response::setWasUnapproved(bool value)
{
    m_WasUnapproved = value;
    m_WasUnapprovedIsSet = true;
}

bool FlagComment_200_response::wasUnapprovedIsSet() const
{
    return m_WasUnapprovedIsSet;
}

void FlagComment_200_response::unsetWasUnapproved()
{
    m_WasUnapprovedIsSet = false;
}
utility::string_t FlagComment_200_response::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void FlagComment_200_response::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool FlagComment_200_response::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void FlagComment_200_response::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t FlagComment_200_response::getBannedUntil() const
{
    return m_BannedUntil;
}

void FlagComment_200_response::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool FlagComment_200_response::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void FlagComment_200_response::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t FlagComment_200_response::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void FlagComment_200_response::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool FlagComment_200_response::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void FlagComment_200_response::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t FlagComment_200_response::getTranslatedError() const
{
    return m_TranslatedError;
}


void FlagComment_200_response::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool FlagComment_200_response::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void FlagComment_200_response::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> FlagComment_200_response::getCustomConfig() const
{
    return m_CustomConfig;
}


void FlagComment_200_response::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool FlagComment_200_response::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void FlagComment_200_response::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
