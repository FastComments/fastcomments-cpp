...
CreateFeedPostResponse_1::CreateFeedPostResponse_1()
{
    m_StatusIsSet = false;
...
void CreateFeedPostResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value CreateFeedPostResponse_1::toJson() const
{
...
bool CreateFeedPostResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateFeedPostResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateFeedPostResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> CreateFeedPostResponse_1::getStatus() const
{
    return m_Status;
}


void CreateFeedPostResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CreateFeedPostResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void CreateFeedPostResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<FeedPost> CreateFeedPostResponse_1::getFeedPost() const
{
    return m_FeedPost;
}


void CreateFeedPostResponse_1::setFeedPost(const std::shared_ptr<FeedPost>& value)
{
    m_FeedPost = value;
    m_FeedPostIsSet = true;
}

bool CreateFeedPostResponse_1::feedPostIsSet() const
{
    return m_FeedPostIsSet;
}

void CreateFeedPostResponse_1::unsetFeedPost()
{
    m_FeedPostIsSet = false;
}
utility::string_t CreateFeedPostResponse_1::getReason() const
{
    return m_Reason;
}


void CreateFeedPostResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CreateFeedPostResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CreateFeedPostResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CreateFeedPostResponse_1::getCode() const
{
    return m_Code;
}


void CreateFeedPostResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CreateFeedPostResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void CreateFeedPostResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CreateFeedPostResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CreateFeedPostResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CreateFeedPostResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CreateFeedPostResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CreateFeedPostResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void CreateFeedPostResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CreateFeedPostResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CreateFeedPostResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CreateFeedPostResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CreateFeedPostResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CreateFeedPostResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CreateFeedPostResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CreateFeedPostResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void CreateFeedPostResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CreateFeedPostResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CreateFeedPostResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CreateFeedPostResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void CreateFeedPostResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CreateFeedPostResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CreateFeedPostResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
