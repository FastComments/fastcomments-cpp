...
GetCommentChildrenResponse::GetCommentChildrenResponse()
{
...
void GetCommentChildrenResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetCommentChildrenResponse::toJson() const
{
...
bool GetCommentChildrenResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetCommentChildrenResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetCommentChildrenResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<ModerationAPIComment>> GetCommentChildrenResponse::getComments() const
{
    return m_Comments;
}


void GetCommentChildrenResponse::setComments(const std::vector<std::shared_ptr<ModerationAPIComment>>& value)
{
    m_Comments = value;
    m_CommentsIsSet = true;
}

bool GetCommentChildrenResponse::commentsIsSet() const
{
    return m_CommentsIsSet;
}

void GetCommentChildrenResponse::unsetComments()
{
    m_CommentsIsSet = false;
}
std::shared_ptr<APIStatus> GetCommentChildrenResponse::getStatus() const
{
    return m_Status;
}


void GetCommentChildrenResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetCommentChildrenResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetCommentChildrenResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetCommentChildrenResponse::getReason() const
{
    return m_Reason;
}


void GetCommentChildrenResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetCommentChildrenResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetCommentChildrenResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetCommentChildrenResponse::getCode() const
{
    return m_Code;
}


void GetCommentChildrenResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetCommentChildrenResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetCommentChildrenResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetCommentChildrenResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetCommentChildrenResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetCommentChildrenResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetCommentChildrenResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetCommentChildrenResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetCommentChildrenResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetCommentChildrenResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetCommentChildrenResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetCommentChildrenResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetCommentChildrenResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetCommentChildrenResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetCommentChildrenResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetCommentChildrenResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetCommentChildrenResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetCommentChildrenResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetCommentChildrenResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetCommentChildrenResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetCommentChildrenResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetCommentChildrenResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetCommentChildrenResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
