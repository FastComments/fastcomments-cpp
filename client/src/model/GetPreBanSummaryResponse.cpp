...
GetPreBanSummaryResponse::GetPreBanSummaryResponse()
{
    m_StatusIsSet = false;
...
void GetPreBanSummaryResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetPreBanSummaryResponse::toJson() const
{
...
bool GetPreBanSummaryResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetPreBanSummaryResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetPreBanSummaryResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetPreBanSummaryResponse::getStatus() const
{
    return m_Status;
}


void GetPreBanSummaryResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetPreBanSummaryResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetPreBanSummaryResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<utility::string_t> GetPreBanSummaryResponse::getUsernames() const
{
    return m_Usernames;
}


void GetPreBanSummaryResponse::setUsernames(const std::vector<utility::string_t>& value)
{
    m_Usernames = value;
    m_UsernamesIsSet = true;
}

bool GetPreBanSummaryResponse::usernamesIsSet() const
{
    return m_UsernamesIsSet;
}

void GetPreBanSummaryResponse::unsetUsernames()
{
    m_UsernamesIsSet = false;
}
double GetPreBanSummaryResponse::getCount() const
{
    return m_Count;
}

void GetPreBanSummaryResponse::setCount(double value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool GetPreBanSummaryResponse::countIsSet() const
{
    return m_CountIsSet;
}

void GetPreBanSummaryResponse::unsetCount()
{
    m_CountIsSet = false;
}
utility::string_t GetPreBanSummaryResponse::getReason() const
{
    return m_Reason;
}


void GetPreBanSummaryResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetPreBanSummaryResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetPreBanSummaryResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetPreBanSummaryResponse::getCode() const
{
    return m_Code;
}


void GetPreBanSummaryResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetPreBanSummaryResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetPreBanSummaryResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetPreBanSummaryResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetPreBanSummaryResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetPreBanSummaryResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetPreBanSummaryResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetPreBanSummaryResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetPreBanSummaryResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetPreBanSummaryResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetPreBanSummaryResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetPreBanSummaryResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetPreBanSummaryResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetPreBanSummaryResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetPreBanSummaryResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetPreBanSummaryResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetPreBanSummaryResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetPreBanSummaryResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetPreBanSummaryResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetPreBanSummaryResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetPreBanSummaryResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetPreBanSummaryResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetPreBanSummaryResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
