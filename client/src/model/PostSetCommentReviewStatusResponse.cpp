...
PostSetCommentReviewStatusResponse::PostSetCommentReviewStatusResponse()
{
    m_StatusIsSet = false;
...
void PostSetCommentReviewStatusResponse::validate()
{
    // TODO: implement validation
}

web::json::value PostSetCommentReviewStatusResponse::toJson() const
{
...
bool PostSetCommentReviewStatusResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PostSetCommentReviewStatusResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PostSetCommentReviewStatusResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> PostSetCommentReviewStatusResponse::getStatus() const
{
    return m_Status;
}


void PostSetCommentReviewStatusResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PostSetCommentReviewStatusResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PostSetCommentReviewStatusResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PostSetCommentReviewStatusResponse::getReason() const
{
    return m_Reason;
}


void PostSetCommentReviewStatusResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PostSetCommentReviewStatusResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PostSetCommentReviewStatusResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PostSetCommentReviewStatusResponse::getCode() const
{
    return m_Code;
}


void PostSetCommentReviewStatusResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PostSetCommentReviewStatusResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PostSetCommentReviewStatusResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PostSetCommentReviewStatusResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PostSetCommentReviewStatusResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PostSetCommentReviewStatusResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PostSetCommentReviewStatusResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PostSetCommentReviewStatusResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PostSetCommentReviewStatusResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PostSetCommentReviewStatusResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PostSetCommentReviewStatusResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PostSetCommentReviewStatusResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PostSetCommentReviewStatusResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PostSetCommentReviewStatusResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PostSetCommentReviewStatusResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PostSetCommentReviewStatusResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PostSetCommentReviewStatusResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PostSetCommentReviewStatusResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PostSetCommentReviewStatusResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PostSetCommentReviewStatusResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PostSetCommentReviewStatusResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PostSetCommentReviewStatusResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PostSetCommentReviewStatusResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
