...
GetUserBanPreferenceResponse::GetUserBanPreferenceResponse()
{
    m_StatusIsSet = false;
...
void GetUserBanPreferenceResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetUserBanPreferenceResponse::toJson() const
{
...
bool GetUserBanPreferenceResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetUserBanPreferenceResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetUserBanPreferenceResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIModerateUserBanPreferences> GetUserBanPreferenceResponse::getPreferences() const
{
    return m_Preferences.get();
}


void GetUserBanPreferenceResponse::setPreferences(const std::shared_ptr<APIModerateUserBanPreferences>& value)
{
    m_Preferences = value;
}

bool GetUserBanPreferenceResponse::preferencesIsSet() const
{
    return m_Preferences.has_value();
}

void GetUserBanPreferenceResponse::unsetPreferences()
{
    m_Preferences.reset();
}
std::shared_ptr<APIStatus> GetUserBanPreferenceResponse::getStatus() const
{
    return m_Status;
}


void GetUserBanPreferenceResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetUserBanPreferenceResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetUserBanPreferenceResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetUserBanPreferenceResponse::getReason() const
{
    return m_Reason;
}


void GetUserBanPreferenceResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetUserBanPreferenceResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetUserBanPreferenceResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetUserBanPreferenceResponse::getCode() const
{
    return m_Code;
}


void GetUserBanPreferenceResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetUserBanPreferenceResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetUserBanPreferenceResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetUserBanPreferenceResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetUserBanPreferenceResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetUserBanPreferenceResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetUserBanPreferenceResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetUserBanPreferenceResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetUserBanPreferenceResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetUserBanPreferenceResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetUserBanPreferenceResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetUserBanPreferenceResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetUserBanPreferenceResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetUserBanPreferenceResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetUserBanPreferenceResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetUserBanPreferenceResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetUserBanPreferenceResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetUserBanPreferenceResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetUserBanPreferenceResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetUserBanPreferenceResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetUserBanPreferenceResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetUserBanPreferenceResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetUserBanPreferenceResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
