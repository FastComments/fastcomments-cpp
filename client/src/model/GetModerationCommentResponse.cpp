...
GetModerationCommentResponse::GetModerationCommentResponse()
{
...
void GetModerationCommentResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetModerationCommentResponse::toJson() const
{
...
bool GetModerationCommentResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetModerationCommentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetModerationCommentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ModerationAPIComment> GetModerationCommentResponse::getComment() const
{
    return m_Comment;
}


void GetModerationCommentResponse::setComment(const std::shared_ptr<ModerationAPIComment>& value)
{
    m_Comment = value;
    m_CommentIsSet = true;
}

bool GetModerationCommentResponse::commentIsSet() const
{
    return m_CommentIsSet;
}

void GetModerationCommentResponse::unsetComment()
{
    m_CommentIsSet = false;
}
std::shared_ptr<APIStatus> GetModerationCommentResponse::getStatus() const
{
    return m_Status;
}


void GetModerationCommentResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetModerationCommentResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetModerationCommentResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetModerationCommentResponse::getReason() const
{
    return m_Reason;
}


void GetModerationCommentResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetModerationCommentResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetModerationCommentResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetModerationCommentResponse::getCode() const
{
    return m_Code;
}


void GetModerationCommentResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetModerationCommentResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetModerationCommentResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetModerationCommentResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetModerationCommentResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetModerationCommentResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetModerationCommentResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetModerationCommentResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetModerationCommentResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetModerationCommentResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetModerationCommentResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetModerationCommentResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetModerationCommentResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetModerationCommentResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetModerationCommentResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetModerationCommentResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetModerationCommentResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetModerationCommentResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetModerationCommentResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetModerationCommentResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetModerationCommentResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetModerationCommentResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetModerationCommentResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
