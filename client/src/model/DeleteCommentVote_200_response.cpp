...
std::shared_ptr<APIStatus> DeleteCommentVote_200_response::getStatus() const
{
    return m_Status;
}


void DeleteCommentVote_200_response::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
