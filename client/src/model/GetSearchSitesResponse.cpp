...
GetSearchSitesResponse::GetSearchSitesResponse()
{
    m_SitesIsSet = false;
    m_StatusIsSet = false;
...
void GetSearchSitesResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetSearchSitesResponse::toJson() const
{
...
bool GetSearchSitesResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetSearchSitesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetSearchSitesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<ModerationSiteSearchProjected>> GetSearchSitesResponse::getSites() const
{
    return m_Sites;
}


void GetSearchSitesResponse::setSites(const std::vector<std::shared_ptr<ModerationSiteSearchProjected>>& value)
{
    m_Sites = value;
    m_SitesIsSet = true;
}

bool GetSearchSitesResponse::sitesIsSet() const
{
    return m_SitesIsSet;
}

void GetSearchSitesResponse::unsetSites()
{
    m_SitesIsSet = false;
}
std::shared_ptr<APIStatus> GetSearchSitesResponse::getStatus() const
{
    return m_Status;
}


void GetSearchSitesResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetSearchSitesResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetSearchSitesResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetSearchSitesResponse::getReason() const
{
    return m_Reason;
}


void GetSearchSitesResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetSearchSitesResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetSearchSitesResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetSearchSitesResponse::getCode() const
{
    return m_Code;
}


void GetSearchSitesResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetSearchSitesResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetSearchSitesResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetSearchSitesResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetSearchSitesResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetSearchSitesResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetSearchSitesResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetSearchSitesResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetSearchSitesResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetSearchSitesResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetSearchSitesResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetSearchSitesResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetSearchSitesResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetSearchSitesResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetSearchSitesResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetSearchSitesResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetSearchSitesResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetSearchSitesResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetSearchSitesResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetSearchSitesResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetSearchSitesResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetSearchSitesResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetSearchSitesResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
