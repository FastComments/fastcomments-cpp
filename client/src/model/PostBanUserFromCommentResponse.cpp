...
PostBanUserFromCommentResponse::PostBanUserFromCommentResponse()
{
    m_StatusIsSet = false;
...
void PostBanUserFromCommentResponse::validate()
{
    // TODO: implement validation
}

web::json::value PostBanUserFromCommentResponse::toJson() const
{
...
bool PostBanUserFromCommentResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PostBanUserFromCommentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PostBanUserFromCommentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> PostBanUserFromCommentResponse::getStatus() const
{
    return m_Status;
}


void PostBanUserFromCommentResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PostBanUserFromCommentResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PostBanUserFromCommentResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<APIBanUserChangeLog> PostBanUserFromCommentResponse::getChangelog() const
{
    return m_Changelog;
}


void PostBanUserFromCommentResponse::setChangelog(const std::shared_ptr<APIBanUserChangeLog>& value)
{
    m_Changelog = value;
    m_ChangelogIsSet = true;
}

bool PostBanUserFromCommentResponse::changelogIsSet() const
{
    return m_ChangelogIsSet;
}

void PostBanUserFromCommentResponse::unsetChangelog()
{
    m_ChangelogIsSet = false;
}
utility::string_t PostBanUserFromCommentResponse::getCode() const
{
    return m_Code;
}


void PostBanUserFromCommentResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PostBanUserFromCommentResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PostBanUserFromCommentResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PostBanUserFromCommentResponse::getReason() const
{
    return m_Reason;
}


void PostBanUserFromCommentResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PostBanUserFromCommentResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PostBanUserFromCommentResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PostBanUserFromCommentResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PostBanUserFromCommentResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PostBanUserFromCommentResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PostBanUserFromCommentResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PostBanUserFromCommentResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PostBanUserFromCommentResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PostBanUserFromCommentResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PostBanUserFromCommentResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PostBanUserFromCommentResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PostBanUserFromCommentResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PostBanUserFromCommentResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PostBanUserFromCommentResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PostBanUserFromCommentResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PostBanUserFromCommentResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PostBanUserFromCommentResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PostBanUserFromCommentResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PostBanUserFromCommentResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PostBanUserFromCommentResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PostBanUserFromCommentResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PostBanUserFromCommentResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
