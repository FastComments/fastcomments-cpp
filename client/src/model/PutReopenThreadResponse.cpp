...
PutReopenThreadResponse::PutReopenThreadResponse()
{
    m_StatusIsSet = false;
...
void PutReopenThreadResponse::validate()
{
    // TODO: implement validation
}

web::json::value PutReopenThreadResponse::toJson() const
{
...
bool PutReopenThreadResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PutReopenThreadResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PutReopenThreadResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> PutReopenThreadResponse::getStatus() const
{
    return m_Status;
}


void PutReopenThreadResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PutReopenThreadResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PutReopenThreadResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PutReopenThreadResponse::getReason() const
{
    return m_Reason;
}


void PutReopenThreadResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PutReopenThreadResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PutReopenThreadResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PutReopenThreadResponse::getCode() const
{
    return m_Code;
}


void PutReopenThreadResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PutReopenThreadResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PutReopenThreadResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PutReopenThreadResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PutReopenThreadResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PutReopenThreadResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PutReopenThreadResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PutReopenThreadResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PutReopenThreadResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PutReopenThreadResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PutReopenThreadResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PutReopenThreadResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PutReopenThreadResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PutReopenThreadResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PutReopenThreadResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PutReopenThreadResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PutReopenThreadResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PutReopenThreadResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PutReopenThreadResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PutReopenThreadResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PutReopenThreadResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PutReopenThreadResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PutReopenThreadResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
