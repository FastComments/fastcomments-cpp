...
GetEmailTemplate_200_response::GetEmailTemplate_200_response()
{
    m_StatusIsSet = false;
...
void GetEmailTemplate_200_response::validate()
{
    // TODO: implement validation
}

web::json::value GetEmailTemplate_200_response::toJson() const
{
...
bool GetEmailTemplate_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetEmailTemplate_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetEmailTemplate_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetEmailTemplate_200_response::getStatus() const
{
    return m_Status;
}


void GetEmailTemplate_200_response::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetEmailTemplate_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetEmailTemplate_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<CustomEmailTemplate> GetEmailTemplate_200_response::getEmailTemplate() const
{
    return m_EmailTemplate;
}


void GetEmailTemplate_200_response::setEmailTemplate(const std::shared_ptr<CustomEmailTemplate>& value)
{
    m_EmailTemplate = value;
    m_EmailTemplateIsSet = true;
}

bool GetEmailTemplate_200_response::emailTemplateIsSet() const
{
    return m_EmailTemplateIsSet;
}

void GetEmailTemplate_200_response::unsetEmailTemplate()
{
    m_EmailTemplateIsSet = false;
}
utility::string_t GetEmailTemplate_200_response::getReason() const
{
    return m_Reason;
}


void GetEmailTemplate_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetEmailTemplate_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetEmailTemplate_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetEmailTemplate_200_response::getCode() const
{
    return m_Code;
}


void GetEmailTemplate_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetEmailTemplate_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetEmailTemplate_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetEmailTemplate_200_response::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetEmailTemplate_200_response::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetEmailTemplate_200_response::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetEmailTemplate_200_response::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetEmailTemplate_200_response::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetEmailTemplate_200_response::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetEmailTemplate_200_response::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetEmailTemplate_200_response::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetEmailTemplate_200_response::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetEmailTemplate_200_response::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetEmailTemplate_200_response::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetEmailTemplate_200_response::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetEmailTemplate_200_response::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetEmailTemplate_200_response::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetEmailTemplate_200_response::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetEmailTemplate_200_response::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetEmailTemplate_200_response::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetEmailTemplate_200_response::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetEmailTemplate_200_response::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetEmailTemplate_200_response::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
