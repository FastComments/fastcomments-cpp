...
BulkAggregateQuestionResultsResponse_1::BulkAggregateQuestionResultsResponse_1()
{
    m_StatusIsSet = false;
    m_DataIsSet = false;
...
void BulkAggregateQuestionResultsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value BulkAggregateQuestionResultsResponse_1::toJson() const
{
...
bool BulkAggregateQuestionResultsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BulkAggregateQuestionResultsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BulkAggregateQuestionResultsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> BulkAggregateQuestionResultsResponse_1::getStatus() const
{
    return m_Status;
}


void BulkAggregateQuestionResultsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool BulkAggregateQuestionResultsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void BulkAggregateQuestionResultsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<QuestionResultAggregationOverall>> BulkAggregateQuestionResultsResponse_1::getData() const
{
    return m_Data;
}


void BulkAggregateQuestionResultsResponse_1::setData(const std::map<utility::string_t, std::shared_ptr<QuestionResultAggregationOverall>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool BulkAggregateQuestionResultsResponse_1::dataIsSet() const
{
    return m_DataIsSet;
}

void BulkAggregateQuestionResultsResponse_1::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t BulkAggregateQuestionResultsResponse_1::getReason() const
{
    return m_Reason;
}


void BulkAggregateQuestionResultsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool BulkAggregateQuestionResultsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void BulkAggregateQuestionResultsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t BulkAggregateQuestionResultsResponse_1::getCode() const
{
    return m_Code;
}


void BulkAggregateQuestionResultsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool BulkAggregateQuestionResultsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void BulkAggregateQuestionResultsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t BulkAggregateQuestionResultsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void BulkAggregateQuestionResultsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool BulkAggregateQuestionResultsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void BulkAggregateQuestionResultsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t BulkAggregateQuestionResultsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void BulkAggregateQuestionResultsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool BulkAggregateQuestionResultsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void BulkAggregateQuestionResultsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t BulkAggregateQuestionResultsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void BulkAggregateQuestionResultsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool BulkAggregateQuestionResultsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void BulkAggregateQuestionResultsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t BulkAggregateQuestionResultsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void BulkAggregateQuestionResultsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool BulkAggregateQuestionResultsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void BulkAggregateQuestionResultsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> BulkAggregateQuestionResultsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void BulkAggregateQuestionResultsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool BulkAggregateQuestionResultsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void BulkAggregateQuestionResultsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
