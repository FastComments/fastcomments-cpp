...
PinCommentResponse::PinCommentResponse()
{
...
void PinCommentResponse::validate()
{
    // TODO: implement validation
}

web::json::value PinCommentResponse::toJson() const
{
...
bool PinCommentResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PinCommentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PinCommentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::map<utility::string_t, std::shared_ptr<Record_string__before_string_or_null__after_string_or_null___value>> PinCommentResponse::getCommentPositions() const
{
    return m_CommentPositions;
}


void PinCommentResponse::setCommentPositions(const std::map<utility::string_t, std::shared_ptr<Record_string__before_string_or_null__after_string_or_null___value>>& value)
{
    m_CommentPositions = value;
    m_CommentPositionsIsSet = true;
}

bool PinCommentResponse::commentPositionsIsSet() const
{
    return m_CommentPositionsIsSet;
}

void PinCommentResponse::unsetCommentPositions()
{
    m_CommentPositionsIsSet = false;
}
std::shared_ptr<APIStatus> PinCommentResponse::getStatus() const
{
    return m_Status;
}


void PinCommentResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PinCommentResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PinCommentResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PinCommentResponse::getReason() const
{
    return m_Reason;
}


void PinCommentResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PinCommentResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PinCommentResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PinCommentResponse::getCode() const
{
    return m_Code;
}


void PinCommentResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PinCommentResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PinCommentResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PinCommentResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PinCommentResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PinCommentResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PinCommentResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PinCommentResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PinCommentResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PinCommentResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PinCommentResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PinCommentResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PinCommentResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PinCommentResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PinCommentResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PinCommentResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PinCommentResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PinCommentResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PinCommentResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PinCommentResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PinCommentResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PinCommentResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PinCommentResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
