...
GetTrustFactorResponse::GetTrustFactorResponse()
{
...
void GetTrustFactorResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetTrustFactorResponse::toJson() const
{
...
bool GetTrustFactorResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetTrustFactorResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetTrustFactorResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
double GetTrustFactorResponse::getManualTrustFactor() const
{
    return m_ManualTrustFactor;
}

void GetTrustFactorResponse::setManualTrustFactor(double value)
{
    m_ManualTrustFactor = value;
    m_ManualTrustFactorIsSet = true;
}

bool GetTrustFactorResponse::manualTrustFactorIsSet() const
{
    return m_ManualTrustFactorIsSet;
}

void GetTrustFactorResponse::unsetManualTrustFactor()
{
    m_ManualTrustFactorIsSet = false;
}
double GetTrustFactorResponse::getAutoTrustFactor() const
{
    return m_AutoTrustFactor;
}

void GetTrustFactorResponse::setAutoTrustFactor(double value)
{
    m_AutoTrustFactor = value;
    m_AutoTrustFactorIsSet = true;
}

bool GetTrustFactorResponse::autoTrustFactorIsSet() const
{
    return m_AutoTrustFactorIsSet;
}

void GetTrustFactorResponse::unsetAutoTrustFactor()
{
    m_AutoTrustFactorIsSet = false;
}
std::shared_ptr<APIStatus> GetTrustFactorResponse::getStatus() const
{
    return m_Status;
}


void GetTrustFactorResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetTrustFactorResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetTrustFactorResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetTrustFactorResponse::getReason() const
{
    return m_Reason;
}


void GetTrustFactorResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetTrustFactorResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetTrustFactorResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetTrustFactorResponse::getCode() const
{
    return m_Code;
}


void GetTrustFactorResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetTrustFactorResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetTrustFactorResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetTrustFactorResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetTrustFactorResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetTrustFactorResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetTrustFactorResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetTrustFactorResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetTrustFactorResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetTrustFactorResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetTrustFactorResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetTrustFactorResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetTrustFactorResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetTrustFactorResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetTrustFactorResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetTrustFactorResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetTrustFactorResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetTrustFactorResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetTrustFactorResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetTrustFactorResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetTrustFactorResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetTrustFactorResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetTrustFactorResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
