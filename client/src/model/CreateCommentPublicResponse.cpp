...
CreateCommentPublicResponse::CreateCommentPublicResponse()
{
    m_StatusIsSet = false;
...
void CreateCommentPublicResponse::validate()
{
    // TODO: implement validation
}

web::json::value CreateCommentPublicResponse::toJson() const
{
...
bool CreateCommentPublicResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateCommentPublicResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateCommentPublicResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> CreateCommentPublicResponse::getStatus() const
{
    return m_Status;
}


void CreateCommentPublicResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CreateCommentPublicResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void CreateCommentPublicResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<PublicComment> CreateCommentPublicResponse::getComment() const
{
    return m_Comment;
}


void CreateCommentPublicResponse::setComment(const std::shared_ptr<PublicComment>& value)
{
    m_Comment = value;
    m_CommentIsSet = true;
}

bool CreateCommentPublicResponse::commentIsSet() const
{
    return m_CommentIsSet;
}

void CreateCommentPublicResponse::unsetComment()
{
    m_CommentIsSet = false;
}
std::shared_ptr<UserSessionInfo> CreateCommentPublicResponse::getUser() const
{
    return m_User.get();
}


void CreateCommentPublicResponse::setUser(const std::shared_ptr<UserSessionInfo>& value)
{
    m_User = value;
}

bool CreateCommentPublicResponse::userIsSet() const
{
    return m_User.has_value();
}

void CreateCommentPublicResponse::unsetUser()
{
    m_User.reset();
}
std::map<utility::string_t, std::shared_ptr<Object>> CreateCommentPublicResponse::getModuleData() const
{
    return m_ModuleData;
}


void CreateCommentPublicResponse::setModuleData(const std::map<utility::string_t, std::shared_ptr<Object>>& value)
{
    m_ModuleData = value;
    m_ModuleDataIsSet = true;
}

bool CreateCommentPublicResponse::moduleDataIsSet() const
{
    return m_ModuleDataIsSet;
}

void CreateCommentPublicResponse::unsetModuleData()
{
    m_ModuleDataIsSet = false;
}
utility::string_t CreateCommentPublicResponse::getUserIdWS() const
{
    return m_UserIdWS;
}


void CreateCommentPublicResponse::setUserIdWS(const utility::string_t& value)
{
    m_UserIdWS = value;
    m_UserIdWSIsSet = true;
}

bool CreateCommentPublicResponse::userIdWSIsSet() const
{
    return m_UserIdWSIsSet;
}

void CreateCommentPublicResponse::unsetUserIdWS()
{
    m_UserIdWSIsSet = false;
}
utility::string_t CreateCommentPublicResponse::getReason() const
{
    return m_Reason;
}


void CreateCommentPublicResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CreateCommentPublicResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CreateCommentPublicResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CreateCommentPublicResponse::getCode() const
{
    return m_Code;
}


void CreateCommentPublicResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CreateCommentPublicResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void CreateCommentPublicResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CreateCommentPublicResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CreateCommentPublicResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CreateCommentPublicResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CreateCommentPublicResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CreateCommentPublicResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void CreateCommentPublicResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CreateCommentPublicResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CreateCommentPublicResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CreateCommentPublicResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CreateCommentPublicResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CreateCommentPublicResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CreateCommentPublicResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CreateCommentPublicResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void CreateCommentPublicResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CreateCommentPublicResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CreateCommentPublicResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CreateCommentPublicResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void CreateCommentPublicResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CreateCommentPublicResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CreateCommentPublicResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
