...
GetTenantsResponse_1::GetTenantsResponse_1()
{
    m_StatusIsSet = false;
...
void GetTenantsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetTenantsResponse_1::toJson() const
{
...
bool GetTenantsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetTenantsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetTenantsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetTenantsResponse_1::getStatus() const
{
    return m_Status;
}


void GetTenantsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetTenantsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetTenantsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<APITenant>> GetTenantsResponse_1::getTenants() const
{
    return m_Tenants;
}


void GetTenantsResponse_1::setTenants(const std::vector<std::shared_ptr<APITenant>>& value)
{
    m_Tenants = value;
    m_TenantsIsSet = true;
}

bool GetTenantsResponse_1::tenantsIsSet() const
{
    return m_TenantsIsSet;
}

void GetTenantsResponse_1::unsetTenants()
{
    m_TenantsIsSet = false;
}
utility::string_t GetTenantsResponse_1::getReason() const
{
    return m_Reason;
}


void GetTenantsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetTenantsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetTenantsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetTenantsResponse_1::getCode() const
{
    return m_Code;
}


void GetTenantsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetTenantsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetTenantsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetTenantsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetTenantsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetTenantsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetTenantsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetTenantsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetTenantsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetTenantsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetTenantsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetTenantsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetTenantsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetTenantsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetTenantsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetTenantsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetTenantsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetTenantsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetTenantsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetTenantsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetTenantsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetTenantsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetTenantsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
