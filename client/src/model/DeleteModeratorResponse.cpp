...
DeleteModeratorResponse::DeleteModeratorResponse()
{
    m_StatusIsSet = false;
...
void DeleteModeratorResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteModeratorResponse::toJson() const
{
...
bool DeleteModeratorResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteModeratorResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteModeratorResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteModeratorResponse::getStatus() const
{
    return m_Status;
}


void DeleteModeratorResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteModeratorResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteModeratorResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteModeratorResponse::getReason() const
{
    return m_Reason;
}


void DeleteModeratorResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteModeratorResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteModeratorResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteModeratorResponse::getCode() const
{
    return m_Code;
}


void DeleteModeratorResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteModeratorResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteModeratorResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteModeratorResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteModeratorResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteModeratorResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteModeratorResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteModeratorResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteModeratorResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteModeratorResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteModeratorResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteModeratorResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteModeratorResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteModeratorResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteModeratorResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteModeratorResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteModeratorResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteModeratorResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteModeratorResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteModeratorResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteModeratorResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteModeratorResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteModeratorResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
