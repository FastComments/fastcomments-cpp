...
GetTenantPackageResponse_1::GetTenantPackageResponse_1()
{
    m_StatusIsSet = false;
...
void GetTenantPackageResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetTenantPackageResponse_1::toJson() const
{
...
bool GetTenantPackageResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetTenantPackageResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetTenantPackageResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetTenantPackageResponse_1::getStatus() const
{
    return m_Status;
}


void GetTenantPackageResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetTenantPackageResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetTenantPackageResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<TenantPackage> GetTenantPackageResponse_1::getTenantPackage() const
{
    return m_TenantPackage;
}


void GetTenantPackageResponse_1::setTenantPackage(const std::shared_ptr<TenantPackage>& value)
{
    m_TenantPackage = value;
    m_TenantPackageIsSet = true;
}

bool GetTenantPackageResponse_1::tenantPackageIsSet() const
{
    return m_TenantPackageIsSet;
}

void GetTenantPackageResponse_1::unsetTenantPackage()
{
    m_TenantPackageIsSet = false;
}
utility::string_t GetTenantPackageResponse_1::getReason() const
{
    return m_Reason;
}


void GetTenantPackageResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetTenantPackageResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetTenantPackageResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetTenantPackageResponse_1::getCode() const
{
    return m_Code;
}


void GetTenantPackageResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetTenantPackageResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetTenantPackageResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetTenantPackageResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetTenantPackageResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetTenantPackageResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetTenantPackageResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetTenantPackageResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetTenantPackageResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetTenantPackageResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetTenantPackageResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetTenantPackageResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetTenantPackageResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetTenantPackageResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetTenantPackageResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetTenantPackageResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetTenantPackageResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetTenantPackageResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetTenantPackageResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetTenantPackageResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetTenantPackageResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetTenantPackageResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetTenantPackageResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
