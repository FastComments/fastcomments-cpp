...
AggregateQuestionResultsResponse_1::AggregateQuestionResultsResponse_1()
{
    m_StatusIsSet = false;
    m_DataIsSet = false;
...
void AggregateQuestionResultsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value AggregateQuestionResultsResponse_1::toJson() const
{
...
bool AggregateQuestionResultsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AggregateQuestionResultsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AggregateQuestionResultsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> AggregateQuestionResultsResponse_1::getStatus() const
{
    return m_Status;
}


void AggregateQuestionResultsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AggregateQuestionResultsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void AggregateQuestionResultsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<QuestionResultAggregationOverall> AggregateQuestionResultsResponse_1::getData() const
{
    return m_Data;
}


void AggregateQuestionResultsResponse_1::setData(const std::shared_ptr<QuestionResultAggregationOverall>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool AggregateQuestionResultsResponse_1::dataIsSet() const
{
    return m_DataIsSet;
}

void AggregateQuestionResultsResponse_1::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t AggregateQuestionResultsResponse_1::getReason() const
{
    return m_Reason;
}


void AggregateQuestionResultsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool AggregateQuestionResultsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void AggregateQuestionResultsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t AggregateQuestionResultsResponse_1::getCode() const
{
    return m_Code;
}


void AggregateQuestionResultsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool AggregateQuestionResultsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void AggregateQuestionResultsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t AggregateQuestionResultsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void AggregateQuestionResultsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool AggregateQuestionResultsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void AggregateQuestionResultsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t AggregateQuestionResultsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void AggregateQuestionResultsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool AggregateQuestionResultsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void AggregateQuestionResultsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t AggregateQuestionResultsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void AggregateQuestionResultsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool AggregateQuestionResultsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void AggregateQuestionResultsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t AggregateQuestionResultsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void AggregateQuestionResultsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool AggregateQuestionResultsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void AggregateQuestionResultsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> AggregateQuestionResultsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void AggregateQuestionResultsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool AggregateQuestionResultsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void AggregateQuestionResultsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
