...
CreateTenantResponse_1::CreateTenantResponse_1()
{
    m_StatusIsSet = false;
    m_TenantIsSet = false;
...
void CreateTenantResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value CreateTenantResponse_1::toJson() const
{
...
bool CreateTenantResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateTenantResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateTenantResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> CreateTenantResponse_1::getStatus() const
{
    return m_Status;
}


void CreateTenantResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CreateTenantResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void CreateTenantResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<APITenant> CreateTenantResponse_1::getTenant() const
{
    return m_Tenant;
}


void CreateTenantResponse_1::setTenant(const std::shared_ptr<APITenant>& value)
{
    m_Tenant = value;
    m_TenantIsSet = true;
}

bool CreateTenantResponse_1::tenantIsSet() const
{
    return m_TenantIsSet;
}

void CreateTenantResponse_1::unsetTenant()
{
    m_TenantIsSet = false;
}
utility::string_t CreateTenantResponse_1::getReason() const
{
    return m_Reason;
}


void CreateTenantResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CreateTenantResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CreateTenantResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CreateTenantResponse_1::getCode() const
{
    return m_Code;
}


void CreateTenantResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CreateTenantResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void CreateTenantResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CreateTenantResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CreateTenantResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CreateTenantResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CreateTenantResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CreateTenantResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void CreateTenantResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CreateTenantResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CreateTenantResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CreateTenantResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CreateTenantResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CreateTenantResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CreateTenantResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CreateTenantResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void CreateTenantResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CreateTenantResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CreateTenantResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CreateTenantResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void CreateTenantResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CreateTenantResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CreateTenantResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
