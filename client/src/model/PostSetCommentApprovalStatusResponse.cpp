...
PostSetCommentApprovalStatusResponse::PostSetCommentApprovalStatusResponse()
{
...
void PostSetCommentApprovalStatusResponse::validate()
{
    // TODO: implement validation
}

web::json::value PostSetCommentApprovalStatusResponse::toJson() const
{
...
bool PostSetCommentApprovalStatusResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PostSetCommentApprovalStatusResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PostSetCommentApprovalStatusResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool PostSetCommentApprovalStatusResponse::isDidResetFlaggedCount() const
{
    return m_DidResetFlaggedCount;
}

void PostSetCommentApprovalStatusResponse::setDidResetFlaggedCount(bool value)
{
    m_DidResetFlaggedCount = value;
    m_DidResetFlaggedCountIsSet = true;
}

bool PostSetCommentApprovalStatusResponse::didResetFlaggedCountIsSet() const
{
    return m_DidResetFlaggedCountIsSet;
}

void PostSetCommentApprovalStatusResponse::unsetDidResetFlaggedCount()
{
    m_DidResetFlaggedCountIsSet = false;
}
std::shared_ptr<APIStatus> PostSetCommentApprovalStatusResponse::getStatus() const
{
    return m_Status;
}


void PostSetCommentApprovalStatusResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PostSetCommentApprovalStatusResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PostSetCommentApprovalStatusResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PostSetCommentApprovalStatusResponse::getReason() const
{
    return m_Reason;
}


void PostSetCommentApprovalStatusResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PostSetCommentApprovalStatusResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PostSetCommentApprovalStatusResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PostSetCommentApprovalStatusResponse::getCode() const
{
    return m_Code;
}


void PostSetCommentApprovalStatusResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PostSetCommentApprovalStatusResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PostSetCommentApprovalStatusResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PostSetCommentApprovalStatusResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PostSetCommentApprovalStatusResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PostSetCommentApprovalStatusResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PostSetCommentApprovalStatusResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PostSetCommentApprovalStatusResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PostSetCommentApprovalStatusResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PostSetCommentApprovalStatusResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PostSetCommentApprovalStatusResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PostSetCommentApprovalStatusResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PostSetCommentApprovalStatusResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PostSetCommentApprovalStatusResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PostSetCommentApprovalStatusResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PostSetCommentApprovalStatusResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PostSetCommentApprovalStatusResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PostSetCommentApprovalStatusResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PostSetCommentApprovalStatusResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PostSetCommentApprovalStatusResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PostSetCommentApprovalStatusResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PostSetCommentApprovalStatusResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PostSetCommentApprovalStatusResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
