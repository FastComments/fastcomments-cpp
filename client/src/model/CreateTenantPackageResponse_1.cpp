...
CreateTenantPackageResponse_1::CreateTenantPackageResponse_1()
{
    m_StatusIsSet = false;
...
void CreateTenantPackageResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value CreateTenantPackageResponse_1::toJson() const
{
...
bool CreateTenantPackageResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateTenantPackageResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateTenantPackageResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> CreateTenantPackageResponse_1::getStatus() const
{
    return m_Status;
}


void CreateTenantPackageResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CreateTenantPackageResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void CreateTenantPackageResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<TenantPackage> CreateTenantPackageResponse_1::getTenantPackage() const
{
    return m_TenantPackage;
}


void CreateTenantPackageResponse_1::setTenantPackage(const std::shared_ptr<TenantPackage>& value)
{
    m_TenantPackage = value;
    m_TenantPackageIsSet = true;
}

bool CreateTenantPackageResponse_1::tenantPackageIsSet() const
{
    return m_TenantPackageIsSet;
}

void CreateTenantPackageResponse_1::unsetTenantPackage()
{
    m_TenantPackageIsSet = false;
}
utility::string_t CreateTenantPackageResponse_1::getReason() const
{
    return m_Reason;
}


void CreateTenantPackageResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CreateTenantPackageResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CreateTenantPackageResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CreateTenantPackageResponse_1::getCode() const
{
    return m_Code;
}


void CreateTenantPackageResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CreateTenantPackageResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void CreateTenantPackageResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CreateTenantPackageResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CreateTenantPackageResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CreateTenantPackageResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CreateTenantPackageResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CreateTenantPackageResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void CreateTenantPackageResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CreateTenantPackageResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CreateTenantPackageResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CreateTenantPackageResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CreateTenantPackageResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CreateTenantPackageResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CreateTenantPackageResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CreateTenantPackageResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void CreateTenantPackageResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CreateTenantPackageResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CreateTenantPackageResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CreateTenantPackageResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void CreateTenantPackageResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CreateTenantPackageResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CreateTenantPackageResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
