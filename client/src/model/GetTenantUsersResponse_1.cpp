...
GetTenantUsersResponse_1::GetTenantUsersResponse_1()
{
    m_StatusIsSet = false;
...
void GetTenantUsersResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetTenantUsersResponse_1::toJson() const
{
...
bool GetTenantUsersResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetTenantUsersResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetTenantUsersResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetTenantUsersResponse_1::getStatus() const
{
    return m_Status;
}


void GetTenantUsersResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetTenantUsersResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetTenantUsersResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<User>> GetTenantUsersResponse_1::getTenantUsers() const
{
    return m_TenantUsers;
}


void GetTenantUsersResponse_1::setTenantUsers(const std::vector<std::shared_ptr<User>>& value)
{
    m_TenantUsers = value;
    m_TenantUsersIsSet = true;
}

bool GetTenantUsersResponse_1::tenantUsersIsSet() const
{
    return m_TenantUsersIsSet;
}

void GetTenantUsersResponse_1::unsetTenantUsers()
{
    m_TenantUsersIsSet = false;
}
utility::string_t GetTenantUsersResponse_1::getReason() const
{
    return m_Reason;
}


void GetTenantUsersResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetTenantUsersResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetTenantUsersResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetTenantUsersResponse_1::getCode() const
{
    return m_Code;
}


void GetTenantUsersResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetTenantUsersResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetTenantUsersResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetTenantUsersResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetTenantUsersResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetTenantUsersResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetTenantUsersResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetTenantUsersResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetTenantUsersResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetTenantUsersResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetTenantUsersResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetTenantUsersResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetTenantUsersResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetTenantUsersResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetTenantUsersResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetTenantUsersResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetTenantUsersResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetTenantUsersResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetTenantUsersResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetTenantUsersResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetTenantUsersResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetTenantUsersResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetTenantUsersResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
