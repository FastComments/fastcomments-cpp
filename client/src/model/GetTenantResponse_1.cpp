...
GetTenantResponse_1::GetTenantResponse_1()
{
    m_StatusIsSet = false;
    m_TenantIsSet = false;
...
void GetTenantResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetTenantResponse_1::toJson() const
{
...
bool GetTenantResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetTenantResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetTenantResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetTenantResponse_1::getStatus() const
{
    return m_Status;
}


void GetTenantResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetTenantResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetTenantResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<APITenant> GetTenantResponse_1::getTenant() const
{
    return m_Tenant;
}


void GetTenantResponse_1::setTenant(const std::shared_ptr<APITenant>& value)
{
    m_Tenant = value;
    m_TenantIsSet = true;
}

bool GetTenantResponse_1::tenantIsSet() const
{
    return m_TenantIsSet;
}

void GetTenantResponse_1::unsetTenant()
{
    m_TenantIsSet = false;
}
utility::string_t GetTenantResponse_1::getReason() const
{
    return m_Reason;
}


void GetTenantResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetTenantResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetTenantResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetTenantResponse_1::getCode() const
{
    return m_Code;
}


void GetTenantResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetTenantResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetTenantResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetTenantResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetTenantResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetTenantResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetTenantResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetTenantResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetTenantResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetTenantResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetTenantResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetTenantResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetTenantResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetTenantResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetTenantResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetTenantResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetTenantResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetTenantResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetTenantResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetTenantResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetTenantResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetTenantResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetTenantResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
