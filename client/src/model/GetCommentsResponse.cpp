...
void GetCommentsResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetCommentsResponse::toJson() const
{
...
bool GetCommentsResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetCommentsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetCommentsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetCommentsResponse::getStatus() const
{
    return m_Status;
}


void GetCommentsResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetCommentsResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetCommentsResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<APIComment>> GetCommentsResponse::getComments() const
{
    return m_Comments;
}


void GetCommentsResponse::setComments(const std::vector<std::shared_ptr<APIComment>>& value)
{
    m_Comments = value;
    m_CommentsIsSet = true;
}

bool GetCommentsResponse::commentsIsSet() const
{
    return m_CommentsIsSet;
}

void GetCommentsResponse::unsetComments()
{
    m_CommentsIsSet = false;
}
utility::string_t GetCommentsResponse::getReason() const
{
    return m_Reason;
}


void GetCommentsResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetCommentsResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetCommentsResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetCommentsResponse::getCode() const
{
    return m_Code;
}


void GetCommentsResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetCommentsResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetCommentsResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetCommentsResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetCommentsResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetCommentsResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetCommentsResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetCommentsResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetCommentsResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetCommentsResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetCommentsResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetCommentsResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetCommentsResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetCommentsResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetCommentsResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetCommentsResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetCommentsResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetCommentsResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetCommentsResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetCommentsResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetCommentsResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetCommentsResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetCommentsResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
