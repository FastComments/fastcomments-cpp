...
GetNotificationCount_200_response::GetNotificationCount_200_response()
{
    m_StatusIsSet = false;
    m_Count = 0.0;
    m_CountIsSet = false;
...
void GetNotificationCount_200_response::validate()
{
    // TODO: implement validation
}

web::json::value GetNotificationCount_200_response::toJson() const
{
...
bool GetNotificationCount_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetNotificationCount_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetNotificationCount_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetNotificationCount_200_response::getStatus() const
{
    return m_Status;
}


void GetNotificationCount_200_response::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetNotificationCount_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetNotificationCount_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
double GetNotificationCount_200_response::getCount() const
{
    return m_Count;
}

void GetNotificationCount_200_response::setCount(double value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool GetNotificationCount_200_response::countIsSet() const
{
    return m_CountIsSet;
}

void GetNotificationCount_200_response::unsetCount()
{
    m_CountIsSet = false;
}
utility::string_t GetNotificationCount_200_response::getReason() const
{
    return m_Reason;
}


void GetNotificationCount_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetNotificationCount_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetNotificationCount_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetNotificationCount_200_response::getCode() const
{
    return m_Code;
}


void GetNotificationCount_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetNotificationCount_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetNotificationCount_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetNotificationCount_200_response::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetNotificationCount_200_response::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetNotificationCount_200_response::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetNotificationCount_200_response::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetNotificationCount_200_response::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetNotificationCount_200_response::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetNotificationCount_200_response::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetNotificationCount_200_response::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetNotificationCount_200_response::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetNotificationCount_200_response::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetNotificationCount_200_response::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetNotificationCount_200_response::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetNotificationCount_200_response::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetNotificationCount_200_response::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetNotificationCount_200_response::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetNotificationCount_200_response::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetNotificationCount_200_response::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetNotificationCount_200_response::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetNotificationCount_200_response::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetNotificationCount_200_response::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
