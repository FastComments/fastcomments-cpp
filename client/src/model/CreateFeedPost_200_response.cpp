...
std::shared_ptr<ImportedAPIStatus_FAILED> CreateFeedPost_200_response::getStatus() const
{
    return m_Status;
}


void CreateFeedPost_200_response::setStatus(const std::shared_ptr<ImportedAPIStatus_FAILED>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
