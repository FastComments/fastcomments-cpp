...
PostBanUserUndoResponse::PostBanUserUndoResponse()
{
    m_StatusIsSet = false;
...
void PostBanUserUndoResponse::validate()
{
    // TODO: implement validation
}

web::json::value PostBanUserUndoResponse::toJson() const
{
...
bool PostBanUserUndoResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PostBanUserUndoResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PostBanUserUndoResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> PostBanUserUndoResponse::getStatus() const
{
    return m_Status;
}


void PostBanUserUndoResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PostBanUserUndoResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PostBanUserUndoResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PostBanUserUndoResponse::getReason() const
{
    return m_Reason;
}


void PostBanUserUndoResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PostBanUserUndoResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PostBanUserUndoResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PostBanUserUndoResponse::getCode() const
{
    return m_Code;
}


void PostBanUserUndoResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PostBanUserUndoResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PostBanUserUndoResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PostBanUserUndoResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PostBanUserUndoResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PostBanUserUndoResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PostBanUserUndoResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PostBanUserUndoResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PostBanUserUndoResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PostBanUserUndoResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PostBanUserUndoResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PostBanUserUndoResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PostBanUserUndoResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PostBanUserUndoResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PostBanUserUndoResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PostBanUserUndoResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PostBanUserUndoResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PostBanUserUndoResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PostBanUserUndoResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PostBanUserUndoResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PostBanUserUndoResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PostBanUserUndoResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PostBanUserUndoResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
