...
void DeleteFeedPostPublicResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteFeedPostPublicResponse::toJson() const
{
...
bool DeleteFeedPostPublicResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteFeedPostPublicResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteFeedPostPublicResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteFeedPostPublicResponse::getStatus() const
{
    return m_Status;
}


void DeleteFeedPostPublicResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteFeedPostPublicResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteFeedPostPublicResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteFeedPostPublicResponse::getReason() const
{
    return m_Reason;
}


void DeleteFeedPostPublicResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteFeedPostPublicResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteFeedPostPublicResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteFeedPostPublicResponse::getCode() const
{
    return m_Code;
}


void DeleteFeedPostPublicResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteFeedPostPublicResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteFeedPostPublicResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteFeedPostPublicResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteFeedPostPublicResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteFeedPostPublicResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteFeedPostPublicResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteFeedPostPublicResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteFeedPostPublicResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteFeedPostPublicResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteFeedPostPublicResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteFeedPostPublicResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteFeedPostPublicResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteFeedPostPublicResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteFeedPostPublicResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteFeedPostPublicResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteFeedPostPublicResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteFeedPostPublicResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteFeedPostPublicResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteFeedPostPublicResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteFeedPostPublicResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteFeedPostPublicResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteFeedPostPublicResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
