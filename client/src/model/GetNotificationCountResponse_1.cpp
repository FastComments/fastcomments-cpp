...
GetNotificationCountResponse_1::GetNotificationCountResponse_1()
{
    m_StatusIsSet = false;
    m_Count = 0.0;
    m_CountIsSet = false;
...
void GetNotificationCountResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetNotificationCountResponse_1::toJson() const
{
...
bool GetNotificationCountResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetNotificationCountResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetNotificationCountResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetNotificationCountResponse_1::getStatus() const
{
    return m_Status;
}


void GetNotificationCountResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetNotificationCountResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetNotificationCountResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
double GetNotificationCountResponse_1::getCount() const
{
    return m_Count;
}

void GetNotificationCountResponse_1::setCount(double value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool GetNotificationCountResponse_1::countIsSet() const
{
    return m_CountIsSet;
}

void GetNotificationCountResponse_1::unsetCount()
{
    m_CountIsSet = false;
}
utility::string_t GetNotificationCountResponse_1::getReason() const
{
    return m_Reason;
}


void GetNotificationCountResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetNotificationCountResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetNotificationCountResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetNotificationCountResponse_1::getCode() const
{
    return m_Code;
}


void GetNotificationCountResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetNotificationCountResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetNotificationCountResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetNotificationCountResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetNotificationCountResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetNotificationCountResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetNotificationCountResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetNotificationCountResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetNotificationCountResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetNotificationCountResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetNotificationCountResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetNotificationCountResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetNotificationCountResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetNotificationCountResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetNotificationCountResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetNotificationCountResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetNotificationCountResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetNotificationCountResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetNotificationCountResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetNotificationCountResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetNotificationCountResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetNotificationCountResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetNotificationCountResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
