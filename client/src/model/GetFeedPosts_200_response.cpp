...
GetFeedPosts_200_response::GetFeedPosts_200_response()
{
    m_StatusIsSet = false;
...
void GetFeedPosts_200_response::validate()
{
    // TODO: implement validation
}

web::json::value GetFeedPosts_200_response::toJson() const
{
...
bool GetFeedPosts_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetFeedPosts_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetFeedPosts_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ImportedAPIStatus_FAILED> GetFeedPosts_200_response::getStatus() const
{
    return m_Status;
}


void GetFeedPosts_200_response::setStatus(const std::shared_ptr<ImportedAPIStatus_FAILED>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetFeedPosts_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetFeedPosts_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<FeedPost>> GetFeedPosts_200_response::getFeedPosts() const
{
    return m_FeedPosts;
}


void GetFeedPosts_200_response::setFeedPosts(const std::vector<std::shared_ptr<FeedPost>>& value)
{
    m_FeedPosts = value;
    m_FeedPostsIsSet = true;
}

bool GetFeedPosts_200_response::feedPostsIsSet() const
{
    return m_FeedPostsIsSet;
}

void GetFeedPosts_200_response::unsetFeedPosts()
{
    m_FeedPostsIsSet = false;
}
utility::string_t GetFeedPosts_200_response::getReason() const
{
    return m_Reason;
}


void GetFeedPosts_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetFeedPosts_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetFeedPosts_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetFeedPosts_200_response::getCode() const
{
    return m_Code;
}


void GetFeedPosts_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetFeedPosts_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetFeedPosts_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetFeedPosts_200_response::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetFeedPosts_200_response::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetFeedPosts_200_response::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetFeedPosts_200_response::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetFeedPosts_200_response::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetFeedPosts_200_response::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetFeedPosts_200_response::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetFeedPosts_200_response::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetFeedPosts_200_response::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetFeedPosts_200_response::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetFeedPosts_200_response::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetFeedPosts_200_response::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetFeedPosts_200_response::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetFeedPosts_200_response::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetFeedPosts_200_response::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetFeedPosts_200_response::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetFeedPosts_200_response::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetFeedPosts_200_response::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetFeedPosts_200_response::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetFeedPosts_200_response::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
