...
CreateTicketResponse_1::CreateTicketResponse_1()
{
    m_StatusIsSet = false;
    m_TicketIsSet = false;
...
void CreateTicketResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value CreateTicketResponse_1::toJson() const
{
...
bool CreateTicketResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateTicketResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateTicketResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> CreateTicketResponse_1::getStatus() const
{
    return m_Status;
}


void CreateTicketResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CreateTicketResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void CreateTicketResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<APITicket> CreateTicketResponse_1::getTicket() const
{
    return m_Ticket;
}


void CreateTicketResponse_1::setTicket(const std::shared_ptr<APITicket>& value)
{
    m_Ticket = value;
    m_TicketIsSet = true;
}

bool CreateTicketResponse_1::ticketIsSet() const
{
    return m_TicketIsSet;
}

void CreateTicketResponse_1::unsetTicket()
{
    m_TicketIsSet = false;
}
utility::string_t CreateTicketResponse_1::getReason() const
{
    return m_Reason;
}


void CreateTicketResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CreateTicketResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CreateTicketResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CreateTicketResponse_1::getCode() const
{
    return m_Code;
}


void CreateTicketResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CreateTicketResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void CreateTicketResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CreateTicketResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CreateTicketResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CreateTicketResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CreateTicketResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CreateTicketResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void CreateTicketResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CreateTicketResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CreateTicketResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CreateTicketResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CreateTicketResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CreateTicketResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CreateTicketResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CreateTicketResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void CreateTicketResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CreateTicketResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CreateTicketResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CreateTicketResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void CreateTicketResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CreateTicketResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CreateTicketResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
