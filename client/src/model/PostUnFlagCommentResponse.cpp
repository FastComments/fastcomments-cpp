...
PostUnFlagCommentResponse::PostUnFlagCommentResponse()
{
    m_StatusIsSet = false;
...
void PostUnFlagCommentResponse::validate()
{
    // TODO: implement validation
}

web::json::value PostUnFlagCommentResponse::toJson() const
{
...
bool PostUnFlagCommentResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PostUnFlagCommentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PostUnFlagCommentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> PostUnFlagCommentResponse::getStatus() const
{
    return m_Status;
}


void PostUnFlagCommentResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PostUnFlagCommentResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PostUnFlagCommentResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PostUnFlagCommentResponse::getReason() const
{
    return m_Reason;
}


void PostUnFlagCommentResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PostUnFlagCommentResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PostUnFlagCommentResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PostUnFlagCommentResponse::getCode() const
{
    return m_Code;
}


void PostUnFlagCommentResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PostUnFlagCommentResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PostUnFlagCommentResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PostUnFlagCommentResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PostUnFlagCommentResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PostUnFlagCommentResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PostUnFlagCommentResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PostUnFlagCommentResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PostUnFlagCommentResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PostUnFlagCommentResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PostUnFlagCommentResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PostUnFlagCommentResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PostUnFlagCommentResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PostUnFlagCommentResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PostUnFlagCommentResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PostUnFlagCommentResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PostUnFlagCommentResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PostUnFlagCommentResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PostUnFlagCommentResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PostUnFlagCommentResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PostUnFlagCommentResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PostUnFlagCommentResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PostUnFlagCommentResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
