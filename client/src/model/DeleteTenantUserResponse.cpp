...
void DeleteTenantUserResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteTenantUserResponse::toJson() const
{
...
bool DeleteTenantUserResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteTenantUserResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteTenantUserResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteTenantUserResponse::getStatus() const
{
    return m_Status;
}


void DeleteTenantUserResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteTenantUserResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteTenantUserResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteTenantUserResponse::getReason() const
{
    return m_Reason;
}


void DeleteTenantUserResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteTenantUserResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteTenantUserResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteTenantUserResponse::getCode() const
{
    return m_Code;
}


void DeleteTenantUserResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteTenantUserResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteTenantUserResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteTenantUserResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteTenantUserResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteTenantUserResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteTenantUserResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteTenantUserResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteTenantUserResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteTenantUserResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteTenantUserResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteTenantUserResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteTenantUserResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteTenantUserResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteTenantUserResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteTenantUserResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteTenantUserResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteTenantUserResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteTenantUserResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteTenantUserResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteTenantUserResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteTenantUserResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteTenantUserResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
