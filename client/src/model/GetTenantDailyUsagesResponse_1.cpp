...
GetTenantDailyUsagesResponse_1::GetTenantDailyUsagesResponse_1()
{
    m_StatusIsSet = false;
...
void GetTenantDailyUsagesResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetTenantDailyUsagesResponse_1::toJson() const
{
...
bool GetTenantDailyUsagesResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetTenantDailyUsagesResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetTenantDailyUsagesResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetTenantDailyUsagesResponse_1::getStatus() const
{
    return m_Status;
}


void GetTenantDailyUsagesResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetTenantDailyUsagesResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetTenantDailyUsagesResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<APITenantDailyUsage>> GetTenantDailyUsagesResponse_1::getTenantDailyUsages() const
{
    return m_TenantDailyUsages;
}


void GetTenantDailyUsagesResponse_1::setTenantDailyUsages(const std::vector<std::shared_ptr<APITenantDailyUsage>>& value)
{
    m_TenantDailyUsages = value;
    m_TenantDailyUsagesIsSet = true;
}

bool GetTenantDailyUsagesResponse_1::tenantDailyUsagesIsSet() const
{
    return m_TenantDailyUsagesIsSet;
}

void GetTenantDailyUsagesResponse_1::unsetTenantDailyUsages()
{
    m_TenantDailyUsagesIsSet = false;
}
utility::string_t GetTenantDailyUsagesResponse_1::getReason() const
{
    return m_Reason;
}


void GetTenantDailyUsagesResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetTenantDailyUsagesResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetTenantDailyUsagesResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetTenantDailyUsagesResponse_1::getCode() const
{
    return m_Code;
}


void GetTenantDailyUsagesResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetTenantDailyUsagesResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetTenantDailyUsagesResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetTenantDailyUsagesResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetTenantDailyUsagesResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetTenantDailyUsagesResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetTenantDailyUsagesResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetTenantDailyUsagesResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetTenantDailyUsagesResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetTenantDailyUsagesResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetTenantDailyUsagesResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetTenantDailyUsagesResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetTenantDailyUsagesResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetTenantDailyUsagesResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetTenantDailyUsagesResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetTenantDailyUsagesResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetTenantDailyUsagesResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetTenantDailyUsagesResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetTenantDailyUsagesResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetTenantDailyUsagesResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetTenantDailyUsagesResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetTenantDailyUsagesResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetTenantDailyUsagesResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
