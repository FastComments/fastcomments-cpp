...
std::shared_ptr<APIStatus> GetComments_200_response::getStatus() const
{
    return m_Status;
}


void GetComments_200_response::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
std::vector<std::shared_ptr<APIComment>> GetComments_200_response::getComments() const
{
    return m_Comments;
}


void GetComments_200_response::setComments(const std::vector<std::shared_ptr<APIComment>>& value)
{
    m_Comments = value;
