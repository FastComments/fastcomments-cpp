...
GetModeratorResponse_1::GetModeratorResponse_1()
{
    m_StatusIsSet = false;
...
void GetModeratorResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetModeratorResponse_1::toJson() const
{
...
bool GetModeratorResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetModeratorResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetModeratorResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetModeratorResponse_1::getStatus() const
{
    return m_Status;
}


void GetModeratorResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetModeratorResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetModeratorResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<Moderator> GetModeratorResponse_1::getModerator() const
{
    return m_Moderator;
}


void GetModeratorResponse_1::setModerator(const std::shared_ptr<Moderator>& value)
{
    m_Moderator = value;
    m_ModeratorIsSet = true;
}

bool GetModeratorResponse_1::moderatorIsSet() const
{
    return m_ModeratorIsSet;
}

void GetModeratorResponse_1::unsetModerator()
{
    m_ModeratorIsSet = false;
}
utility::string_t GetModeratorResponse_1::getReason() const
{
    return m_Reason;
}


void GetModeratorResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetModeratorResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetModeratorResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetModeratorResponse_1::getCode() const
{
    return m_Code;
}


void GetModeratorResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetModeratorResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetModeratorResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetModeratorResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetModeratorResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetModeratorResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetModeratorResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetModeratorResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetModeratorResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetModeratorResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetModeratorResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetModeratorResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetModeratorResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetModeratorResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetModeratorResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetModeratorResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetModeratorResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetModeratorResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetModeratorResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetModeratorResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetModeratorResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetModeratorResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetModeratorResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
