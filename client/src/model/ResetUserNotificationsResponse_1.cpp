...
ResetUserNotificationsResponse_1::ResetUserNotificationsResponse_1()
{
    m_StatusIsSet = false;
...
void ResetUserNotificationsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value ResetUserNotificationsResponse_1::toJson() const
{
...
bool ResetUserNotificationsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ResetUserNotificationsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ResetUserNotificationsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> ResetUserNotificationsResponse_1::getStatus() const
{
    return m_Status;
}


void ResetUserNotificationsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ResetUserNotificationsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void ResetUserNotificationsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t ResetUserNotificationsResponse_1::getCode() const
{
    return m_Code;
}


void ResetUserNotificationsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool ResetUserNotificationsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void ResetUserNotificationsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t ResetUserNotificationsResponse_1::getReason() const
{
    return m_Reason;
}


void ResetUserNotificationsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool ResetUserNotificationsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void ResetUserNotificationsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t ResetUserNotificationsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void ResetUserNotificationsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool ResetUserNotificationsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void ResetUserNotificationsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t ResetUserNotificationsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void ResetUserNotificationsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool ResetUserNotificationsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void ResetUserNotificationsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t ResetUserNotificationsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void ResetUserNotificationsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool ResetUserNotificationsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void ResetUserNotificationsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t ResetUserNotificationsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void ResetUserNotificationsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool ResetUserNotificationsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void ResetUserNotificationsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> ResetUserNotificationsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void ResetUserNotificationsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool ResetUserNotificationsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void ResetUserNotificationsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
