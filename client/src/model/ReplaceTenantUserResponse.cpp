...
ReplaceTenantUserResponse::ReplaceTenantUserResponse()
{
    m_StatusIsSet = false;
...
void ReplaceTenantUserResponse::validate()
{
    // TODO: implement validation
}

web::json::value ReplaceTenantUserResponse::toJson() const
{
...
bool ReplaceTenantUserResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ReplaceTenantUserResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ReplaceTenantUserResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> ReplaceTenantUserResponse::getStatus() const
{
    return m_Status;
}


void ReplaceTenantUserResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ReplaceTenantUserResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void ReplaceTenantUserResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t ReplaceTenantUserResponse::getReason() const
{
    return m_Reason;
}


void ReplaceTenantUserResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool ReplaceTenantUserResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void ReplaceTenantUserResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t ReplaceTenantUserResponse::getCode() const
{
    return m_Code;
}


void ReplaceTenantUserResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool ReplaceTenantUserResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void ReplaceTenantUserResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t ReplaceTenantUserResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void ReplaceTenantUserResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool ReplaceTenantUserResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void ReplaceTenantUserResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t ReplaceTenantUserResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void ReplaceTenantUserResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool ReplaceTenantUserResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void ReplaceTenantUserResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t ReplaceTenantUserResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void ReplaceTenantUserResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool ReplaceTenantUserResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void ReplaceTenantUserResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t ReplaceTenantUserResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void ReplaceTenantUserResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool ReplaceTenantUserResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void ReplaceTenantUserResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> ReplaceTenantUserResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void ReplaceTenantUserResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool ReplaceTenantUserResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void ReplaceTenantUserResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
