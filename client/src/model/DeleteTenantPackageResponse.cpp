...
DeleteTenantPackageResponse::DeleteTenantPackageResponse()
{
    m_StatusIsSet = false;
...
void DeleteTenantPackageResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteTenantPackageResponse::toJson() const
{
...
bool DeleteTenantPackageResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteTenantPackageResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteTenantPackageResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteTenantPackageResponse::getStatus() const
{
    return m_Status;
}


void DeleteTenantPackageResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteTenantPackageResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteTenantPackageResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteTenantPackageResponse::getReason() const
{
    return m_Reason;
}


void DeleteTenantPackageResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteTenantPackageResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteTenantPackageResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteTenantPackageResponse::getCode() const
{
    return m_Code;
}


void DeleteTenantPackageResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteTenantPackageResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteTenantPackageResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteTenantPackageResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteTenantPackageResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteTenantPackageResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteTenantPackageResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteTenantPackageResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteTenantPackageResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteTenantPackageResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteTenantPackageResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteTenantPackageResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteTenantPackageResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteTenantPackageResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteTenantPackageResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteTenantPackageResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteTenantPackageResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteTenantPackageResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteTenantPackageResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteTenantPackageResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteTenantPackageResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteTenantPackageResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteTenantPackageResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
