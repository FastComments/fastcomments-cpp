...
void UpdateEmailTemplateResponse::validate()
{
    // TODO: implement validation
}

web::json::value UpdateEmailTemplateResponse::toJson() const
{
...
bool UpdateEmailTemplateResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateEmailTemplateResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateEmailTemplateResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UpdateEmailTemplateResponse::getStatus() const
{
    return m_Status;
}


void UpdateEmailTemplateResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UpdateEmailTemplateResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UpdateEmailTemplateResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t UpdateEmailTemplateResponse::getReason() const
{
    return m_Reason;
}


void UpdateEmailTemplateResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UpdateEmailTemplateResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UpdateEmailTemplateResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UpdateEmailTemplateResponse::getCode() const
{
    return m_Code;
}


void UpdateEmailTemplateResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UpdateEmailTemplateResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UpdateEmailTemplateResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UpdateEmailTemplateResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UpdateEmailTemplateResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UpdateEmailTemplateResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UpdateEmailTemplateResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UpdateEmailTemplateResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UpdateEmailTemplateResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UpdateEmailTemplateResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UpdateEmailTemplateResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UpdateEmailTemplateResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UpdateEmailTemplateResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UpdateEmailTemplateResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UpdateEmailTemplateResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UpdateEmailTemplateResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UpdateEmailTemplateResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UpdateEmailTemplateResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UpdateEmailTemplateResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UpdateEmailTemplateResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UpdateEmailTemplateResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UpdateEmailTemplateResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UpdateEmailTemplateResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
