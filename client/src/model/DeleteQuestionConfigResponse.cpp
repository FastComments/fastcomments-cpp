...
DeleteQuestionConfigResponse::DeleteQuestionConfigResponse()
{
    m_StatusIsSet = false;
...
void DeleteQuestionConfigResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteQuestionConfigResponse::toJson() const
{
...
bool DeleteQuestionConfigResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteQuestionConfigResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteQuestionConfigResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteQuestionConfigResponse::getStatus() const
{
    return m_Status;
}


void DeleteQuestionConfigResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteQuestionConfigResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteQuestionConfigResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteQuestionConfigResponse::getReason() const
{
    return m_Reason;
}


void DeleteQuestionConfigResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteQuestionConfigResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteQuestionConfigResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteQuestionConfigResponse::getCode() const
{
    return m_Code;
}


void DeleteQuestionConfigResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteQuestionConfigResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteQuestionConfigResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteQuestionConfigResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteQuestionConfigResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteQuestionConfigResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteQuestionConfigResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteQuestionConfigResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteQuestionConfigResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteQuestionConfigResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteQuestionConfigResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteQuestionConfigResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteQuestionConfigResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteQuestionConfigResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteQuestionConfigResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteQuestionConfigResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteQuestionConfigResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteQuestionConfigResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteQuestionConfigResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteQuestionConfigResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteQuestionConfigResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteQuestionConfigResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteQuestionConfigResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
