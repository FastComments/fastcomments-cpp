...
UpdateFeedPostResponse::UpdateFeedPostResponse()
{
    m_StatusIsSet = false;
...
void UpdateFeedPostResponse::validate()
{
    // TODO: implement validation
}

web::json::value UpdateFeedPostResponse::toJson() const
{
...
bool UpdateFeedPostResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateFeedPostResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateFeedPostResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UpdateFeedPostResponse::getStatus() const
{
    return m_Status;
}


void UpdateFeedPostResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UpdateFeedPostResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UpdateFeedPostResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t UpdateFeedPostResponse::getReason() const
{
    return m_Reason;
}


void UpdateFeedPostResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UpdateFeedPostResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UpdateFeedPostResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UpdateFeedPostResponse::getCode() const
{
    return m_Code;
}


void UpdateFeedPostResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UpdateFeedPostResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UpdateFeedPostResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UpdateFeedPostResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UpdateFeedPostResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UpdateFeedPostResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UpdateFeedPostResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UpdateFeedPostResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UpdateFeedPostResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UpdateFeedPostResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UpdateFeedPostResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UpdateFeedPostResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UpdateFeedPostResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UpdateFeedPostResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UpdateFeedPostResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UpdateFeedPostResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UpdateFeedPostResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UpdateFeedPostResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UpdateFeedPostResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UpdateFeedPostResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UpdateFeedPostResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UpdateFeedPostResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UpdateFeedPostResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
