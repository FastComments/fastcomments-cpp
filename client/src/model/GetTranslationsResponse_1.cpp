...
GetTranslationsResponse_1::GetTranslationsResponse_1()
{
...
void GetTranslationsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetTranslationsResponse_1::toJson() const
{
...
bool GetTranslationsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetTranslationsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetTranslationsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::map<utility::string_t, utility::string_t> GetTranslationsResponse_1::getTranslations() const
{
    return m_Translations;
}


void GetTranslationsResponse_1::setTranslations(const std::map<utility::string_t, utility::string_t>& value)
{
    m_Translations = value;
    m_TranslationsIsSet = true;
}

bool GetTranslationsResponse_1::translationsIsSet() const
{
    return m_TranslationsIsSet;
}

void GetTranslationsResponse_1::unsetTranslations()
{
    m_TranslationsIsSet = false;
}
std::shared_ptr<APIStatus> GetTranslationsResponse_1::getStatus() const
{
    return m_Status;
}


void GetTranslationsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetTranslationsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetTranslationsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetTranslationsResponse_1::getReason() const
{
    return m_Reason;
}


void GetTranslationsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetTranslationsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetTranslationsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetTranslationsResponse_1::getCode() const
{
    return m_Code;
}


void GetTranslationsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetTranslationsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetTranslationsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetTranslationsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetTranslationsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetTranslationsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetTranslationsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetTranslationsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetTranslationsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetTranslationsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetTranslationsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetTranslationsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetTranslationsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetTranslationsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetTranslationsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetTranslationsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetTranslationsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetTranslationsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetTranslationsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetTranslationsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetTranslationsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetTranslationsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetTranslationsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
