...
UpdateModeratorResponse::UpdateModeratorResponse()
{
    m_StatusIsSet = false;
...
void UpdateModeratorResponse::validate()
{
    // TODO: implement validation
}

web::json::value UpdateModeratorResponse::toJson() const
{
...
bool UpdateModeratorResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateModeratorResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateModeratorResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UpdateModeratorResponse::getStatus() const
{
    return m_Status;
}


void UpdateModeratorResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UpdateModeratorResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UpdateModeratorResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t UpdateModeratorResponse::getReason() const
{
    return m_Reason;
}


void UpdateModeratorResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UpdateModeratorResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UpdateModeratorResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UpdateModeratorResponse::getCode() const
{
    return m_Code;
}


void UpdateModeratorResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UpdateModeratorResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UpdateModeratorResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UpdateModeratorResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UpdateModeratorResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UpdateModeratorResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UpdateModeratorResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UpdateModeratorResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UpdateModeratorResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UpdateModeratorResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UpdateModeratorResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UpdateModeratorResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UpdateModeratorResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UpdateModeratorResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UpdateModeratorResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UpdateModeratorResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UpdateModeratorResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UpdateModeratorResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UpdateModeratorResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UpdateModeratorResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UpdateModeratorResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UpdateModeratorResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UpdateModeratorResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
