...
GetSearchUsersResponse::GetSearchUsersResponse()
{
    m_UsersIsSet = false;
    m_StatusIsSet = false;
...
void GetSearchUsersResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetSearchUsersResponse::toJson() const
{
...
bool GetSearchUsersResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetSearchUsersResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetSearchUsersResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<ModerationUserSearchProjected>> GetSearchUsersResponse::getUsers() const
{
    return m_Users;
}


void GetSearchUsersResponse::setUsers(const std::vector<std::shared_ptr<ModerationUserSearchProjected>>& value)
{
    m_Users = value;
    m_UsersIsSet = true;
}

bool GetSearchUsersResponse::usersIsSet() const
{
    return m_UsersIsSet;
}

void GetSearchUsersResponse::unsetUsers()
{
    m_UsersIsSet = false;
}
std::shared_ptr<APIStatus> GetSearchUsersResponse::getStatus() const
{
    return m_Status;
}


void GetSearchUsersResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetSearchUsersResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetSearchUsersResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetSearchUsersResponse::getReason() const
{
    return m_Reason;
}


void GetSearchUsersResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetSearchUsersResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetSearchUsersResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetSearchUsersResponse::getCode() const
{
    return m_Code;
}


void GetSearchUsersResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetSearchUsersResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetSearchUsersResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetSearchUsersResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetSearchUsersResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetSearchUsersResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetSearchUsersResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetSearchUsersResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetSearchUsersResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetSearchUsersResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetSearchUsersResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetSearchUsersResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetSearchUsersResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetSearchUsersResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetSearchUsersResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetSearchUsersResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetSearchUsersResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetSearchUsersResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetSearchUsersResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetSearchUsersResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetSearchUsersResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetSearchUsersResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetSearchUsersResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
