...
CreateQuestionConfigResponse_1::CreateQuestionConfigResponse_1()
{
    m_StatusIsSet = false;
...
void CreateQuestionConfigResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value CreateQuestionConfigResponse_1::toJson() const
{
...
bool CreateQuestionConfigResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateQuestionConfigResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateQuestionConfigResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> CreateQuestionConfigResponse_1::getStatus() const
{
    return m_Status;
}


void CreateQuestionConfigResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CreateQuestionConfigResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void CreateQuestionConfigResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<QuestionConfig> CreateQuestionConfigResponse_1::getQuestionConfig() const
{
    return m_QuestionConfig;
}


void CreateQuestionConfigResponse_1::setQuestionConfig(const std::shared_ptr<QuestionConfig>& value)
{
    m_QuestionConfig = value;
    m_QuestionConfigIsSet = true;
}

bool CreateQuestionConfigResponse_1::questionConfigIsSet() const
{
    return m_QuestionConfigIsSet;
}

void CreateQuestionConfigResponse_1::unsetQuestionConfig()
{
    m_QuestionConfigIsSet = false;
}
utility::string_t CreateQuestionConfigResponse_1::getReason() const
{
    return m_Reason;
}


void CreateQuestionConfigResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CreateQuestionConfigResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CreateQuestionConfigResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CreateQuestionConfigResponse_1::getCode() const
{
    return m_Code;
}


void CreateQuestionConfigResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CreateQuestionConfigResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void CreateQuestionConfigResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CreateQuestionConfigResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CreateQuestionConfigResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CreateQuestionConfigResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CreateQuestionConfigResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CreateQuestionConfigResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void CreateQuestionConfigResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CreateQuestionConfigResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CreateQuestionConfigResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CreateQuestionConfigResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CreateQuestionConfigResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CreateQuestionConfigResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CreateQuestionConfigResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CreateQuestionConfigResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void CreateQuestionConfigResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CreateQuestionConfigResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CreateQuestionConfigResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CreateQuestionConfigResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void CreateQuestionConfigResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CreateQuestionConfigResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CreateQuestionConfigResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
