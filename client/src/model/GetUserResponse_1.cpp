...
GetUserResponse_1::GetUserResponse_1()
{
    m_StatusIsSet = false;
    m_UserIsSet = false;
...
void GetUserResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetUserResponse_1::toJson() const
{
...
bool GetUserResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetUserResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetUserResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetUserResponse_1::getStatus() const
{
    return m_Status;
}


void GetUserResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetUserResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetUserResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<User> GetUserResponse_1::getUser() const
{
    return m_User;
}


void GetUserResponse_1::setUser(const std::shared_ptr<User>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool GetUserResponse_1::userIsSet() const
{
    return m_UserIsSet;
}

void GetUserResponse_1::unsetUser()
{
    m_UserIsSet = false;
}
utility::string_t GetUserResponse_1::getReason() const
{
    return m_Reason;
}


void GetUserResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetUserResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetUserResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetUserResponse_1::getCode() const
{
    return m_Code;
}


void GetUserResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetUserResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetUserResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetUserResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetUserResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetUserResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetUserResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetUserResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetUserResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetUserResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetUserResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetUserResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetUserResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetUserResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetUserResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetUserResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetUserResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetUserResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetUserResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetUserResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetUserResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetUserResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetUserResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
