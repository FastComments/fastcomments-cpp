...
DeleteV1PageReactResponse::DeleteV1PageReactResponse()
{
...
void DeleteV1PageReactResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteV1PageReactResponse::toJson() const
{
...
bool DeleteV1PageReactResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteV1PageReactResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteV1PageReactResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t DeleteV1PageReactResponse::getCode() const
{
    return m_Code;
}


void DeleteV1PageReactResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteV1PageReactResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteV1PageReactResponse::unsetCode()
{
    m_CodeIsSet = false;
}
std::shared_ptr<APIStatus> DeleteV1PageReactResponse::getStatus() const
{
    return m_Status;
}


void DeleteV1PageReactResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteV1PageReactResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteV1PageReactResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteV1PageReactResponse::getReason() const
{
    return m_Reason;
}


void DeleteV1PageReactResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteV1PageReactResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteV1PageReactResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteV1PageReactResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteV1PageReactResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteV1PageReactResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteV1PageReactResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteV1PageReactResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteV1PageReactResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteV1PageReactResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteV1PageReactResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteV1PageReactResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteV1PageReactResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteV1PageReactResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteV1PageReactResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteV1PageReactResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteV1PageReactResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteV1PageReactResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteV1PageReactResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteV1PageReactResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteV1PageReactResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteV1PageReactResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteV1PageReactResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
