...
GetUserBadgeProgressByUserIdResponse::GetUserBadgeProgressByUserIdResponse()
{
    m_StatusIsSet = false;
...
void GetUserBadgeProgressByUserIdResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetUserBadgeProgressByUserIdResponse::toJson() const
{
...
bool GetUserBadgeProgressByUserIdResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetUserBadgeProgressByUserIdResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetUserBadgeProgressByUserIdResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetUserBadgeProgressByUserIdResponse::getStatus() const
{
    return m_Status;
}


void GetUserBadgeProgressByUserIdResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetUserBadgeProgressByUserIdResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetUserBadgeProgressByUserIdResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<UserBadgeProgress> GetUserBadgeProgressByUserIdResponse::getUserBadgeProgress() const
{
    return m_UserBadgeProgress;
}


void GetUserBadgeProgressByUserIdResponse::setUserBadgeProgress(const std::shared_ptr<UserBadgeProgress>& value)
{
    m_UserBadgeProgress = value;
    m_UserBadgeProgressIsSet = true;
}

bool GetUserBadgeProgressByUserIdResponse::userBadgeProgressIsSet() const
{
    return m_UserBadgeProgressIsSet;
}

void GetUserBadgeProgressByUserIdResponse::unsetUserBadgeProgress()
{
    m_UserBadgeProgressIsSet = false;
}
utility::string_t GetUserBadgeProgressByUserIdResponse::getReason() const
{
    return m_Reason;
}


void GetUserBadgeProgressByUserIdResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetUserBadgeProgressByUserIdResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetUserBadgeProgressByUserIdResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetUserBadgeProgressByUserIdResponse::getCode() const
{
    return m_Code;
}


void GetUserBadgeProgressByUserIdResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetUserBadgeProgressByUserIdResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetUserBadgeProgressByUserIdResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetUserBadgeProgressByUserIdResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetUserBadgeProgressByUserIdResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetUserBadgeProgressByUserIdResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetUserBadgeProgressByUserIdResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetUserBadgeProgressByUserIdResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetUserBadgeProgressByUserIdResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetUserBadgeProgressByUserIdResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetUserBadgeProgressByUserIdResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetUserBadgeProgressByUserIdResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetUserBadgeProgressByUserIdResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetUserBadgeProgressByUserIdResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetUserBadgeProgressByUserIdResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetUserBadgeProgressByUserIdResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetUserBadgeProgressByUserIdResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetUserBadgeProgressByUserIdResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetUserBadgeProgressByUserIdResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetUserBadgeProgressByUserIdResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetUserBadgeProgressByUserIdResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetUserBadgeProgressByUserIdResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetUserBadgeProgressByUserIdResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
