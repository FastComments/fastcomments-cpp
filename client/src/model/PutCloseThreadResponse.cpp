...
PutCloseThreadResponse::PutCloseThreadResponse()
{
    m_StatusIsSet = false;
...
void PutCloseThreadResponse::validate()
{
    // TODO: implement validation
}

web::json::value PutCloseThreadResponse::toJson() const
{
...
bool PutCloseThreadResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PutCloseThreadResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PutCloseThreadResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> PutCloseThreadResponse::getStatus() const
{
    return m_Status;
}


void PutCloseThreadResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PutCloseThreadResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PutCloseThreadResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PutCloseThreadResponse::getReason() const
{
    return m_Reason;
}


void PutCloseThreadResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PutCloseThreadResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PutCloseThreadResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PutCloseThreadResponse::getCode() const
{
    return m_Code;
}


void PutCloseThreadResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PutCloseThreadResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PutCloseThreadResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PutCloseThreadResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PutCloseThreadResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PutCloseThreadResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PutCloseThreadResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PutCloseThreadResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PutCloseThreadResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PutCloseThreadResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PutCloseThreadResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PutCloseThreadResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PutCloseThreadResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PutCloseThreadResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PutCloseThreadResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PutCloseThreadResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PutCloseThreadResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PutCloseThreadResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PutCloseThreadResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PutCloseThreadResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PutCloseThreadResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PutCloseThreadResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PutCloseThreadResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
