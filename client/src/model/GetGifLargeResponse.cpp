...
GetGifLargeResponse::GetGifLargeResponse()
{
...
void GetGifLargeResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetGifLargeResponse::toJson() const
{
...
bool GetGifLargeResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetGifLargeResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetGifLargeResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t GetGifLargeResponse::getSrc() const
{
    return m_Src;
}


void GetGifLargeResponse::setSrc(const utility::string_t& value)
{
    m_Src = value;
    m_SrcIsSet = true;
}

bool GetGifLargeResponse::srcIsSet() const
{
    return m_SrcIsSet;
}

void GetGifLargeResponse::unsetSrc()
{
    m_SrcIsSet = false;
}
std::shared_ptr<APIStatus> GetGifLargeResponse::getStatus() const
{
    return m_Status;
}


void GetGifLargeResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetGifLargeResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetGifLargeResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetGifLargeResponse::getReason() const
{
    return m_Reason;
}


void GetGifLargeResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetGifLargeResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetGifLargeResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetGifLargeResponse::getCode() const
{
    return m_Code;
}


void GetGifLargeResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetGifLargeResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetGifLargeResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetGifLargeResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetGifLargeResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetGifLargeResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetGifLargeResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetGifLargeResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetGifLargeResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetGifLargeResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetGifLargeResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetGifLargeResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetGifLargeResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetGifLargeResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetGifLargeResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetGifLargeResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetGifLargeResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetGifLargeResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetGifLargeResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetGifLargeResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetGifLargeResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetGifLargeResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetGifLargeResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
