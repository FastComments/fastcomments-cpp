...
GetV2PageReactUsersResponse_1::GetV2PageReactUsersResponse_1()
{
...
void GetV2PageReactUsersResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetV2PageReactUsersResponse_1::toJson() const
{
...
bool GetV2PageReactUsersResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetV2PageReactUsersResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetV2PageReactUsersResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<utility::string_t> GetV2PageReactUsersResponse_1::getUserNames() const
{
    return m_UserNames;
}


void GetV2PageReactUsersResponse_1::setUserNames(const std::vector<utility::string_t>& value)
{
    m_UserNames = value;
    m_UserNamesIsSet = true;
}

bool GetV2PageReactUsersResponse_1::userNamesIsSet() const
{
    return m_UserNamesIsSet;
}

void GetV2PageReactUsersResponse_1::unsetUserNames()
{
    m_UserNamesIsSet = false;
}
std::shared_ptr<APIStatus> GetV2PageReactUsersResponse_1::getStatus() const
{
    return m_Status;
}


void GetV2PageReactUsersResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetV2PageReactUsersResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetV2PageReactUsersResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetV2PageReactUsersResponse_1::getReason() const
{
    return m_Reason;
}


void GetV2PageReactUsersResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetV2PageReactUsersResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetV2PageReactUsersResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetV2PageReactUsersResponse_1::getCode() const
{
    return m_Code;
}


void GetV2PageReactUsersResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetV2PageReactUsersResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetV2PageReactUsersResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetV2PageReactUsersResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetV2PageReactUsersResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetV2PageReactUsersResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetV2PageReactUsersResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetV2PageReactUsersResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetV2PageReactUsersResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetV2PageReactUsersResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetV2PageReactUsersResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetV2PageReactUsersResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetV2PageReactUsersResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetV2PageReactUsersResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetV2PageReactUsersResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetV2PageReactUsersResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetV2PageReactUsersResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetV2PageReactUsersResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetV2PageReactUsersResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetV2PageReactUsersResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetV2PageReactUsersResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetV2PageReactUsersResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetV2PageReactUsersResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
