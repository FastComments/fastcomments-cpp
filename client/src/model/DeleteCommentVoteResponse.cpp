...
DeleteCommentVoteResponse::DeleteCommentVoteResponse()
{
    m_StatusIsSet = false;
...
void DeleteCommentVoteResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteCommentVoteResponse::toJson() const
{
...
bool DeleteCommentVoteResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteCommentVoteResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteCommentVoteResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteCommentVoteResponse::getStatus() const
{
    return m_Status;
}


void DeleteCommentVoteResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteCommentVoteResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteCommentVoteResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
bool DeleteCommentVoteResponse::isWasPendingVote() const
{
    return m_WasPendingVote;
}

void DeleteCommentVoteResponse::setWasPendingVote(bool value)
{
    m_WasPendingVote = value;
    m_WasPendingVoteIsSet = true;
}

bool DeleteCommentVoteResponse::wasPendingVoteIsSet() const
{
    return m_WasPendingVoteIsSet;
}

void DeleteCommentVoteResponse::unsetWasPendingVote()
{
    m_WasPendingVoteIsSet = false;
}
utility::string_t DeleteCommentVoteResponse::getReason() const
{
    return m_Reason;
}


void DeleteCommentVoteResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteCommentVoteResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteCommentVoteResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteCommentVoteResponse::getCode() const
{
    return m_Code;
}


void DeleteCommentVoteResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteCommentVoteResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteCommentVoteResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteCommentVoteResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteCommentVoteResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteCommentVoteResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteCommentVoteResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteCommentVoteResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteCommentVoteResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteCommentVoteResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteCommentVoteResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteCommentVoteResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteCommentVoteResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteCommentVoteResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteCommentVoteResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteCommentVoteResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteCommentVoteResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteCommentVoteResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteCommentVoteResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteCommentVoteResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteCommentVoteResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteCommentVoteResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteCommentVoteResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
