...
GetCommentBanStatusResponse_1::GetCommentBanStatusResponse_1()
{
    m_StatusIsSet = false;
...
void GetCommentBanStatusResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetCommentBanStatusResponse_1::toJson() const
{
...
bool GetCommentBanStatusResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetCommentBanStatusResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetCommentBanStatusResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetCommentBanStatusResponse_1::getStatus() const
{
    return m_Status;
}


void GetCommentBanStatusResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetCommentBanStatusResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetCommentBanStatusResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetCommentBanStatusResponse_1::getEmailDomain() const
{
    return m_EmailDomain.get();
}


void GetCommentBanStatusResponse_1::setEmailDomain(const utility::string_t& value)
{
    m_EmailDomain = value;
}

bool GetCommentBanStatusResponse_1::emailDomainIsSet() const
{
    return m_EmailDomain.has_value();
}

void GetCommentBanStatusResponse_1::unsetEmailDomain()
{
    m_EmailDomain.reset();
}
bool GetCommentBanStatusResponse_1::isCanIPBan() const
{
    return m_CanIPBan.get();
}

void GetCommentBanStatusResponse_1::setCanIPBan(bool value)
{
    m_CanIPBan = value;
}

bool GetCommentBanStatusResponse_1::canIPBanIsSet() const
{
    return m_CanIPBan.has_value();
}

void GetCommentBanStatusResponse_1::unsetCanIPBan()
{
    m_CanIPBan.reset();
}
utility::string_t GetCommentBanStatusResponse_1::getReason() const
{
    return m_Reason;
}


void GetCommentBanStatusResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetCommentBanStatusResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetCommentBanStatusResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetCommentBanStatusResponse_1::getCode() const
{
    return m_Code;
}


void GetCommentBanStatusResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetCommentBanStatusResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetCommentBanStatusResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetCommentBanStatusResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetCommentBanStatusResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetCommentBanStatusResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetCommentBanStatusResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetCommentBanStatusResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetCommentBanStatusResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetCommentBanStatusResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetCommentBanStatusResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetCommentBanStatusResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetCommentBanStatusResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetCommentBanStatusResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetCommentBanStatusResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetCommentBanStatusResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetCommentBanStatusResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetCommentBanStatusResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetCommentBanStatusResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetCommentBanStatusResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetCommentBanStatusResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetCommentBanStatusResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetCommentBanStatusResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
