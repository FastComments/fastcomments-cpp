...
GetSearchSuggestResponse::GetSearchSuggestResponse()
{
    m_StatusIsSet = false;
    m_PagesIsSet = false;
    m_UsersIsSet = false;
...
void GetSearchSuggestResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetSearchSuggestResponse::toJson() const
{
...
bool GetSearchSuggestResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetSearchSuggestResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetSearchSuggestResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetSearchSuggestResponse::getStatus() const
{
    return m_Status;
}


void GetSearchSuggestResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetSearchSuggestResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetSearchSuggestResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<ModerationPageSearchProjected>> GetSearchSuggestResponse::getPages() const
{
    return m_Pages;
}


void GetSearchSuggestResponse::setPages(const std::vector<std::shared_ptr<ModerationPageSearchProjected>>& value)
{
    m_Pages = value;
    m_PagesIsSet = true;
}

bool GetSearchSuggestResponse::pagesIsSet() const
{
    return m_PagesIsSet;
}

void GetSearchSuggestResponse::unsetPages()
{
    m_PagesIsSet = false;
}
std::vector<std::shared_ptr<ModerationUserSearchProjected>> GetSearchSuggestResponse::getUsers() const
{
    return m_Users;
}


void GetSearchSuggestResponse::setUsers(const std::vector<std::shared_ptr<ModerationUserSearchProjected>>& value)
{
    m_Users = value;
    m_UsersIsSet = true;
}

bool GetSearchSuggestResponse::usersIsSet() const
{
    return m_UsersIsSet;
}

void GetSearchSuggestResponse::unsetUsers()
{
    m_UsersIsSet = false;
}
utility::string_t GetSearchSuggestResponse::getCode() const
{
    return m_Code;
}


void GetSearchSuggestResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetSearchSuggestResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetSearchSuggestResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetSearchSuggestResponse::getReason() const
{
    return m_Reason;
}


void GetSearchSuggestResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetSearchSuggestResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetSearchSuggestResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetSearchSuggestResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetSearchSuggestResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetSearchSuggestResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetSearchSuggestResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetSearchSuggestResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetSearchSuggestResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetSearchSuggestResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetSearchSuggestResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetSearchSuggestResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetSearchSuggestResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetSearchSuggestResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetSearchSuggestResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetSearchSuggestResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetSearchSuggestResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetSearchSuggestResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetSearchSuggestResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetSearchSuggestResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetSearchSuggestResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetSearchSuggestResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetSearchSuggestResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
