...
CreateQuestionResultResponse_1::CreateQuestionResultResponse_1()
{
    m_StatusIsSet = false;
...
void CreateQuestionResultResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value CreateQuestionResultResponse_1::toJson() const
{
...
bool CreateQuestionResultResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateQuestionResultResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateQuestionResultResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> CreateQuestionResultResponse_1::getStatus() const
{
    return m_Status;
}


void CreateQuestionResultResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CreateQuestionResultResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void CreateQuestionResultResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<QuestionResult> CreateQuestionResultResponse_1::getQuestionResult() const
{
    return m_QuestionResult;
}


void CreateQuestionResultResponse_1::setQuestionResult(const std::shared_ptr<QuestionResult>& value)
{
    m_QuestionResult = value;
    m_QuestionResultIsSet = true;
}

bool CreateQuestionResultResponse_1::questionResultIsSet() const
{
    return m_QuestionResultIsSet;
}

void CreateQuestionResultResponse_1::unsetQuestionResult()
{
    m_QuestionResultIsSet = false;
}
utility::string_t CreateQuestionResultResponse_1::getReason() const
{
    return m_Reason;
}


void CreateQuestionResultResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CreateQuestionResultResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CreateQuestionResultResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CreateQuestionResultResponse_1::getCode() const
{
    return m_Code;
}


void CreateQuestionResultResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CreateQuestionResultResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void CreateQuestionResultResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CreateQuestionResultResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CreateQuestionResultResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CreateQuestionResultResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CreateQuestionResultResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CreateQuestionResultResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void CreateQuestionResultResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CreateQuestionResultResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CreateQuestionResultResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CreateQuestionResultResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CreateQuestionResultResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CreateQuestionResultResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CreateQuestionResultResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CreateQuestionResultResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void CreateQuestionResultResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CreateQuestionResultResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CreateQuestionResultResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CreateQuestionResultResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void CreateQuestionResultResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CreateQuestionResultResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CreateQuestionResultResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
