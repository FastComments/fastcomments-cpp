...
UpdateUserBadgeResponse::UpdateUserBadgeResponse()
{
    m_StatusIsSet = false;
...
void UpdateUserBadgeResponse::validate()
{
    // TODO: implement validation
}

web::json::value UpdateUserBadgeResponse::toJson() const
{
...
bool UpdateUserBadgeResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateUserBadgeResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateUserBadgeResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UpdateUserBadgeResponse::getStatus() const
{
    return m_Status;
}


void UpdateUserBadgeResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UpdateUserBadgeResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UpdateUserBadgeResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t UpdateUserBadgeResponse::getReason() const
{
    return m_Reason;
}


void UpdateUserBadgeResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UpdateUserBadgeResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UpdateUserBadgeResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UpdateUserBadgeResponse::getCode() const
{
    return m_Code;
}


void UpdateUserBadgeResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UpdateUserBadgeResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UpdateUserBadgeResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UpdateUserBadgeResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UpdateUserBadgeResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UpdateUserBadgeResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UpdateUserBadgeResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UpdateUserBadgeResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UpdateUserBadgeResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UpdateUserBadgeResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UpdateUserBadgeResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UpdateUserBadgeResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UpdateUserBadgeResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UpdateUserBadgeResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UpdateUserBadgeResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UpdateUserBadgeResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UpdateUserBadgeResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UpdateUserBadgeResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UpdateUserBadgeResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UpdateUserBadgeResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UpdateUserBadgeResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UpdateUserBadgeResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UpdateUserBadgeResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
