...
std::shared_ptr<APIStatus> FlagCommentPublic_200_response::getStatus() const
{
    return m_Status;
}


void FlagCommentPublic_200_response::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
