...
DeleteEmailTemplateRenderErrorResponse::DeleteEmailTemplateRenderErrorResponse()
{
    m_StatusIsSet = false;
...
void DeleteEmailTemplateRenderErrorResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteEmailTemplateRenderErrorResponse::toJson() const
{
...
bool DeleteEmailTemplateRenderErrorResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteEmailTemplateRenderErrorResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteEmailTemplateRenderErrorResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteEmailTemplateRenderErrorResponse::getStatus() const
{
    return m_Status;
}


void DeleteEmailTemplateRenderErrorResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteEmailTemplateRenderErrorResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteEmailTemplateRenderErrorResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteEmailTemplateRenderErrorResponse::getReason() const
{
    return m_Reason;
}


void DeleteEmailTemplateRenderErrorResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteEmailTemplateRenderErrorResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteEmailTemplateRenderErrorResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteEmailTemplateRenderErrorResponse::getCode() const
{
    return m_Code;
}


void DeleteEmailTemplateRenderErrorResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteEmailTemplateRenderErrorResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteEmailTemplateRenderErrorResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteEmailTemplateRenderErrorResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteEmailTemplateRenderErrorResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteEmailTemplateRenderErrorResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteEmailTemplateRenderErrorResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteEmailTemplateRenderErrorResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteEmailTemplateRenderErrorResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteEmailTemplateRenderErrorResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteEmailTemplateRenderErrorResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteEmailTemplateRenderErrorResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteEmailTemplateRenderErrorResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteEmailTemplateRenderErrorResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteEmailTemplateRenderErrorResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteEmailTemplateRenderErrorResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteEmailTemplateRenderErrorResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteEmailTemplateRenderErrorResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteEmailTemplateRenderErrorResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteEmailTemplateRenderErrorResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteEmailTemplateRenderErrorResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteEmailTemplateRenderErrorResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteEmailTemplateRenderErrorResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
