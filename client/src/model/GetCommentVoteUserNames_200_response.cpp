...
GetCommentVoteUserNames_200_response::GetCommentVoteUserNames_200_response()
{
    m_StatusIsSet = false;
...
void GetCommentVoteUserNames_200_response::validate()
{
    // TODO: implement validation
}

web::json::value GetCommentVoteUserNames_200_response::toJson() const
{
...
bool GetCommentVoteUserNames_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetCommentVoteUserNames_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetCommentVoteUserNames_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ImportedAPIStatus_FAILED> GetCommentVoteUserNames_200_response::getStatus() const
{
    return m_Status;
}


void GetCommentVoteUserNames_200_response::setStatus(const std::shared_ptr<ImportedAPIStatus_FAILED>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetCommentVoteUserNames_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetCommentVoteUserNames_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<utility::string_t> GetCommentVoteUserNames_200_response::getVoteUserNames() const
{
    return m_VoteUserNames;
}


void GetCommentVoteUserNames_200_response::setVoteUserNames(const std::vector<utility::string_t>& value)
{
    m_VoteUserNames = value;
    m_VoteUserNamesIsSet = true;
}

bool GetCommentVoteUserNames_200_response::voteUserNamesIsSet() const
{
    return m_VoteUserNamesIsSet;
}

void GetCommentVoteUserNames_200_response::unsetVoteUserNames()
{
    m_VoteUserNamesIsSet = false;
}
bool GetCommentVoteUserNames_200_response::isHasMore() const
{
    return m_HasMore;
}

void GetCommentVoteUserNames_200_response::setHasMore(bool value)
{
    m_HasMore = value;
    m_HasMoreIsSet = true;
}

bool GetCommentVoteUserNames_200_response::hasMoreIsSet() const
{
    return m_HasMoreIsSet;
}

void GetCommentVoteUserNames_200_response::unsetHasMore()
{
    m_HasMoreIsSet = false;
}
utility::string_t GetCommentVoteUserNames_200_response::getReason() const
{
    return m_Reason;
}


void GetCommentVoteUserNames_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetCommentVoteUserNames_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetCommentVoteUserNames_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetCommentVoteUserNames_200_response::getCode() const
{
    return m_Code;
}


void GetCommentVoteUserNames_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetCommentVoteUserNames_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetCommentVoteUserNames_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetCommentVoteUserNames_200_response::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetCommentVoteUserNames_200_response::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetCommentVoteUserNames_200_response::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetCommentVoteUserNames_200_response::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetCommentVoteUserNames_200_response::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetCommentVoteUserNames_200_response::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetCommentVoteUserNames_200_response::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetCommentVoteUserNames_200_response::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetCommentVoteUserNames_200_response::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetCommentVoteUserNames_200_response::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetCommentVoteUserNames_200_response::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetCommentVoteUserNames_200_response::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetCommentVoteUserNames_200_response::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetCommentVoteUserNames_200_response::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetCommentVoteUserNames_200_response::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetCommentVoteUserNames_200_response::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetCommentVoteUserNames_200_response::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetCommentVoteUserNames_200_response::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetCommentVoteUserNames_200_response::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetCommentVoteUserNames_200_response::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
