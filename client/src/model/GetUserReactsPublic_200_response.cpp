...
GetUserReactsPublic_200_response::GetUserReactsPublic_200_response()
{
    m_StatusIsSet = false;
    m_ReactsIsSet = false;
...
void GetUserReactsPublic_200_response::validate()
{
    // TODO: implement validation
}

web::json::value GetUserReactsPublic_200_response::toJson() const
{
...
bool GetUserReactsPublic_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetUserReactsPublic_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetUserReactsPublic_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ImportedAPIStatus_FAILED> GetUserReactsPublic_200_response::getStatus() const
{
    return m_Status;
}


void GetUserReactsPublic_200_response::setStatus(const std::shared_ptr<ImportedAPIStatus_FAILED>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetUserReactsPublic_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetUserReactsPublic_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
std::map<utility::string_t, std::map<utility::string_t, bool>> GetUserReactsPublic_200_response::getReacts() const
{
    return m_Reacts;
}


void GetUserReactsPublic_200_response::setReacts(const std::map<utility::string_t, std::map<utility::string_t, bool>>& value)
{
    m_Reacts = value;
    m_ReactsIsSet = true;
}

bool GetUserReactsPublic_200_response::reactsIsSet() const
{
    return m_ReactsIsSet;
}

void GetUserReactsPublic_200_response::unsetReacts()
{
    m_ReactsIsSet = false;
}
utility::string_t GetUserReactsPublic_200_response::getReason() const
{
    return m_Reason;
}


void GetUserReactsPublic_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetUserReactsPublic_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetUserReactsPublic_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetUserReactsPublic_200_response::getCode() const
{
    return m_Code;
}


void GetUserReactsPublic_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetUserReactsPublic_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetUserReactsPublic_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetUserReactsPublic_200_response::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetUserReactsPublic_200_response::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetUserReactsPublic_200_response::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetUserReactsPublic_200_response::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetUserReactsPublic_200_response::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetUserReactsPublic_200_response::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetUserReactsPublic_200_response::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetUserReactsPublic_200_response::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetUserReactsPublic_200_response::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetUserReactsPublic_200_response::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetUserReactsPublic_200_response::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetUserReactsPublic_200_response::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetUserReactsPublic_200_response::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetUserReactsPublic_200_response::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetUserReactsPublic_200_response::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetUserReactsPublic_200_response::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetUserReactsPublic_200_response::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetUserReactsPublic_200_response::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetUserReactsPublic_200_response::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetUserReactsPublic_200_response::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
