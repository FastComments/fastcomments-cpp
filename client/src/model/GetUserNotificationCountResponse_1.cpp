...
GetUserNotificationCountResponse_1::GetUserNotificationCountResponse_1()
{
    m_StatusIsSet = false;
    m_Count = 0L;
    m_CountIsSet = false;
...
void GetUserNotificationCountResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetUserNotificationCountResponse_1::toJson() const
{
...
bool GetUserNotificationCountResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetUserNotificationCountResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetUserNotificationCountResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetUserNotificationCountResponse_1::getStatus() const
{
    return m_Status;
}


void GetUserNotificationCountResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetUserNotificationCountResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetUserNotificationCountResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
int64_t GetUserNotificationCountResponse_1::getCount() const
{
    return m_Count;
}

void GetUserNotificationCountResponse_1::setCount(int64_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool GetUserNotificationCountResponse_1::countIsSet() const
{
    return m_CountIsSet;
}

void GetUserNotificationCountResponse_1::unsetCount()
{
    m_CountIsSet = false;
}
utility::string_t GetUserNotificationCountResponse_1::getReason() const
{
    return m_Reason;
}


void GetUserNotificationCountResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetUserNotificationCountResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetUserNotificationCountResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetUserNotificationCountResponse_1::getCode() const
{
    return m_Code;
}


void GetUserNotificationCountResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetUserNotificationCountResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetUserNotificationCountResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetUserNotificationCountResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetUserNotificationCountResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetUserNotificationCountResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetUserNotificationCountResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetUserNotificationCountResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetUserNotificationCountResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetUserNotificationCountResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetUserNotificationCountResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetUserNotificationCountResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetUserNotificationCountResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetUserNotificationCountResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetUserNotificationCountResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetUserNotificationCountResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetUserNotificationCountResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetUserNotificationCountResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetUserNotificationCountResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetUserNotificationCountResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetUserNotificationCountResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetUserNotificationCountResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetUserNotificationCountResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
