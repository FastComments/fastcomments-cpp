...
ResetUserNotificationCountResponse::ResetUserNotificationCountResponse()
{
    m_StatusIsSet = false;
...
void ResetUserNotificationCountResponse::validate()
{
    // TODO: implement validation
}

web::json::value ResetUserNotificationCountResponse::toJson() const
{
...
bool ResetUserNotificationCountResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ResetUserNotificationCountResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ResetUserNotificationCountResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> ResetUserNotificationCountResponse::getStatus() const
{
    return m_Status;
}


void ResetUserNotificationCountResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ResetUserNotificationCountResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void ResetUserNotificationCountResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t ResetUserNotificationCountResponse::getCode() const
{
    return m_Code;
}


void ResetUserNotificationCountResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool ResetUserNotificationCountResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void ResetUserNotificationCountResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t ResetUserNotificationCountResponse::getReason() const
{
    return m_Reason;
}


void ResetUserNotificationCountResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool ResetUserNotificationCountResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void ResetUserNotificationCountResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t ResetUserNotificationCountResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void ResetUserNotificationCountResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool ResetUserNotificationCountResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void ResetUserNotificationCountResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t ResetUserNotificationCountResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void ResetUserNotificationCountResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool ResetUserNotificationCountResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void ResetUserNotificationCountResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t ResetUserNotificationCountResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void ResetUserNotificationCountResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool ResetUserNotificationCountResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void ResetUserNotificationCountResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t ResetUserNotificationCountResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void ResetUserNotificationCountResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool ResetUserNotificationCountResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void ResetUserNotificationCountResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> ResetUserNotificationCountResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void ResetUserNotificationCountResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool ResetUserNotificationCountResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void ResetUserNotificationCountResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
