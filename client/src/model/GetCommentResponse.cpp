...
void GetCommentResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetCommentResponse::toJson() const
{
...
bool GetCommentResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetCommentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetCommentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetCommentResponse::getStatus() const
{
    return m_Status;
}


void GetCommentResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetCommentResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetCommentResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<APIComment> GetCommentResponse::getComment() const
{
    return m_Comment;
}


void GetCommentResponse::setComment(const std::shared_ptr<APIComment>& value)
{
    m_Comment = value;
    m_CommentIsSet = true;
}

bool GetCommentResponse::commentIsSet() const
{
    return m_CommentIsSet;
}

void GetCommentResponse::unsetComment()
{
    m_CommentIsSet = false;
}
utility::string_t GetCommentResponse::getReason() const
{
    return m_Reason;
}


void GetCommentResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetCommentResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetCommentResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetCommentResponse::getCode() const
{
    return m_Code;
}


void GetCommentResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetCommentResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetCommentResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetCommentResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetCommentResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetCommentResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetCommentResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetCommentResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetCommentResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetCommentResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetCommentResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetCommentResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetCommentResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetCommentResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetCommentResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetCommentResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetCommentResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetCommentResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetCommentResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetCommentResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetCommentResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetCommentResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetCommentResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
