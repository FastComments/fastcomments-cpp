...
void DeleteEmailTemplateResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteEmailTemplateResponse::toJson() const
{
...
bool DeleteEmailTemplateResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteEmailTemplateResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteEmailTemplateResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteEmailTemplateResponse::getStatus() const
{
    return m_Status;
}


void DeleteEmailTemplateResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteEmailTemplateResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteEmailTemplateResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteEmailTemplateResponse::getReason() const
{
    return m_Reason;
}


void DeleteEmailTemplateResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteEmailTemplateResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteEmailTemplateResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteEmailTemplateResponse::getCode() const
{
    return m_Code;
}


void DeleteEmailTemplateResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteEmailTemplateResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteEmailTemplateResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteEmailTemplateResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteEmailTemplateResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteEmailTemplateResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteEmailTemplateResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteEmailTemplateResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteEmailTemplateResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteEmailTemplateResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteEmailTemplateResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteEmailTemplateResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteEmailTemplateResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteEmailTemplateResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteEmailTemplateResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteEmailTemplateResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteEmailTemplateResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteEmailTemplateResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteEmailTemplateResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteEmailTemplateResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteEmailTemplateResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteEmailTemplateResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteEmailTemplateResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
