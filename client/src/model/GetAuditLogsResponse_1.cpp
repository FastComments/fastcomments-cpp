...
GetAuditLogsResponse_1::GetAuditLogsResponse_1()
{
    m_StatusIsSet = false;
...
void GetAuditLogsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetAuditLogsResponse_1::toJson() const
{
...
bool GetAuditLogsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetAuditLogsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetAuditLogsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetAuditLogsResponse_1::getStatus() const
{
    return m_Status;
}


void GetAuditLogsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetAuditLogsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetAuditLogsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<APIAuditLog>> GetAuditLogsResponse_1::getAuditLogs() const
{
    return m_AuditLogs;
}


void GetAuditLogsResponse_1::setAuditLogs(const std::vector<std::shared_ptr<APIAuditLog>>& value)
{
    m_AuditLogs = value;
    m_AuditLogsIsSet = true;
}

bool GetAuditLogsResponse_1::auditLogsIsSet() const
{
    return m_AuditLogsIsSet;
}

void GetAuditLogsResponse_1::unsetAuditLogs()
{
    m_AuditLogsIsSet = false;
}
utility::string_t GetAuditLogsResponse_1::getReason() const
{
    return m_Reason;
}


void GetAuditLogsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetAuditLogsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetAuditLogsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetAuditLogsResponse_1::getCode() const
{
    return m_Code;
}


void GetAuditLogsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetAuditLogsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetAuditLogsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetAuditLogsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetAuditLogsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetAuditLogsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetAuditLogsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetAuditLogsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetAuditLogsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetAuditLogsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetAuditLogsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetAuditLogsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetAuditLogsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetAuditLogsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetAuditLogsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetAuditLogsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetAuditLogsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetAuditLogsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetAuditLogsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetAuditLogsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetAuditLogsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetAuditLogsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetAuditLogsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
