...
GetEventLog_200_response::GetEventLog_200_response()
{
    m_EventsIsSet = false;
    m_StatusIsSet = false;
...
void GetEventLog_200_response::validate()
{
    // TODO: implement validation
}

web::json::value GetEventLog_200_response::toJson() const
{
...
bool GetEventLog_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetEventLog_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetEventLog_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<EventLogEntry>> GetEventLog_200_response::getEvents() const
{
    return m_Events;
}


void GetEventLog_200_response::setEvents(const std::vector<std::shared_ptr<EventLogEntry>>& value)
{
    m_Events = value;
    m_EventsIsSet = true;
}

bool GetEventLog_200_response::eventsIsSet() const
{
    return m_EventsIsSet;
}

void GetEventLog_200_response::unsetEvents()
{
    m_EventsIsSet = false;
}
std::shared_ptr<ImportedAPIStatus_FAILED> GetEventLog_200_response::getStatus() const
{
    return m_Status;
}


void GetEventLog_200_response::setStatus(const std::shared_ptr<ImportedAPIStatus_FAILED>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetEventLog_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetEventLog_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetEventLog_200_response::getReason() const
{
    return m_Reason;
}


void GetEventLog_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetEventLog_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetEventLog_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetEventLog_200_response::getCode() const
{
    return m_Code;
}


void GetEventLog_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetEventLog_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetEventLog_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetEventLog_200_response::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetEventLog_200_response::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetEventLog_200_response::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetEventLog_200_response::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetEventLog_200_response::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetEventLog_200_response::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetEventLog_200_response::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetEventLog_200_response::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetEventLog_200_response::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetEventLog_200_response::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetEventLog_200_response::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetEventLog_200_response::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetEventLog_200_response::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetEventLog_200_response::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetEventLog_200_response::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetEventLog_200_response::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetEventLog_200_response::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetEventLog_200_response::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetEventLog_200_response::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetEventLog_200_response::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
