...
AddHashTagsBulkResponse::AddHashTagsBulkResponse()
{
    m_StatusIsSet = false;
...
void AddHashTagsBulkResponse::validate()
{
    // TODO: implement validation
}

web::json::value AddHashTagsBulkResponse::toJson() const
{
...
bool AddHashTagsBulkResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("results"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<BulkCreateHashTagsResponse_results_inner>> refVal_setResults;
...
void AddHashTagsBulkResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AddHashTagsBulkResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> AddHashTagsBulkResponse::getStatus() const
{
    return m_Status;
}


void AddHashTagsBulkResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AddHashTagsBulkResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void AddHashTagsBulkResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<BulkCreateHashTagsResponse_results_inner>> AddHashTagsBulkResponse::getResults() const
{
    return m_Results;
}


void AddHashTagsBulkResponse::setResults(const std::vector<std::shared_ptr<BulkCreateHashTagsResponse_results_inner>>& value)
{
    m_Results = value;
    m_ResultsIsSet = true;
}

bool AddHashTagsBulkResponse::resultsIsSet() const
{
    return m_ResultsIsSet;
}

void AddHashTagsBulkResponse::unsetResults()
{
    m_ResultsIsSet = false;
}
utility::string_t AddHashTagsBulkResponse::getReason() const
{
    return m_Reason;
}


void AddHashTagsBulkResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool AddHashTagsBulkResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void AddHashTagsBulkResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t AddHashTagsBulkResponse::getCode() const
{
    return m_Code;
}


void AddHashTagsBulkResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool AddHashTagsBulkResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void AddHashTagsBulkResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t AddHashTagsBulkResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void AddHashTagsBulkResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool AddHashTagsBulkResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void AddHashTagsBulkResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t AddHashTagsBulkResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void AddHashTagsBulkResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool AddHashTagsBulkResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void AddHashTagsBulkResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t AddHashTagsBulkResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void AddHashTagsBulkResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool AddHashTagsBulkResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void AddHashTagsBulkResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t AddHashTagsBulkResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void AddHashTagsBulkResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool AddHashTagsBulkResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void AddHashTagsBulkResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> AddHashTagsBulkResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void AddHashTagsBulkResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool AddHashTagsBulkResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void AddHashTagsBulkResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
