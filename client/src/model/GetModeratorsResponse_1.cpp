...
GetModeratorsResponse_1::GetModeratorsResponse_1()
{
    m_StatusIsSet = false;
...
void GetModeratorsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetModeratorsResponse_1::toJson() const
{
...
bool GetModeratorsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetModeratorsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetModeratorsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetModeratorsResponse_1::getStatus() const
{
    return m_Status;
}


void GetModeratorsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetModeratorsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetModeratorsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<Moderator>> GetModeratorsResponse_1::getModerators() const
{
    return m_Moderators;
}


void GetModeratorsResponse_1::setModerators(const std::vector<std::shared_ptr<Moderator>>& value)
{
    m_Moderators = value;
    m_ModeratorsIsSet = true;
}

bool GetModeratorsResponse_1::moderatorsIsSet() const
{
    return m_ModeratorsIsSet;
}

void GetModeratorsResponse_1::unsetModerators()
{
    m_ModeratorsIsSet = false;
}
utility::string_t GetModeratorsResponse_1::getReason() const
{
    return m_Reason;
}


void GetModeratorsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetModeratorsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetModeratorsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetModeratorsResponse_1::getCode() const
{
    return m_Code;
}


void GetModeratorsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetModeratorsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetModeratorsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetModeratorsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetModeratorsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetModeratorsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetModeratorsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetModeratorsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetModeratorsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetModeratorsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetModeratorsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetModeratorsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetModeratorsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetModeratorsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetModeratorsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetModeratorsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetModeratorsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetModeratorsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetModeratorsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetModeratorsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetModeratorsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetModeratorsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetModeratorsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
