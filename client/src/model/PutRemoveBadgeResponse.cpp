...
PutRemoveBadgeResponse::PutRemoveBadgeResponse()
{
    m_BadgesIsSet = false;
    m_StatusIsSet = false;
...
void PutRemoveBadgeResponse::validate()
{
    // TODO: implement validation
}

web::json::value PutRemoveBadgeResponse::toJson() const
{
...
bool PutRemoveBadgeResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PutRemoveBadgeResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PutRemoveBadgeResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<CommentUserBadgeInfo>> PutRemoveBadgeResponse::getBadges() const
{
    return m_Badges;
}


void PutRemoveBadgeResponse::setBadges(const std::vector<std::shared_ptr<CommentUserBadgeInfo>>& value)
{
    m_Badges = value;
    m_BadgesIsSet = true;
}

bool PutRemoveBadgeResponse::badgesIsSet() const
{
    return m_BadgesIsSet;
}

void PutRemoveBadgeResponse::unsetBadges()
{
    m_BadgesIsSet = false;
}
std::shared_ptr<APIStatus> PutRemoveBadgeResponse::getStatus() const
{
    return m_Status;
}


void PutRemoveBadgeResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PutRemoveBadgeResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PutRemoveBadgeResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PutRemoveBadgeResponse::getReason() const
{
    return m_Reason;
}


void PutRemoveBadgeResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PutRemoveBadgeResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PutRemoveBadgeResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PutRemoveBadgeResponse::getCode() const
{
    return m_Code;
}


void PutRemoveBadgeResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PutRemoveBadgeResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PutRemoveBadgeResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PutRemoveBadgeResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PutRemoveBadgeResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PutRemoveBadgeResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PutRemoveBadgeResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PutRemoveBadgeResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PutRemoveBadgeResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PutRemoveBadgeResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PutRemoveBadgeResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PutRemoveBadgeResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PutRemoveBadgeResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PutRemoveBadgeResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PutRemoveBadgeResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PutRemoveBadgeResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PutRemoveBadgeResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PutRemoveBadgeResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PutRemoveBadgeResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PutRemoveBadgeResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PutRemoveBadgeResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PutRemoveBadgeResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PutRemoveBadgeResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
