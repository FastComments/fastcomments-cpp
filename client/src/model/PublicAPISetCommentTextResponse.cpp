...
std::shared_ptr<APIStatus> PublicAPISetCommentTextResponse::getStatus() const
{
    return m_Status;
}


void PublicAPISetCommentTextResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
