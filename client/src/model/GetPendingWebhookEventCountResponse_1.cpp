...
GetPendingWebhookEventCountResponse_1::GetPendingWebhookEventCountResponse_1()
{
    m_StatusIsSet = false;
    m_Count = 0.0;
    m_CountIsSet = false;
...
void GetPendingWebhookEventCountResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetPendingWebhookEventCountResponse_1::toJson() const
{
...
bool GetPendingWebhookEventCountResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetPendingWebhookEventCountResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetPendingWebhookEventCountResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetPendingWebhookEventCountResponse_1::getStatus() const
{
    return m_Status;
}


void GetPendingWebhookEventCountResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetPendingWebhookEventCountResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetPendingWebhookEventCountResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
double GetPendingWebhookEventCountResponse_1::getCount() const
{
    return m_Count;
}

void GetPendingWebhookEventCountResponse_1::setCount(double value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool GetPendingWebhookEventCountResponse_1::countIsSet() const
{
    return m_CountIsSet;
}

void GetPendingWebhookEventCountResponse_1::unsetCount()
{
    m_CountIsSet = false;
}
utility::string_t GetPendingWebhookEventCountResponse_1::getReason() const
{
    return m_Reason;
}


void GetPendingWebhookEventCountResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetPendingWebhookEventCountResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetPendingWebhookEventCountResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetPendingWebhookEventCountResponse_1::getCode() const
{
    return m_Code;
}


void GetPendingWebhookEventCountResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetPendingWebhookEventCountResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetPendingWebhookEventCountResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetPendingWebhookEventCountResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetPendingWebhookEventCountResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetPendingWebhookEventCountResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetPendingWebhookEventCountResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetPendingWebhookEventCountResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetPendingWebhookEventCountResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetPendingWebhookEventCountResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetPendingWebhookEventCountResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetPendingWebhookEventCountResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetPendingWebhookEventCountResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetPendingWebhookEventCountResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetPendingWebhookEventCountResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetPendingWebhookEventCountResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetPendingWebhookEventCountResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetPendingWebhookEventCountResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetPendingWebhookEventCountResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetPendingWebhookEventCountResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetPendingWebhookEventCountResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetPendingWebhookEventCountResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetPendingWebhookEventCountResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
