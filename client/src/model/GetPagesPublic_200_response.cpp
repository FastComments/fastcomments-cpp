...
#include "FastCommentsClient/model/GetPagesPublic_200_response.h"
...
GetPagesPublic_200_response::GetPagesPublic_200_response()
{
    m_PagesIsSet = false;
    m_StatusIsSet = false;
...
void GetPagesPublic_200_response::validate()
{
    // TODO: implement validation
}

web::json::value GetPagesPublic_200_response::toJson() const
{
...
bool GetPagesPublic_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetPagesPublic_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetPagesPublic_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t GetPagesPublic_200_response::getNextCursor() const
{
    return m_NextCursor.get();
}


void GetPagesPublic_200_response::setNextCursor(const utility::string_t& value)
{
    m_NextCursor = value;
}

bool GetPagesPublic_200_response::nextCursorIsSet() const
{
    return m_NextCursor.has_value();
}

void GetPagesPublic_200_response::unsetNextCursor()
{
    m_NextCursor.reset();
}
std::vector<std::shared_ptr<PublicPage>> GetPagesPublic_200_response::getPages() const
{
    return m_Pages;
}


void GetPagesPublic_200_response::setPages(const std::vector<std::shared_ptr<PublicPage>>& value)
{
    m_Pages = value;
    m_PagesIsSet = true;
}

bool GetPagesPublic_200_response::pagesIsSet() const
{
    return m_PagesIsSet;
}

void GetPagesPublic_200_response::unsetPages()
{
    m_PagesIsSet = false;
}
std::shared_ptr<APIStatus> GetPagesPublic_200_response::getStatus() const
{
    return m_Status;
}


void GetPagesPublic_200_response::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetPagesPublic_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetPagesPublic_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetPagesPublic_200_response::getReason() const
{
    return m_Reason;
}


void GetPagesPublic_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetPagesPublic_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetPagesPublic_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetPagesPublic_200_response::getCode() const
{
    return m_Code;
}


void GetPagesPublic_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetPagesPublic_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetPagesPublic_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetPagesPublic_200_response::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetPagesPublic_200_response::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetPagesPublic_200_response::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetPagesPublic_200_response::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetPagesPublic_200_response::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetPagesPublic_200_response::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetPagesPublic_200_response::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetPagesPublic_200_response::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetPagesPublic_200_response::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetPagesPublic_200_response::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetPagesPublic_200_response::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetPagesPublic_200_response::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetPagesPublic_200_response::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetPagesPublic_200_response::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetPagesPublic_200_response::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetPagesPublic_200_response::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetPagesPublic_200_response::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetPagesPublic_200_response::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetPagesPublic_200_response::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetPagesPublic_200_response::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
