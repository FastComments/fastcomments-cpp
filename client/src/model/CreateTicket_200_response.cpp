...
CreateTicket_200_response::CreateTicket_200_response()
{
    m_StatusIsSet = false;
    m_TicketIsSet = false;
...
void CreateTicket_200_response::validate()
{
    // TODO: implement validation
}

web::json::value CreateTicket_200_response::toJson() const
{
...
bool CreateTicket_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateTicket_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateTicket_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> CreateTicket_200_response::getStatus() const
{
    return m_Status;
}


void CreateTicket_200_response::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CreateTicket_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void CreateTicket_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<APITicket> CreateTicket_200_response::getTicket() const
{
    return m_Ticket;
}


void CreateTicket_200_response::setTicket(const std::shared_ptr<APITicket>& value)
{
    m_Ticket = value;
    m_TicketIsSet = true;
}

bool CreateTicket_200_response::ticketIsSet() const
{
    return m_TicketIsSet;
}

void CreateTicket_200_response::unsetTicket()
{
    m_TicketIsSet = false;
}
utility::string_t CreateTicket_200_response::getReason() const
{
    return m_Reason;
}


void CreateTicket_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CreateTicket_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CreateTicket_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CreateTicket_200_response::getCode() const
{
    return m_Code;
}


void CreateTicket_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CreateTicket_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void CreateTicket_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CreateTicket_200_response::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CreateTicket_200_response::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CreateTicket_200_response::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CreateTicket_200_response::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CreateTicket_200_response::getBannedUntil() const
{
    return m_BannedUntil;
}

void CreateTicket_200_response::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CreateTicket_200_response::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CreateTicket_200_response::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CreateTicket_200_response::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CreateTicket_200_response::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CreateTicket_200_response::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CreateTicket_200_response::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CreateTicket_200_response::getTranslatedError() const
{
    return m_TranslatedError;
}


void CreateTicket_200_response::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CreateTicket_200_response::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CreateTicket_200_response::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CreateTicket_200_response::getCustomConfig() const
{
    return m_CustomConfig;
}


void CreateTicket_200_response::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CreateTicket_200_response::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CreateTicket_200_response::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
