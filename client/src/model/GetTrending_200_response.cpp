...
#include "FastCommentsClient/model/GetTrending_200_response.h"
...
GetTrending_200_response::GetTrending_200_response()
{
    m_ImagesIsSet = false;
    m_StatusIsSet = false;
...
void GetTrending_200_response::validate()
{
    // TODO: implement validation
}

web::json::value GetTrending_200_response::toJson() const
{
...
bool GetTrending_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetTrending_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetTrending_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::vector<std::shared_ptr<GifSearchResponse_images_inner_inner>>> GetTrending_200_response::getImages() const
{
    return m_Images;
}


void GetTrending_200_response::setImages(const std::vector<std::vector<std::shared_ptr<GifSearchResponse_images_inner_inner>>>& value)
{
    m_Images = value;
    m_ImagesIsSet = true;
}

bool GetTrending_200_response::imagesIsSet() const
{
    return m_ImagesIsSet;
}

void GetTrending_200_response::unsetImages()
{
    m_ImagesIsSet = false;
}
std::shared_ptr<APIStatus> GetTrending_200_response::getStatus() const
{
    return m_Status;
}


void GetTrending_200_response::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetTrending_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetTrending_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetTrending_200_response::getCode() const
{
    return m_Code;
}


void GetTrending_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetTrending_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetTrending_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
