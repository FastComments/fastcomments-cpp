...
CreateFeedPostPublicResponse::CreateFeedPostPublicResponse()
{
    m_StatusIsSet = false;
...
void CreateFeedPostPublicResponse::validate()
{
    // TODO: implement validation
}

web::json::value CreateFeedPostPublicResponse::toJson() const
{
...
bool CreateFeedPostPublicResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateFeedPostPublicResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateFeedPostPublicResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> CreateFeedPostPublicResponse::getStatus() const
{
    return m_Status;
}


void CreateFeedPostPublicResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CreateFeedPostPublicResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void CreateFeedPostPublicResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<FeedPost> CreateFeedPostPublicResponse::getFeedPost() const
{
    return m_FeedPost;
}


void CreateFeedPostPublicResponse::setFeedPost(const std::shared_ptr<FeedPost>& value)
{
    m_FeedPost = value;
    m_FeedPostIsSet = true;
}

bool CreateFeedPostPublicResponse::feedPostIsSet() const
{
    return m_FeedPostIsSet;
}

void CreateFeedPostPublicResponse::unsetFeedPost()
{
    m_FeedPostIsSet = false;
}
utility::string_t CreateFeedPostPublicResponse::getReason() const
{
    return m_Reason;
}


void CreateFeedPostPublicResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CreateFeedPostPublicResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CreateFeedPostPublicResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CreateFeedPostPublicResponse::getCode() const
{
    return m_Code;
}


void CreateFeedPostPublicResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CreateFeedPostPublicResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void CreateFeedPostPublicResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CreateFeedPostPublicResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CreateFeedPostPublicResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CreateFeedPostPublicResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CreateFeedPostPublicResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CreateFeedPostPublicResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void CreateFeedPostPublicResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CreateFeedPostPublicResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CreateFeedPostPublicResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CreateFeedPostPublicResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CreateFeedPostPublicResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CreateFeedPostPublicResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CreateFeedPostPublicResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CreateFeedPostPublicResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void CreateFeedPostPublicResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CreateFeedPostPublicResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CreateFeedPostPublicResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CreateFeedPostPublicResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void CreateFeedPostPublicResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CreateFeedPostPublicResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CreateFeedPostPublicResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
