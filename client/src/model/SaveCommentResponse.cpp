...
std::shared_ptr<ImportedAPIStatus_SUCCESS> SaveCommentResponse::getStatus() const
{
    return m_Status;
}


void SaveCommentResponse::setStatus(const std::shared_ptr<ImportedAPIStatus_SUCCESS>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
