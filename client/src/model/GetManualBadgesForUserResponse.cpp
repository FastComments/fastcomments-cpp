...
GetManualBadgesForUserResponse::GetManualBadgesForUserResponse()
{
    m_BadgesIsSet = false;
    m_StatusIsSet = false;
...
void GetManualBadgesForUserResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetManualBadgesForUserResponse::toJson() const
{
...
bool GetManualBadgesForUserResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetManualBadgesForUserResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetManualBadgesForUserResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<UserBadge>> GetManualBadgesForUserResponse::getBadges() const
{
    return m_Badges;
}


void GetManualBadgesForUserResponse::setBadges(const std::vector<std::shared_ptr<UserBadge>>& value)
{
    m_Badges = value;
    m_BadgesIsSet = true;
}

bool GetManualBadgesForUserResponse::badgesIsSet() const
{
    return m_BadgesIsSet;
}

void GetManualBadgesForUserResponse::unsetBadges()
{
    m_BadgesIsSet = false;
}
std::shared_ptr<APIStatus> GetManualBadgesForUserResponse::getStatus() const
{
    return m_Status;
}


void GetManualBadgesForUserResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetManualBadgesForUserResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetManualBadgesForUserResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetManualBadgesForUserResponse::getReason() const
{
    return m_Reason;
}


void GetManualBadgesForUserResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetManualBadgesForUserResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetManualBadgesForUserResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetManualBadgesForUserResponse::getCode() const
{
    return m_Code;
}


void GetManualBadgesForUserResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetManualBadgesForUserResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetManualBadgesForUserResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetManualBadgesForUserResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetManualBadgesForUserResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetManualBadgesForUserResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetManualBadgesForUserResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetManualBadgesForUserResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetManualBadgesForUserResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetManualBadgesForUserResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetManualBadgesForUserResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetManualBadgesForUserResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetManualBadgesForUserResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetManualBadgesForUserResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetManualBadgesForUserResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetManualBadgesForUserResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetManualBadgesForUserResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetManualBadgesForUserResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetManualBadgesForUserResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetManualBadgesForUserResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetManualBadgesForUserResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetManualBadgesForUserResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetManualBadgesForUserResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
