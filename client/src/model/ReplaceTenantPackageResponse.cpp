...
ReplaceTenantPackageResponse::ReplaceTenantPackageResponse()
{
    m_StatusIsSet = false;
...
void ReplaceTenantPackageResponse::validate()
{
    // TODO: implement validation
}

web::json::value ReplaceTenantPackageResponse::toJson() const
{
...
bool ReplaceTenantPackageResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ReplaceTenantPackageResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ReplaceTenantPackageResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> ReplaceTenantPackageResponse::getStatus() const
{
    return m_Status;
}


void ReplaceTenantPackageResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ReplaceTenantPackageResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void ReplaceTenantPackageResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t ReplaceTenantPackageResponse::getReason() const
{
    return m_Reason;
}


void ReplaceTenantPackageResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool ReplaceTenantPackageResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void ReplaceTenantPackageResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t ReplaceTenantPackageResponse::getCode() const
{
    return m_Code;
}


void ReplaceTenantPackageResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool ReplaceTenantPackageResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void ReplaceTenantPackageResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t ReplaceTenantPackageResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void ReplaceTenantPackageResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool ReplaceTenantPackageResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void ReplaceTenantPackageResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t ReplaceTenantPackageResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void ReplaceTenantPackageResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool ReplaceTenantPackageResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void ReplaceTenantPackageResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t ReplaceTenantPackageResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void ReplaceTenantPackageResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool ReplaceTenantPackageResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void ReplaceTenantPackageResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t ReplaceTenantPackageResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void ReplaceTenantPackageResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool ReplaceTenantPackageResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void ReplaceTenantPackageResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> ReplaceTenantPackageResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void ReplaceTenantPackageResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool ReplaceTenantPackageResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void ReplaceTenantPackageResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
