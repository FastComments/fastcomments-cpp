...
PatchHashTagResponse::PatchHashTagResponse()
{
    m_StatusIsSet = false;
...
void PatchHashTagResponse::validate()
{
    // TODO: implement validation
}

web::json::value PatchHashTagResponse::toJson() const
{
...
bool PatchHashTagResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PatchHashTagResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PatchHashTagResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> PatchHashTagResponse::getStatus() const
{
    return m_Status;
}


void PatchHashTagResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PatchHashTagResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PatchHashTagResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<TenantHashTag> PatchHashTagResponse::getHashTag() const
{
    return m_HashTag;
}


void PatchHashTagResponse::setHashTag(const std::shared_ptr<TenantHashTag>& value)
{
    m_HashTag = value;
    m_HashTagIsSet = true;
}

bool PatchHashTagResponse::hashTagIsSet() const
{
    return m_HashTagIsSet;
}

void PatchHashTagResponse::unsetHashTag()
{
    m_HashTagIsSet = false;
}
utility::string_t PatchHashTagResponse::getReason() const
{
    return m_Reason;
}


void PatchHashTagResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PatchHashTagResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PatchHashTagResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PatchHashTagResponse::getCode() const
{
    return m_Code;
}


void PatchHashTagResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PatchHashTagResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PatchHashTagResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PatchHashTagResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PatchHashTagResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PatchHashTagResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PatchHashTagResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PatchHashTagResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PatchHashTagResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PatchHashTagResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PatchHashTagResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PatchHashTagResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PatchHashTagResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PatchHashTagResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PatchHashTagResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PatchHashTagResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PatchHashTagResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PatchHashTagResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PatchHashTagResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PatchHashTagResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PatchHashTagResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PatchHashTagResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PatchHashTagResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
