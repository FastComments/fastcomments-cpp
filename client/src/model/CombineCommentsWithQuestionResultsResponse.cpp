...
CombineCommentsWithQuestionResultsResponse::CombineCommentsWithQuestionResultsResponse()
{
    m_StatusIsSet = false;
    m_DataIsSet = false;
...
void CombineCommentsWithQuestionResultsResponse::validate()
{
    // TODO: implement validation
}

web::json::value CombineCommentsWithQuestionResultsResponse::toJson() const
{
...
bool CombineCommentsWithQuestionResultsResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CombineCommentsWithQuestionResultsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CombineCommentsWithQuestionResultsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> CombineCommentsWithQuestionResultsResponse::getStatus() const
{
    return m_Status;
}


void CombineCommentsWithQuestionResultsResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CombineCommentsWithQuestionResultsResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void CombineCommentsWithQuestionResultsResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<FindCommentsByRangeResponse> CombineCommentsWithQuestionResultsResponse::getData() const
{
    return m_Data;
}


void CombineCommentsWithQuestionResultsResponse::setData(const std::shared_ptr<FindCommentsByRangeResponse>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool CombineCommentsWithQuestionResultsResponse::dataIsSet() const
{
    return m_DataIsSet;
}

void CombineCommentsWithQuestionResultsResponse::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t CombineCommentsWithQuestionResultsResponse::getReason() const
{
    return m_Reason;
}


void CombineCommentsWithQuestionResultsResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CombineCommentsWithQuestionResultsResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CombineCommentsWithQuestionResultsResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CombineCommentsWithQuestionResultsResponse::getCode() const
{
    return m_Code;
}


void CombineCommentsWithQuestionResultsResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CombineCommentsWithQuestionResultsResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void CombineCommentsWithQuestionResultsResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CombineCommentsWithQuestionResultsResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CombineCommentsWithQuestionResultsResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CombineCommentsWithQuestionResultsResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CombineCommentsWithQuestionResultsResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CombineCommentsWithQuestionResultsResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void CombineCommentsWithQuestionResultsResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CombineCommentsWithQuestionResultsResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CombineCommentsWithQuestionResultsResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CombineCommentsWithQuestionResultsResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CombineCommentsWithQuestionResultsResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CombineCommentsWithQuestionResultsResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CombineCommentsWithQuestionResultsResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CombineCommentsWithQuestionResultsResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void CombineCommentsWithQuestionResultsResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CombineCommentsWithQuestionResultsResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CombineCommentsWithQuestionResultsResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CombineCommentsWithQuestionResultsResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void CombineCommentsWithQuestionResultsResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CombineCommentsWithQuestionResultsResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CombineCommentsWithQuestionResultsResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
