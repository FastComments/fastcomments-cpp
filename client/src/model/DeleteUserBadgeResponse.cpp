...
DeleteUserBadgeResponse::DeleteUserBadgeResponse()
{
    m_StatusIsSet = false;
...
void DeleteUserBadgeResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteUserBadgeResponse::toJson() const
{
...
bool DeleteUserBadgeResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteUserBadgeResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteUserBadgeResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteUserBadgeResponse::getStatus() const
{
    return m_Status;
}


void DeleteUserBadgeResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteUserBadgeResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteUserBadgeResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteUserBadgeResponse::getReason() const
{
    return m_Reason;
}


void DeleteUserBadgeResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteUserBadgeResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteUserBadgeResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteUserBadgeResponse::getCode() const
{
    return m_Code;
}


void DeleteUserBadgeResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteUserBadgeResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteUserBadgeResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteUserBadgeResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteUserBadgeResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteUserBadgeResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteUserBadgeResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteUserBadgeResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteUserBadgeResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteUserBadgeResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteUserBadgeResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteUserBadgeResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteUserBadgeResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteUserBadgeResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteUserBadgeResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteUserBadgeResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteUserBadgeResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteUserBadgeResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteUserBadgeResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteUserBadgeResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteUserBadgeResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteUserBadgeResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteUserBadgeResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
