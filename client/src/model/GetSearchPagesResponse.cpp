...
GetSearchPagesResponse::GetSearchPagesResponse()
{
    m_PagesIsSet = false;
    m_StatusIsSet = false;
...
void GetSearchPagesResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetSearchPagesResponse::toJson() const
{
...
bool GetSearchPagesResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetSearchPagesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetSearchPagesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<ModerationPageSearchProjected>> GetSearchPagesResponse::getPages() const
{
    return m_Pages;
}


void GetSearchPagesResponse::setPages(const std::vector<std::shared_ptr<ModerationPageSearchProjected>>& value)
{
    m_Pages = value;
    m_PagesIsSet = true;
}

bool GetSearchPagesResponse::pagesIsSet() const
{
    return m_PagesIsSet;
}

void GetSearchPagesResponse::unsetPages()
{
    m_PagesIsSet = false;
}
std::shared_ptr<APIStatus> GetSearchPagesResponse::getStatus() const
{
    return m_Status;
}


void GetSearchPagesResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetSearchPagesResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetSearchPagesResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetSearchPagesResponse::getReason() const
{
    return m_Reason;
}


void GetSearchPagesResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetSearchPagesResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetSearchPagesResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetSearchPagesResponse::getCode() const
{
    return m_Code;
}


void GetSearchPagesResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetSearchPagesResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetSearchPagesResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetSearchPagesResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetSearchPagesResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetSearchPagesResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetSearchPagesResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetSearchPagesResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetSearchPagesResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetSearchPagesResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetSearchPagesResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetSearchPagesResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetSearchPagesResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetSearchPagesResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetSearchPagesResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetSearchPagesResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetSearchPagesResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetSearchPagesResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetSearchPagesResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetSearchPagesResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetSearchPagesResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetSearchPagesResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetSearchPagesResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
