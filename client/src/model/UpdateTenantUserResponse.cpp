...
UpdateTenantUserResponse::UpdateTenantUserResponse()
{
    m_StatusIsSet = false;
...
void UpdateTenantUserResponse::validate()
{
    // TODO: implement validation
}

web::json::value UpdateTenantUserResponse::toJson() const
{
...
bool UpdateTenantUserResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateTenantUserResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateTenantUserResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UpdateTenantUserResponse::getStatus() const
{
    return m_Status;
}


void UpdateTenantUserResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UpdateTenantUserResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UpdateTenantUserResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t UpdateTenantUserResponse::getReason() const
{
    return m_Reason;
}


void UpdateTenantUserResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UpdateTenantUserResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UpdateTenantUserResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UpdateTenantUserResponse::getCode() const
{
    return m_Code;
}


void UpdateTenantUserResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UpdateTenantUserResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UpdateTenantUserResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UpdateTenantUserResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UpdateTenantUserResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UpdateTenantUserResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UpdateTenantUserResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UpdateTenantUserResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UpdateTenantUserResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UpdateTenantUserResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UpdateTenantUserResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UpdateTenantUserResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UpdateTenantUserResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UpdateTenantUserResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UpdateTenantUserResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UpdateTenantUserResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UpdateTenantUserResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UpdateTenantUserResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UpdateTenantUserResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UpdateTenantUserResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UpdateTenantUserResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UpdateTenantUserResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UpdateTenantUserResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
