...
GetHashTagsResponse_1::GetHashTagsResponse_1()
{
    m_StatusIsSet = false;
...
void GetHashTagsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetHashTagsResponse_1::toJson() const
{
...
bool GetHashTagsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetHashTagsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetHashTagsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetHashTagsResponse_1::getStatus() const
{
    return m_Status;
}


void GetHashTagsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetHashTagsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetHashTagsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<TenantHashTag>> GetHashTagsResponse_1::getHashTags() const
{
    return m_HashTags;
}


void GetHashTagsResponse_1::setHashTags(const std::vector<std::shared_ptr<TenantHashTag>>& value)
{
    m_HashTags = value;
    m_HashTagsIsSet = true;
}

bool GetHashTagsResponse_1::hashTagsIsSet() const
{
    return m_HashTagsIsSet;
}

void GetHashTagsResponse_1::unsetHashTags()
{
    m_HashTagsIsSet = false;
}
utility::string_t GetHashTagsResponse_1::getReason() const
{
    return m_Reason;
}


void GetHashTagsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetHashTagsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetHashTagsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetHashTagsResponse_1::getCode() const
{
    return m_Code;
}


void GetHashTagsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetHashTagsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetHashTagsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetHashTagsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetHashTagsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetHashTagsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetHashTagsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetHashTagsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetHashTagsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetHashTagsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetHashTagsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetHashTagsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetHashTagsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetHashTagsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetHashTagsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetHashTagsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetHashTagsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetHashTagsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetHashTagsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetHashTagsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetHashTagsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetHashTagsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetHashTagsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
