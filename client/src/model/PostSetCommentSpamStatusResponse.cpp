...
PostSetCommentSpamStatusResponse::PostSetCommentSpamStatusResponse()
{
    m_StatusIsSet = false;
...
void PostSetCommentSpamStatusResponse::validate()
{
    // TODO: implement validation
}

web::json::value PostSetCommentSpamStatusResponse::toJson() const
{
...
bool PostSetCommentSpamStatusResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PostSetCommentSpamStatusResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PostSetCommentSpamStatusResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> PostSetCommentSpamStatusResponse::getStatus() const
{
    return m_Status;
}


void PostSetCommentSpamStatusResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PostSetCommentSpamStatusResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PostSetCommentSpamStatusResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PostSetCommentSpamStatusResponse::getReason() const
{
    return m_Reason;
}


void PostSetCommentSpamStatusResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PostSetCommentSpamStatusResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PostSetCommentSpamStatusResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PostSetCommentSpamStatusResponse::getCode() const
{
    return m_Code;
}


void PostSetCommentSpamStatusResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PostSetCommentSpamStatusResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PostSetCommentSpamStatusResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PostSetCommentSpamStatusResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PostSetCommentSpamStatusResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PostSetCommentSpamStatusResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PostSetCommentSpamStatusResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PostSetCommentSpamStatusResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PostSetCommentSpamStatusResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PostSetCommentSpamStatusResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PostSetCommentSpamStatusResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PostSetCommentSpamStatusResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PostSetCommentSpamStatusResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PostSetCommentSpamStatusResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PostSetCommentSpamStatusResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PostSetCommentSpamStatusResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PostSetCommentSpamStatusResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PostSetCommentSpamStatusResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PostSetCommentSpamStatusResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PostSetCommentSpamStatusResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PostSetCommentSpamStatusResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PostSetCommentSpamStatusResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PostSetCommentSpamStatusResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
