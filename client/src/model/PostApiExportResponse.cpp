...
PostApiExportResponse::PostApiExportResponse()
{
    m_StatusIsSet = false;
...
void PostApiExportResponse::validate()
{
    // TODO: implement validation
}

web::json::value PostApiExportResponse::toJson() const
{
...
bool PostApiExportResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PostApiExportResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PostApiExportResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> PostApiExportResponse::getStatus() const
{
    return m_Status;
}


void PostApiExportResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PostApiExportResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PostApiExportResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PostApiExportResponse::getBatchJobId() const
{
    return m_BatchJobId;
}


void PostApiExportResponse::setBatchJobId(const utility::string_t& value)
{
    m_BatchJobId = value;
    m_BatchJobIdIsSet = true;
}

bool PostApiExportResponse::batchJobIdIsSet() const
{
    return m_BatchJobIdIsSet;
}

void PostApiExportResponse::unsetBatchJobId()
{
    m_BatchJobIdIsSet = false;
}
utility::string_t PostApiExportResponse::getReason() const
{
    return m_Reason;
}


void PostApiExportResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PostApiExportResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PostApiExportResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PostApiExportResponse::getCode() const
{
    return m_Code;
}


void PostApiExportResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PostApiExportResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PostApiExportResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PostApiExportResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PostApiExportResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PostApiExportResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PostApiExportResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PostApiExportResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PostApiExportResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PostApiExportResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PostApiExportResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PostApiExportResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PostApiExportResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PostApiExportResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PostApiExportResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PostApiExportResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PostApiExportResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PostApiExportResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PostApiExportResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PostApiExportResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PostApiExportResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PostApiExportResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PostApiExportResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
