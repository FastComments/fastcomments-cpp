...
void UpdateNotificationResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateNotificationResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UpdateNotificationResponse::getStatus() const
{
    return m_Status;
}


void UpdateNotificationResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
...
utility::string_t UpdateNotificationResponse::getReason() const
{
    return m_Reason;
}


void UpdateNotificationResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UpdateNotificationResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UpdateNotificationResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UpdateNotificationResponse::getCode() const
{
    return m_Code;
}


void UpdateNotificationResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UpdateNotificationResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UpdateNotificationResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UpdateNotificationResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UpdateNotificationResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UpdateNotificationResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UpdateNotificationResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UpdateNotificationResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UpdateNotificationResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UpdateNotificationResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UpdateNotificationResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UpdateNotificationResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UpdateNotificationResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UpdateNotificationResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UpdateNotificationResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UpdateNotificationResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UpdateNotificationResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UpdateNotificationResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UpdateNotificationResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UpdateNotificationResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UpdateNotificationResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UpdateNotificationResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UpdateNotificationResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
