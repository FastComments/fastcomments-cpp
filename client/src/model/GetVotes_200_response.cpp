...
GetVotes_200_response::GetVotes_200_response()
{
    m_StatusIsSet = false;
...
void GetVotes_200_response::validate()
{
    // TODO: implement validation
}

web::json::value GetVotes_200_response::toJson() const
{
...
bool GetVotes_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetVotes_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetVotes_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetVotes_200_response::getStatus() const
{
    return m_Status;
}


void GetVotes_200_response::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetVotes_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetVotes_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<PublicVote>> GetVotes_200_response::getAppliedAuthorizedVotes() const
{
    return m_AppliedAuthorizedVotes;
}


void GetVotes_200_response::setAppliedAuthorizedVotes(const std::vector<std::shared_ptr<PublicVote>>& value)
{
    m_AppliedAuthorizedVotes = value;
    m_AppliedAuthorizedVotesIsSet = true;
}

bool GetVotes_200_response::appliedAuthorizedVotesIsSet() const
{
    return m_AppliedAuthorizedVotesIsSet;
}

void GetVotes_200_response::unsetAppliedAuthorizedVotes()
{
    m_AppliedAuthorizedVotesIsSet = false;
}
std::vector<std::shared_ptr<PublicVote>> GetVotes_200_response::getAppliedAnonymousVotes() const
{
    return m_AppliedAnonymousVotes;
}


void GetVotes_200_response::setAppliedAnonymousVotes(const std::vector<std::shared_ptr<PublicVote>>& value)
{
    m_AppliedAnonymousVotes = value;
    m_AppliedAnonymousVotesIsSet = true;
}

bool GetVotes_200_response::appliedAnonymousVotesIsSet() const
{
    return m_AppliedAnonymousVotesIsSet;
}

void GetVotes_200_response::unsetAppliedAnonymousVotes()
{
    m_AppliedAnonymousVotesIsSet = false;
}
std::vector<std::shared_ptr<PublicVote>> GetVotes_200_response::getPendingVotes() const
{
    return m_PendingVotes;
}


void GetVotes_200_response::setPendingVotes(const std::vector<std::shared_ptr<PublicVote>>& value)
{
    m_PendingVotes = value;
    m_PendingVotesIsSet = true;
}

bool GetVotes_200_response::pendingVotesIsSet() const
{
    return m_PendingVotesIsSet;
}

void GetVotes_200_response::unsetPendingVotes()
{
    m_PendingVotesIsSet = false;
}
utility::string_t GetVotes_200_response::getReason() const
{
    return m_Reason;
}


void GetVotes_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetVotes_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetVotes_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetVotes_200_response::getCode() const
{
    return m_Code;
}


void GetVotes_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetVotes_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetVotes_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetVotes_200_response::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetVotes_200_response::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetVotes_200_response::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetVotes_200_response::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetVotes_200_response::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetVotes_200_response::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetVotes_200_response::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetVotes_200_response::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetVotes_200_response::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetVotes_200_response::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetVotes_200_response::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetVotes_200_response::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetVotes_200_response::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetVotes_200_response::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetVotes_200_response::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetVotes_200_response::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetVotes_200_response::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetVotes_200_response::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetVotes_200_response::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetVotes_200_response::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
