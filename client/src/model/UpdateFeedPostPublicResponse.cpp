...
UpdateFeedPostPublicResponse::UpdateFeedPostPublicResponse()
{
    m_StatusIsSet = false;
...
void UpdateFeedPostPublicResponse::validate()
{
    // TODO: implement validation
}

web::json::value UpdateFeedPostPublicResponse::toJson() const
{
...
bool UpdateFeedPostPublicResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateFeedPostPublicResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateFeedPostPublicResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UpdateFeedPostPublicResponse::getStatus() const
{
    return m_Status;
}


void UpdateFeedPostPublicResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UpdateFeedPostPublicResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UpdateFeedPostPublicResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<FeedPost> UpdateFeedPostPublicResponse::getFeedPost() const
{
    return m_FeedPost;
}


void UpdateFeedPostPublicResponse::setFeedPost(const std::shared_ptr<FeedPost>& value)
{
    m_FeedPost = value;
    m_FeedPostIsSet = true;
}

bool UpdateFeedPostPublicResponse::feedPostIsSet() const
{
    return m_FeedPostIsSet;
}

void UpdateFeedPostPublicResponse::unsetFeedPost()
{
    m_FeedPostIsSet = false;
}
utility::string_t UpdateFeedPostPublicResponse::getReason() const
{
    return m_Reason;
}


void UpdateFeedPostPublicResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UpdateFeedPostPublicResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UpdateFeedPostPublicResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UpdateFeedPostPublicResponse::getCode() const
{
    return m_Code;
}


void UpdateFeedPostPublicResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UpdateFeedPostPublicResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UpdateFeedPostPublicResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UpdateFeedPostPublicResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UpdateFeedPostPublicResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UpdateFeedPostPublicResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UpdateFeedPostPublicResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UpdateFeedPostPublicResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UpdateFeedPostPublicResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UpdateFeedPostPublicResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UpdateFeedPostPublicResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UpdateFeedPostPublicResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UpdateFeedPostPublicResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UpdateFeedPostPublicResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UpdateFeedPostPublicResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UpdateFeedPostPublicResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UpdateFeedPostPublicResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UpdateFeedPostPublicResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UpdateFeedPostPublicResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UpdateFeedPostPublicResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UpdateFeedPostPublicResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UpdateFeedPostPublicResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UpdateFeedPostPublicResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
