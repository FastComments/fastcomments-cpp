...
PutAwardBadgeResponse::PutAwardBadgeResponse()
{
    m_NotesIsSet = false;
    m_BadgesIsSet = false;
    m_StatusIsSet = false;
...
void PutAwardBadgeResponse::validate()
{
    // TODO: implement validation
}

web::json::value PutAwardBadgeResponse::toJson() const
{
...
bool PutAwardBadgeResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PutAwardBadgeResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PutAwardBadgeResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<utility::string_t> PutAwardBadgeResponse::getNotes() const
{
    return m_Notes;
}


void PutAwardBadgeResponse::setNotes(const std::vector<utility::string_t>& value)
{
    m_Notes = value;
    m_NotesIsSet = true;
}

bool PutAwardBadgeResponse::notesIsSet() const
{
    return m_NotesIsSet;
}

void PutAwardBadgeResponse::unsetNotes()
{
    m_NotesIsSet = false;
}
std::vector<std::shared_ptr<CommentUserBadgeInfo>> PutAwardBadgeResponse::getBadges() const
{
    return m_Badges;
}


void PutAwardBadgeResponse::setBadges(const std::vector<std::shared_ptr<CommentUserBadgeInfo>>& value)
{
    m_Badges = value;
    m_BadgesIsSet = true;
}

bool PutAwardBadgeResponse::badgesIsSet() const
{
    return m_BadgesIsSet;
}

void PutAwardBadgeResponse::unsetBadges()
{
    m_BadgesIsSet = false;
}
std::shared_ptr<APIStatus> PutAwardBadgeResponse::getStatus() const
{
    return m_Status;
}


void PutAwardBadgeResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PutAwardBadgeResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PutAwardBadgeResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PutAwardBadgeResponse::getReason() const
{
    return m_Reason;
}


void PutAwardBadgeResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PutAwardBadgeResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PutAwardBadgeResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PutAwardBadgeResponse::getCode() const
{
    return m_Code;
}


void PutAwardBadgeResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PutAwardBadgeResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PutAwardBadgeResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PutAwardBadgeResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PutAwardBadgeResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PutAwardBadgeResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PutAwardBadgeResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PutAwardBadgeResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PutAwardBadgeResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PutAwardBadgeResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PutAwardBadgeResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PutAwardBadgeResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PutAwardBadgeResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PutAwardBadgeResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PutAwardBadgeResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PutAwardBadgeResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PutAwardBadgeResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PutAwardBadgeResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PutAwardBadgeResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PutAwardBadgeResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PutAwardBadgeResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PutAwardBadgeResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PutAwardBadgeResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
