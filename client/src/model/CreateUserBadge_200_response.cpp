...
CreateUserBadge_200_response::CreateUserBadge_200_response()
{
    m_StatusIsSet = false;
...
void CreateUserBadge_200_response::validate()
{
    // TODO: implement validation
}

web::json::value CreateUserBadge_200_response::toJson() const
{
...
bool CreateUserBadge_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateUserBadge_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateUserBadge_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ImportedAPIStatus_FAILED> CreateUserBadge_200_response::getStatus() const
{
    return m_Status;
}


void CreateUserBadge_200_response::setStatus(const std::shared_ptr<ImportedAPIStatus_FAILED>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CreateUserBadge_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void CreateUserBadge_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<UserBadge> CreateUserBadge_200_response::getUserBadge() const
{
    return m_UserBadge;
}


void CreateUserBadge_200_response::setUserBadge(const std::shared_ptr<UserBadge>& value)
{
    m_UserBadge = value;
    m_UserBadgeIsSet = true;
}

bool CreateUserBadge_200_response::userBadgeIsSet() const
{
...
void CreateUserBadge_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CreateUserBadge_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CreateUserBadge_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CreateUserBadge_200_response::getCode() const
{
    return m_Code;
}


void CreateUserBadge_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CreateUserBadge_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void CreateUserBadge_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CreateUserBadge_200_response::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CreateUserBadge_200_response::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CreateUserBadge_200_response::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CreateUserBadge_200_response::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CreateUserBadge_200_response::getBannedUntil() const
{
    return m_BannedUntil;
}

void CreateUserBadge_200_response::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CreateUserBadge_200_response::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CreateUserBadge_200_response::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CreateUserBadge_200_response::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CreateUserBadge_200_response::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CreateUserBadge_200_response::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CreateUserBadge_200_response::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CreateUserBadge_200_response::getTranslatedError() const
{
    return m_TranslatedError;
}


void CreateUserBadge_200_response::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CreateUserBadge_200_response::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CreateUserBadge_200_response::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CreateUserBadge_200_response::getCustomConfig() const
{
    return m_CustomConfig;
}


void CreateUserBadge_200_response::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CreateUserBadge_200_response::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CreateUserBadge_200_response::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
