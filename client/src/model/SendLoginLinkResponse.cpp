...
SendLoginLinkResponse::SendLoginLinkResponse()
{
    m_StatusIsSet = false;
...
void SendLoginLinkResponse::validate()
{
    // TODO: implement validation
}

web::json::value SendLoginLinkResponse::toJson() const
{
...
bool SendLoginLinkResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendLoginLinkResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendLoginLinkResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> SendLoginLinkResponse::getStatus() const
{
    return m_Status;
}


void SendLoginLinkResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool SendLoginLinkResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void SendLoginLinkResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t SendLoginLinkResponse::getReason() const
{
    return m_Reason;
}


void SendLoginLinkResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool SendLoginLinkResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void SendLoginLinkResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t SendLoginLinkResponse::getCode() const
{
    return m_Code;
}


void SendLoginLinkResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool SendLoginLinkResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void SendLoginLinkResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t SendLoginLinkResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void SendLoginLinkResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool SendLoginLinkResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void SendLoginLinkResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t SendLoginLinkResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void SendLoginLinkResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool SendLoginLinkResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void SendLoginLinkResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t SendLoginLinkResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void SendLoginLinkResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool SendLoginLinkResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void SendLoginLinkResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t SendLoginLinkResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void SendLoginLinkResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool SendLoginLinkResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void SendLoginLinkResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> SendLoginLinkResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void SendLoginLinkResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool SendLoginLinkResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void SendLoginLinkResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
