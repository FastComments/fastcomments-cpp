...
PostRestoreDeletedCommentResponse::PostRestoreDeletedCommentResponse()
{
    m_StatusIsSet = false;
...
void PostRestoreDeletedCommentResponse::validate()
{
    // TODO: implement validation
}

web::json::value PostRestoreDeletedCommentResponse::toJson() const
{
...
bool PostRestoreDeletedCommentResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PostRestoreDeletedCommentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PostRestoreDeletedCommentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> PostRestoreDeletedCommentResponse::getStatus() const
{
    return m_Status;
}


void PostRestoreDeletedCommentResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PostRestoreDeletedCommentResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PostRestoreDeletedCommentResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PostRestoreDeletedCommentResponse::getReason() const
{
    return m_Reason;
}


void PostRestoreDeletedCommentResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PostRestoreDeletedCommentResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PostRestoreDeletedCommentResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PostRestoreDeletedCommentResponse::getCode() const
{
    return m_Code;
}


void PostRestoreDeletedCommentResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PostRestoreDeletedCommentResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PostRestoreDeletedCommentResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PostRestoreDeletedCommentResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PostRestoreDeletedCommentResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PostRestoreDeletedCommentResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PostRestoreDeletedCommentResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PostRestoreDeletedCommentResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PostRestoreDeletedCommentResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PostRestoreDeletedCommentResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PostRestoreDeletedCommentResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PostRestoreDeletedCommentResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PostRestoreDeletedCommentResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PostRestoreDeletedCommentResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PostRestoreDeletedCommentResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PostRestoreDeletedCommentResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PostRestoreDeletedCommentResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PostRestoreDeletedCommentResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PostRestoreDeletedCommentResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PostRestoreDeletedCommentResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PostRestoreDeletedCommentResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PostRestoreDeletedCommentResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PostRestoreDeletedCommentResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
