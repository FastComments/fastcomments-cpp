...
GetNotificationsResponse_1::GetNotificationsResponse_1()
{
    m_StatusIsSet = false;
...
void GetNotificationsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetNotificationsResponse_1::toJson() const
{
...
bool GetNotificationsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetNotificationsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetNotificationsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetNotificationsResponse_1::getStatus() const
{
    return m_Status;
}


void GetNotificationsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetNotificationsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetNotificationsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<UserNotification>> GetNotificationsResponse_1::getNotifications() const
{
    return m_Notifications;
}


void GetNotificationsResponse_1::setNotifications(const std::vector<std::shared_ptr<UserNotification>>& value)
{
    m_Notifications = value;
    m_NotificationsIsSet = true;
}

bool GetNotificationsResponse_1::notificationsIsSet() const
{
    return m_NotificationsIsSet;
}

void GetNotificationsResponse_1::unsetNotifications()
{
    m_NotificationsIsSet = false;
}
utility::string_t GetNotificationsResponse_1::getReason() const
{
    return m_Reason;
}


void GetNotificationsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetNotificationsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetNotificationsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetNotificationsResponse_1::getCode() const
{
    return m_Code;
}


void GetNotificationsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetNotificationsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetNotificationsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetNotificationsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetNotificationsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetNotificationsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetNotificationsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetNotificationsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetNotificationsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetNotificationsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetNotificationsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetNotificationsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetNotificationsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetNotificationsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetNotificationsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetNotificationsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetNotificationsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetNotificationsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetNotificationsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetNotificationsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetNotificationsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetNotificationsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetNotificationsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
