...
GetEmailTemplateResponse_1::GetEmailTemplateResponse_1()
{
    m_StatusIsSet = false;
...
void GetEmailTemplateResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetEmailTemplateResponse_1::toJson() const
{
...
bool GetEmailTemplateResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetEmailTemplateResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetEmailTemplateResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetEmailTemplateResponse_1::getStatus() const
{
    return m_Status;
}


void GetEmailTemplateResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetEmailTemplateResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetEmailTemplateResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<CustomEmailTemplate> GetEmailTemplateResponse_1::getEmailTemplate() const
{
    return m_EmailTemplate;
}


void GetEmailTemplateResponse_1::setEmailTemplate(const std::shared_ptr<CustomEmailTemplate>& value)
{
    m_EmailTemplate = value;
    m_EmailTemplateIsSet = true;
}

bool GetEmailTemplateResponse_1::emailTemplateIsSet() const
{
    return m_EmailTemplateIsSet;
}

void GetEmailTemplateResponse_1::unsetEmailTemplate()
{
    m_EmailTemplateIsSet = false;
}
utility::string_t GetEmailTemplateResponse_1::getReason() const
{
    return m_Reason;
}


void GetEmailTemplateResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetEmailTemplateResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetEmailTemplateResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetEmailTemplateResponse_1::getCode() const
{
    return m_Code;
}


void GetEmailTemplateResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetEmailTemplateResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetEmailTemplateResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetEmailTemplateResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetEmailTemplateResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetEmailTemplateResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetEmailTemplateResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetEmailTemplateResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetEmailTemplateResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetEmailTemplateResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetEmailTemplateResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetEmailTemplateResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetEmailTemplateResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetEmailTemplateResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetEmailTemplateResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetEmailTemplateResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetEmailTemplateResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetEmailTemplateResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetEmailTemplateResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetEmailTemplateResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetEmailTemplateResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetEmailTemplateResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetEmailTemplateResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
