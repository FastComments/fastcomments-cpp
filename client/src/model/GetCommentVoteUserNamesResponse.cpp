...
GetCommentVoteUserNamesResponse::GetCommentVoteUserNamesResponse()
{
    m_StatusIsSet = false;
...
void GetCommentVoteUserNamesResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetCommentVoteUserNamesResponse::toJson() const
{
...
bool GetCommentVoteUserNamesResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetCommentVoteUserNamesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetCommentVoteUserNamesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetCommentVoteUserNamesResponse::getStatus() const
{
    return m_Status;
}


void GetCommentVoteUserNamesResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetCommentVoteUserNamesResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetCommentVoteUserNamesResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<utility::string_t> GetCommentVoteUserNamesResponse::getVoteUserNames() const
{
    return m_VoteUserNames;
}


void GetCommentVoteUserNamesResponse::setVoteUserNames(const std::vector<utility::string_t>& value)
{
    m_VoteUserNames = value;
    m_VoteUserNamesIsSet = true;
}

bool GetCommentVoteUserNamesResponse::voteUserNamesIsSet() const
{
    return m_VoteUserNamesIsSet;
}

void GetCommentVoteUserNamesResponse::unsetVoteUserNames()
{
    m_VoteUserNamesIsSet = false;
}
bool GetCommentVoteUserNamesResponse::isHasMore() const
{
    return m_HasMore;
}

void GetCommentVoteUserNamesResponse::setHasMore(bool value)
{
    m_HasMore = value;
    m_HasMoreIsSet = true;
}

bool GetCommentVoteUserNamesResponse::hasMoreIsSet() const
{
    return m_HasMoreIsSet;
}

void GetCommentVoteUserNamesResponse::unsetHasMore()
{
    m_HasMoreIsSet = false;
}
utility::string_t GetCommentVoteUserNamesResponse::getReason() const
{
    return m_Reason;
}


void GetCommentVoteUserNamesResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetCommentVoteUserNamesResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetCommentVoteUserNamesResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetCommentVoteUserNamesResponse::getCode() const
{
    return m_Code;
}


void GetCommentVoteUserNamesResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetCommentVoteUserNamesResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetCommentVoteUserNamesResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetCommentVoteUserNamesResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetCommentVoteUserNamesResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetCommentVoteUserNamesResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetCommentVoteUserNamesResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetCommentVoteUserNamesResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetCommentVoteUserNamesResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetCommentVoteUserNamesResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetCommentVoteUserNamesResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetCommentVoteUserNamesResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetCommentVoteUserNamesResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetCommentVoteUserNamesResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetCommentVoteUserNamesResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetCommentVoteUserNamesResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetCommentVoteUserNamesResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetCommentVoteUserNamesResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetCommentVoteUserNamesResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetCommentVoteUserNamesResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetCommentVoteUserNamesResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetCommentVoteUserNamesResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetCommentVoteUserNamesResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
