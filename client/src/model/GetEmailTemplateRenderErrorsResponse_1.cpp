...
GetEmailTemplateRenderErrorsResponse_1::GetEmailTemplateRenderErrorsResponse_1()
{
    m_StatusIsSet = false;
...
void GetEmailTemplateRenderErrorsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetEmailTemplateRenderErrorsResponse_1::toJson() const
{
...
bool GetEmailTemplateRenderErrorsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetEmailTemplateRenderErrorsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetEmailTemplateRenderErrorsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetEmailTemplateRenderErrorsResponse_1::getStatus() const
{
    return m_Status;
}


void GetEmailTemplateRenderErrorsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetEmailTemplateRenderErrorsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetEmailTemplateRenderErrorsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<EmailTemplateRenderErrorResponse>> GetEmailTemplateRenderErrorsResponse_1::getRenderErrors() const
{
    return m_RenderErrors;
}


void GetEmailTemplateRenderErrorsResponse_1::setRenderErrors(const std::vector<std::shared_ptr<EmailTemplateRenderErrorResponse>>& value)
{
    m_RenderErrors = value;
    m_RenderErrorsIsSet = true;
}

bool GetEmailTemplateRenderErrorsResponse_1::renderErrorsIsSet() const
{
    return m_RenderErrorsIsSet;
}

void GetEmailTemplateRenderErrorsResponse_1::unsetRenderErrors()
{
    m_RenderErrorsIsSet = false;
}
utility::string_t GetEmailTemplateRenderErrorsResponse_1::getReason() const
{
    return m_Reason;
}


void GetEmailTemplateRenderErrorsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetEmailTemplateRenderErrorsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetEmailTemplateRenderErrorsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetEmailTemplateRenderErrorsResponse_1::getCode() const
{
    return m_Code;
}


void GetEmailTemplateRenderErrorsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetEmailTemplateRenderErrorsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetEmailTemplateRenderErrorsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetEmailTemplateRenderErrorsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetEmailTemplateRenderErrorsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetEmailTemplateRenderErrorsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetEmailTemplateRenderErrorsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetEmailTemplateRenderErrorsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetEmailTemplateRenderErrorsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetEmailTemplateRenderErrorsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetEmailTemplateRenderErrorsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetEmailTemplateRenderErrorsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetEmailTemplateRenderErrorsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetEmailTemplateRenderErrorsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetEmailTemplateRenderErrorsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetEmailTemplateRenderErrorsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetEmailTemplateRenderErrorsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetEmailTemplateRenderErrorsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetEmailTemplateRenderErrorsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetEmailTemplateRenderErrorsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetEmailTemplateRenderErrorsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetEmailTemplateRenderErrorsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetEmailTemplateRenderErrorsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
