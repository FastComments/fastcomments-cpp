...
UnBlockCommentPublicResponse::UnBlockCommentPublicResponse()
{
    m_StatusIsSet = false;
...
void UnBlockCommentPublicResponse::validate()
{
    // TODO: implement validation
}

web::json::value UnBlockCommentPublicResponse::toJson() const
{
...
bool UnBlockCommentPublicResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UnBlockCommentPublicResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UnBlockCommentPublicResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UnBlockCommentPublicResponse::getStatus() const
{
    return m_Status;
}


void UnBlockCommentPublicResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UnBlockCommentPublicResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UnBlockCommentPublicResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::map<utility::string_t, bool> UnBlockCommentPublicResponse::getCommentStatuses() const
{
    return m_CommentStatuses;
}

void UnBlockCommentPublicResponse::setCommentStatuses(std::map<utility::string_t, bool> value)
{
    m_CommentStatuses = value;
    m_CommentStatusesIsSet = true;
}

bool UnBlockCommentPublicResponse::commentStatusesIsSet() const
{
    return m_CommentStatusesIsSet;
}

void UnBlockCommentPublicResponse::unsetCommentStatuses()
{
    m_CommentStatusesIsSet = false;
}
utility::string_t UnBlockCommentPublicResponse::getReason() const
{
    return m_Reason;
}


void UnBlockCommentPublicResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UnBlockCommentPublicResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UnBlockCommentPublicResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UnBlockCommentPublicResponse::getCode() const
{
    return m_Code;
}


void UnBlockCommentPublicResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UnBlockCommentPublicResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UnBlockCommentPublicResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UnBlockCommentPublicResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UnBlockCommentPublicResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UnBlockCommentPublicResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UnBlockCommentPublicResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UnBlockCommentPublicResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UnBlockCommentPublicResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UnBlockCommentPublicResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UnBlockCommentPublicResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UnBlockCommentPublicResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UnBlockCommentPublicResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UnBlockCommentPublicResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UnBlockCommentPublicResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UnBlockCommentPublicResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UnBlockCommentPublicResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UnBlockCommentPublicResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UnBlockCommentPublicResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UnBlockCommentPublicResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UnBlockCommentPublicResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UnBlockCommentPublicResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UnBlockCommentPublicResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
