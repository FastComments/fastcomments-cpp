...
void UpdateTenantResponse::validate()
{
    // TODO: implement validation
}

web::json::value UpdateTenantResponse::toJson() const
{
...
bool UpdateTenantResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateTenantResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateTenantResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UpdateTenantResponse::getStatus() const
{
    return m_Status;
}


void UpdateTenantResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UpdateTenantResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UpdateTenantResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t UpdateTenantResponse::getReason() const
{
    return m_Reason;
}


void UpdateTenantResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UpdateTenantResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UpdateTenantResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UpdateTenantResponse::getCode() const
{
    return m_Code;
}


void UpdateTenantResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UpdateTenantResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UpdateTenantResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UpdateTenantResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UpdateTenantResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UpdateTenantResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UpdateTenantResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UpdateTenantResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UpdateTenantResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UpdateTenantResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UpdateTenantResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UpdateTenantResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UpdateTenantResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UpdateTenantResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UpdateTenantResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UpdateTenantResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UpdateTenantResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UpdateTenantResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UpdateTenantResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UpdateTenantResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UpdateTenantResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UpdateTenantResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UpdateTenantResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
