...
PostFlagCommentResponse::PostFlagCommentResponse()
{
    m_StatusIsSet = false;
...
void PostFlagCommentResponse::validate()
{
    // TODO: implement validation
}

web::json::value PostFlagCommentResponse::toJson() const
{
...
bool PostFlagCommentResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PostFlagCommentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PostFlagCommentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> PostFlagCommentResponse::getStatus() const
{
    return m_Status;
}


void PostFlagCommentResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PostFlagCommentResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PostFlagCommentResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PostFlagCommentResponse::getReason() const
{
    return m_Reason;
}


void PostFlagCommentResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PostFlagCommentResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PostFlagCommentResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PostFlagCommentResponse::getCode() const
{
    return m_Code;
}


void PostFlagCommentResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PostFlagCommentResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PostFlagCommentResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PostFlagCommentResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PostFlagCommentResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PostFlagCommentResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PostFlagCommentResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PostFlagCommentResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PostFlagCommentResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PostFlagCommentResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PostFlagCommentResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PostFlagCommentResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PostFlagCommentResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PostFlagCommentResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PostFlagCommentResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PostFlagCommentResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PostFlagCommentResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PostFlagCommentResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PostFlagCommentResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PostFlagCommentResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PostFlagCommentResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PostFlagCommentResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PostFlagCommentResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
