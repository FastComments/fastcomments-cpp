...
void DeleteTenantResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteTenantResponse::toJson() const
{
...
bool DeleteTenantResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteTenantResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteTenantResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteTenantResponse::getStatus() const
{
    return m_Status;
}


void DeleteTenantResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteTenantResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteTenantResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteTenantResponse::getReason() const
{
    return m_Reason;
}


void DeleteTenantResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteTenantResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteTenantResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteTenantResponse::getCode() const
{
    return m_Code;
}


void DeleteTenantResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteTenantResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteTenantResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteTenantResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteTenantResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteTenantResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteTenantResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteTenantResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteTenantResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteTenantResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteTenantResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteTenantResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteTenantResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteTenantResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteTenantResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteTenantResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteTenantResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteTenantResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteTenantResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteTenantResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteTenantResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteTenantResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteTenantResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
