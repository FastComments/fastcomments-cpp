...
void GetCountResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetCountResponse::toJson() const
{
...
bool GetCountResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetCountResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetCountResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetCountResponse::getStatus() const
{
    return m_Status;
}


void GetCountResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetCountResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetCountResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
double GetCountResponse::getCount() const
{
    return m_Count;
}

void GetCountResponse::setCount(double value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool GetCountResponse::countIsSet() const
{
    return m_CountIsSet;
}

void GetCountResponse::unsetCount()
{
    m_CountIsSet = false;
}
utility::string_t GetCountResponse::getReason() const
{
    return m_Reason;
}


void GetCountResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetCountResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetCountResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetCountResponse::getCode() const
{
    return m_Code;
}


void GetCountResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetCountResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetCountResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetCountResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetCountResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetCountResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetCountResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetCountResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetCountResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetCountResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetCountResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetCountResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetCountResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetCountResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetCountResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetCountResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetCountResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetCountResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetCountResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetCountResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetCountResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetCountResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetCountResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
