...
FlagCommentPublicResponse::FlagCommentPublicResponse()
{
    m_StatusIsSet = false;
...
void FlagCommentPublicResponse::validate()
{
    // TODO: implement validation
}

web::json::value FlagCommentPublicResponse::toJson() const
{
...
bool FlagCommentPublicResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void FlagCommentPublicResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool FlagCommentPublicResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> FlagCommentPublicResponse::getStatus() const
{
    return m_Status;
}


void FlagCommentPublicResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool FlagCommentPublicResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void FlagCommentPublicResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t FlagCommentPublicResponse::getReason() const
{
    return m_Reason;
}


void FlagCommentPublicResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool FlagCommentPublicResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void FlagCommentPublicResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t FlagCommentPublicResponse::getCode() const
{
    return m_Code;
}


void FlagCommentPublicResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool FlagCommentPublicResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void FlagCommentPublicResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t FlagCommentPublicResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void FlagCommentPublicResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool FlagCommentPublicResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void FlagCommentPublicResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t FlagCommentPublicResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void FlagCommentPublicResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool FlagCommentPublicResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void FlagCommentPublicResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t FlagCommentPublicResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void FlagCommentPublicResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool FlagCommentPublicResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void FlagCommentPublicResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t FlagCommentPublicResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void FlagCommentPublicResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool FlagCommentPublicResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void FlagCommentPublicResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> FlagCommentPublicResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void FlagCommentPublicResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool FlagCommentPublicResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void FlagCommentPublicResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
