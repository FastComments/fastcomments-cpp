...
void UpdateCommentResponse::validate()
{
    // TODO: implement validation
}

web::json::value UpdateCommentResponse::toJson() const
{
...
bool UpdateCommentResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateCommentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateCommentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UpdateCommentResponse::getStatus() const
{
    return m_Status;
}


void UpdateCommentResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UpdateCommentResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UpdateCommentResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t UpdateCommentResponse::getReason() const
{
    return m_Reason;
}


void UpdateCommentResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UpdateCommentResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UpdateCommentResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UpdateCommentResponse::getCode() const
{
    return m_Code;
}


void UpdateCommentResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UpdateCommentResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UpdateCommentResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UpdateCommentResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UpdateCommentResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UpdateCommentResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UpdateCommentResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UpdateCommentResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UpdateCommentResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UpdateCommentResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UpdateCommentResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UpdateCommentResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UpdateCommentResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UpdateCommentResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UpdateCommentResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UpdateCommentResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UpdateCommentResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UpdateCommentResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UpdateCommentResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UpdateCommentResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UpdateCommentResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UpdateCommentResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UpdateCommentResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
