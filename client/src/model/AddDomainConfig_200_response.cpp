...
AddDomainConfig_200_response::AddDomainConfig_200_response()
{
...
void AddDomainConfig_200_response::validate()
{
    // TODO: implement validation
}

web::json::value AddDomainConfig_200_response::toJson() const
{
...
bool AddDomainConfig_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AddDomainConfig_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AddDomainConfig_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t AddDomainConfig_200_response::getReason() const
{
    return m_Reason;
}


void AddDomainConfig_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool AddDomainConfig_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void AddDomainConfig_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t AddDomainConfig_200_response::getCode() const
{
    return m_Code;
}


void AddDomainConfig_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool AddDomainConfig_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void AddDomainConfig_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
std::shared_ptr<Object> AddDomainConfig_200_response::getStatus() const
{
    return m_Status.get();
}


void AddDomainConfig_200_response::setStatus(const std::shared_ptr<Object>& value)
{
    m_Status = value;
}

bool AddDomainConfig_200_response::statusIsSet() const
{
    return m_Status.has_value();
}

void AddDomainConfig_200_response::unsetStatus()
{
    m_Status.reset();
}
std::shared_ptr<Object> AddDomainConfig_200_response::getConfiguration() const
{
    return m_Configuration.get();
}


void AddDomainConfig_200_response::setConfiguration(const std::shared_ptr<Object>& value)
{
    m_Configuration = value;
}

bool AddDomainConfig_200_response::configurationIsSet() const
{
    return m_Configuration.has_value();
}

void AddDomainConfig_200_response::unsetConfiguration()
{
