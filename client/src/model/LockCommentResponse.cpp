...
LockCommentResponse::LockCommentResponse()
{
    m_StatusIsSet = false;
...
void LockCommentResponse::validate()
{
    // TODO: implement validation
}

web::json::value LockCommentResponse::toJson() const
{
...
bool LockCommentResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void LockCommentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool LockCommentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> LockCommentResponse::getStatus() const
{
    return m_Status;
}


void LockCommentResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool LockCommentResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void LockCommentResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t LockCommentResponse::getReason() const
{
    return m_Reason;
}


void LockCommentResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool LockCommentResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void LockCommentResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t LockCommentResponse::getCode() const
{
    return m_Code;
}


void LockCommentResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool LockCommentResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void LockCommentResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t LockCommentResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void LockCommentResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool LockCommentResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void LockCommentResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t LockCommentResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void LockCommentResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool LockCommentResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void LockCommentResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t LockCommentResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void LockCommentResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool LockCommentResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void LockCommentResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t LockCommentResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void LockCommentResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool LockCommentResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void LockCommentResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> LockCommentResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void LockCommentResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool LockCommentResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void LockCommentResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
