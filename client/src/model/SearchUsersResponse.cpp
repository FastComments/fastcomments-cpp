...
std::shared_ptr<ImportedAPIStatus_SUCCESS> SearchUsersResponse::getStatus() const
{
    return m_Status;
}


void SearchUsersResponse::setStatus(const std::shared_ptr<ImportedAPIStatus_SUCCESS>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}
