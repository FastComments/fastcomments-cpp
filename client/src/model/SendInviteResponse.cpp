...
void SendInviteResponse::validate()
{
    // TODO: implement validation
}

web::json::value SendInviteResponse::toJson() const
{
...
bool SendInviteResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SendInviteResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SendInviteResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> SendInviteResponse::getStatus() const
{
    return m_Status;
}


void SendInviteResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool SendInviteResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void SendInviteResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t SendInviteResponse::getReason() const
{
    return m_Reason;
}


void SendInviteResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool SendInviteResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void SendInviteResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t SendInviteResponse::getCode() const
{
    return m_Code;
}


void SendInviteResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool SendInviteResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void SendInviteResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t SendInviteResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void SendInviteResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool SendInviteResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void SendInviteResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t SendInviteResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void SendInviteResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool SendInviteResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void SendInviteResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t SendInviteResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void SendInviteResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool SendInviteResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void SendInviteResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t SendInviteResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void SendInviteResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool SendInviteResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void SendInviteResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> SendInviteResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void SendInviteResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool SendInviteResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void SendInviteResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
