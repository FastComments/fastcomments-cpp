...
GetTenantUserResponse_1::GetTenantUserResponse_1()
{
    m_StatusIsSet = false;
...
void GetTenantUserResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetTenantUserResponse_1::toJson() const
{
...
bool GetTenantUserResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetTenantUserResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetTenantUserResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetTenantUserResponse_1::getStatus() const
{
    return m_Status;
}


void GetTenantUserResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetTenantUserResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetTenantUserResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<User> GetTenantUserResponse_1::getTenantUser() const
{
    return m_TenantUser;
}


void GetTenantUserResponse_1::setTenantUser(const std::shared_ptr<User>& value)
{
    m_TenantUser = value;
    m_TenantUserIsSet = true;
}

bool GetTenantUserResponse_1::tenantUserIsSet() const
{
    return m_TenantUserIsSet;
}

void GetTenantUserResponse_1::unsetTenantUser()
{
    m_TenantUserIsSet = false;
}
utility::string_t GetTenantUserResponse_1::getReason() const
{
    return m_Reason;
}


void GetTenantUserResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetTenantUserResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetTenantUserResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetTenantUserResponse_1::getCode() const
{
    return m_Code;
}


void GetTenantUserResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetTenantUserResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetTenantUserResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetTenantUserResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetTenantUserResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetTenantUserResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetTenantUserResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetTenantUserResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetTenantUserResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetTenantUserResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetTenantUserResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetTenantUserResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetTenantUserResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetTenantUserResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetTenantUserResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetTenantUserResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetTenantUserResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetTenantUserResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetTenantUserResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetTenantUserResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetTenantUserResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetTenantUserResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetTenantUserResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
