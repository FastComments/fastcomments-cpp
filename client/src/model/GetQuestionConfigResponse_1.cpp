...
GetQuestionConfigResponse_1::GetQuestionConfigResponse_1()
{
    m_StatusIsSet = false;
...
void GetQuestionConfigResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetQuestionConfigResponse_1::toJson() const
{
...
bool GetQuestionConfigResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetQuestionConfigResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetQuestionConfigResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetQuestionConfigResponse_1::getStatus() const
{
    return m_Status;
}


void GetQuestionConfigResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetQuestionConfigResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetQuestionConfigResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<QuestionConfig> GetQuestionConfigResponse_1::getQuestionConfig() const
{
    return m_QuestionConfig;
}


void GetQuestionConfigResponse_1::setQuestionConfig(const std::shared_ptr<QuestionConfig>& value)
{
    m_QuestionConfig = value;
    m_QuestionConfigIsSet = true;
}

bool GetQuestionConfigResponse_1::questionConfigIsSet() const
{
    return m_QuestionConfigIsSet;
}

void GetQuestionConfigResponse_1::unsetQuestionConfig()
{
    m_QuestionConfigIsSet = false;
}
utility::string_t GetQuestionConfigResponse_1::getReason() const
{
    return m_Reason;
}


void GetQuestionConfigResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetQuestionConfigResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetQuestionConfigResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetQuestionConfigResponse_1::getCode() const
{
    return m_Code;
}


void GetQuestionConfigResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetQuestionConfigResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetQuestionConfigResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetQuestionConfigResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetQuestionConfigResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetQuestionConfigResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetQuestionConfigResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetQuestionConfigResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetQuestionConfigResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetQuestionConfigResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetQuestionConfigResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetQuestionConfigResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetQuestionConfigResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetQuestionConfigResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetQuestionConfigResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetQuestionConfigResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetQuestionConfigResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetQuestionConfigResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetQuestionConfigResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetQuestionConfigResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetQuestionConfigResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetQuestionConfigResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetQuestionConfigResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
