...
BlockUserFromCommentResponse::BlockUserFromCommentResponse()
{
    m_StatusIsSet = false;
...
void BlockUserFromCommentResponse::validate()
{
    // TODO: implement validation
}

web::json::value BlockUserFromCommentResponse::toJson() const
{
...
bool BlockUserFromCommentResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void BlockUserFromCommentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool BlockUserFromCommentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> BlockUserFromCommentResponse::getStatus() const
{
    return m_Status;
}


void BlockUserFromCommentResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool BlockUserFromCommentResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void BlockUserFromCommentResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::map<utility::string_t, bool> BlockUserFromCommentResponse::getCommentStatuses() const
{
    return m_CommentStatuses;
}

void BlockUserFromCommentResponse::setCommentStatuses(std::map<utility::string_t, bool> value)
{
    m_CommentStatuses = value;
    m_CommentStatusesIsSet = true;
}

bool BlockUserFromCommentResponse::commentStatusesIsSet() const
{
    return m_CommentStatusesIsSet;
}

void BlockUserFromCommentResponse::unsetCommentStatuses()
{
    m_CommentStatusesIsSet = false;
}
utility::string_t BlockUserFromCommentResponse::getReason() const
{
    return m_Reason;
}


void BlockUserFromCommentResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool BlockUserFromCommentResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void BlockUserFromCommentResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t BlockUserFromCommentResponse::getCode() const
{
    return m_Code;
}


void BlockUserFromCommentResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool BlockUserFromCommentResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void BlockUserFromCommentResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t BlockUserFromCommentResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void BlockUserFromCommentResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool BlockUserFromCommentResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void BlockUserFromCommentResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t BlockUserFromCommentResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void BlockUserFromCommentResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool BlockUserFromCommentResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void BlockUserFromCommentResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t BlockUserFromCommentResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void BlockUserFromCommentResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool BlockUserFromCommentResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void BlockUserFromCommentResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t BlockUserFromCommentResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void BlockUserFromCommentResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool BlockUserFromCommentResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void BlockUserFromCommentResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> BlockUserFromCommentResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void BlockUserFromCommentResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool BlockUserFromCommentResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void BlockUserFromCommentResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
