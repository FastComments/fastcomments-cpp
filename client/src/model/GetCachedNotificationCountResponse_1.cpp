...
GetCachedNotificationCountResponse_1::GetCachedNotificationCountResponse_1()
{
    m_StatusIsSet = false;
    m_DataIsSet = false;
...
void GetCachedNotificationCountResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetCachedNotificationCountResponse_1::toJson() const
{
...
bool GetCachedNotificationCountResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetCachedNotificationCountResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetCachedNotificationCountResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetCachedNotificationCountResponse_1::getStatus() const
{
    return m_Status;
}


void GetCachedNotificationCountResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetCachedNotificationCountResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetCachedNotificationCountResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<UserNotificationCount> GetCachedNotificationCountResponse_1::getData() const
{
    return m_Data;
}


void GetCachedNotificationCountResponse_1::setData(const std::shared_ptr<UserNotificationCount>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool GetCachedNotificationCountResponse_1::dataIsSet() const
{
    return m_DataIsSet;
}

void GetCachedNotificationCountResponse_1::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t GetCachedNotificationCountResponse_1::getReason() const
{
    return m_Reason;
}


void GetCachedNotificationCountResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetCachedNotificationCountResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetCachedNotificationCountResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetCachedNotificationCountResponse_1::getCode() const
{
    return m_Code;
}


void GetCachedNotificationCountResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetCachedNotificationCountResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetCachedNotificationCountResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetCachedNotificationCountResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetCachedNotificationCountResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetCachedNotificationCountResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetCachedNotificationCountResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetCachedNotificationCountResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetCachedNotificationCountResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetCachedNotificationCountResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetCachedNotificationCountResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetCachedNotificationCountResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetCachedNotificationCountResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetCachedNotificationCountResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetCachedNotificationCountResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetCachedNotificationCountResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetCachedNotificationCountResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetCachedNotificationCountResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetCachedNotificationCountResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetCachedNotificationCountResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetCachedNotificationCountResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetCachedNotificationCountResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetCachedNotificationCountResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
