...
AddHashTagResponse::AddHashTagResponse()
{
    m_StatusIsSet = false;
...
void AddHashTagResponse::validate()
{
    // TODO: implement validation
}

web::json::value AddHashTagResponse::toJson() const
{
...
bool AddHashTagResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AddHashTagResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AddHashTagResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> AddHashTagResponse::getStatus() const
{
    return m_Status;
}


void AddHashTagResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool AddHashTagResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void AddHashTagResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<TenantHashTag> AddHashTagResponse::getHashTag() const
{
    return m_HashTag;
}


void AddHashTagResponse::setHashTag(const std::shared_ptr<TenantHashTag>& value)
{
    m_HashTag = value;
    m_HashTagIsSet = true;
}

bool AddHashTagResponse::hashTagIsSet() const
{
    return m_HashTagIsSet;
}

void AddHashTagResponse::unsetHashTag()
{
    m_HashTagIsSet = false;
}
utility::string_t AddHashTagResponse::getReason() const
{
    return m_Reason;
}


void AddHashTagResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool AddHashTagResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void AddHashTagResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t AddHashTagResponse::getCode() const
{
    return m_Code;
}


void AddHashTagResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool AddHashTagResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void AddHashTagResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t AddHashTagResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void AddHashTagResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool AddHashTagResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void AddHashTagResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t AddHashTagResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void AddHashTagResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool AddHashTagResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void AddHashTagResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t AddHashTagResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void AddHashTagResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool AddHashTagResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void AddHashTagResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t AddHashTagResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void AddHashTagResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool AddHashTagResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void AddHashTagResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> AddHashTagResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void AddHashTagResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool AddHashTagResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void AddHashTagResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
