...
UnLockCommentResponse::UnLockCommentResponse()
{
    m_StatusIsSet = false;
...
void UnLockCommentResponse::validate()
{
    // TODO: implement validation
}

web::json::value UnLockCommentResponse::toJson() const
{
...
bool UnLockCommentResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UnLockCommentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UnLockCommentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UnLockCommentResponse::getStatus() const
{
    return m_Status;
}


void UnLockCommentResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UnLockCommentResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UnLockCommentResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t UnLockCommentResponse::getReason() const
{
    return m_Reason;
}


void UnLockCommentResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UnLockCommentResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UnLockCommentResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UnLockCommentResponse::getCode() const
{
    return m_Code;
}


void UnLockCommentResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UnLockCommentResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UnLockCommentResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UnLockCommentResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UnLockCommentResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UnLockCommentResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UnLockCommentResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UnLockCommentResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UnLockCommentResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UnLockCommentResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UnLockCommentResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UnLockCommentResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UnLockCommentResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UnLockCommentResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UnLockCommentResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UnLockCommentResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UnLockCommentResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UnLockCommentResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UnLockCommentResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UnLockCommentResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UnLockCommentResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UnLockCommentResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UnLockCommentResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
