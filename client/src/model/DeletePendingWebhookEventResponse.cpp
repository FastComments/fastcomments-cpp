...
DeletePendingWebhookEventResponse::DeletePendingWebhookEventResponse()
{
    m_StatusIsSet = false;
...
void DeletePendingWebhookEventResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeletePendingWebhookEventResponse::toJson() const
{
...
bool DeletePendingWebhookEventResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeletePendingWebhookEventResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeletePendingWebhookEventResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeletePendingWebhookEventResponse::getStatus() const
{
    return m_Status;
}


void DeletePendingWebhookEventResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeletePendingWebhookEventResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeletePendingWebhookEventResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeletePendingWebhookEventResponse::getReason() const
{
    return m_Reason;
}


void DeletePendingWebhookEventResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeletePendingWebhookEventResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeletePendingWebhookEventResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeletePendingWebhookEventResponse::getCode() const
{
    return m_Code;
}


void DeletePendingWebhookEventResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeletePendingWebhookEventResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeletePendingWebhookEventResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeletePendingWebhookEventResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeletePendingWebhookEventResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeletePendingWebhookEventResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeletePendingWebhookEventResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeletePendingWebhookEventResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeletePendingWebhookEventResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeletePendingWebhookEventResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeletePendingWebhookEventResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeletePendingWebhookEventResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeletePendingWebhookEventResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeletePendingWebhookEventResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeletePendingWebhookEventResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeletePendingWebhookEventResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeletePendingWebhookEventResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeletePendingWebhookEventResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeletePendingWebhookEventResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeletePendingWebhookEventResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeletePendingWebhookEventResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeletePendingWebhookEventResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeletePendingWebhookEventResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
