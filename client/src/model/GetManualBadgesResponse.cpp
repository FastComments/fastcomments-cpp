...
GetManualBadgesResponse::GetManualBadgesResponse()
{
    m_BadgesIsSet = false;
    m_StatusIsSet = false;
...
void GetManualBadgesResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetManualBadgesResponse::toJson() const
{
...
bool GetManualBadgesResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("badges"))))
    {
        ...
        {
            std::vector<std::shared_ptr<TenantBadge>> refVal_setBadges;
...
void GetManualBadgesResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetManualBadgesResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::vector<std::shared_ptr<TenantBadge>> GetManualBadgesResponse::getBadges() const
{
    return m_Badges;
}


void GetManualBadgesResponse::setBadges(const std::vector<std::shared_ptr<TenantBadge>>& value)
{
    m_Badges = value;
    m_BadgesIsSet = true;
}

bool GetManualBadgesResponse::badgesIsSet() const
{
    return m_BadgesIsSet;
}

void GetManualBadgesResponse::unsetBadges()
{
    m_BadgesIsSet = false;
}
std::shared_ptr<APIStatus> GetManualBadgesResponse::getStatus() const
{
    return m_Status;
}


void GetManualBadgesResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetManualBadgesResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetManualBadgesResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetManualBadgesResponse::getReason() const
{
    return m_Reason;
}


void GetManualBadgesResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetManualBadgesResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetManualBadgesResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetManualBadgesResponse::getCode() const
{
    return m_Code;
}


void GetManualBadgesResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetManualBadgesResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetManualBadgesResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetManualBadgesResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetManualBadgesResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetManualBadgesResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetManualBadgesResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetManualBadgesResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetManualBadgesResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetManualBadgesResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetManualBadgesResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetManualBadgesResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetManualBadgesResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetManualBadgesResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetManualBadgesResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetManualBadgesResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetManualBadgesResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetManualBadgesResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetManualBadgesResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetManualBadgesResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetManualBadgesResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetManualBadgesResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetManualBadgesResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
