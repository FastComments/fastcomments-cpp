...
UpdateQuestionConfigResponse::UpdateQuestionConfigResponse()
{
    m_StatusIsSet = false;
...
void UpdateQuestionConfigResponse::validate()
{
    // TODO: implement validation
}

web::json::value UpdateQuestionConfigResponse::toJson() const
{
...
bool UpdateQuestionConfigResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateQuestionConfigResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateQuestionConfigResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UpdateQuestionConfigResponse::getStatus() const
{
    return m_Status;
}


void UpdateQuestionConfigResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UpdateQuestionConfigResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UpdateQuestionConfigResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t UpdateQuestionConfigResponse::getReason() const
{
    return m_Reason;
}


void UpdateQuestionConfigResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UpdateQuestionConfigResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UpdateQuestionConfigResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UpdateQuestionConfigResponse::getCode() const
{
    return m_Code;
}


void UpdateQuestionConfigResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UpdateQuestionConfigResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UpdateQuestionConfigResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UpdateQuestionConfigResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UpdateQuestionConfigResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UpdateQuestionConfigResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UpdateQuestionConfigResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UpdateQuestionConfigResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UpdateQuestionConfigResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UpdateQuestionConfigResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UpdateQuestionConfigResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UpdateQuestionConfigResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UpdateQuestionConfigResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UpdateQuestionConfigResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UpdateQuestionConfigResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UpdateQuestionConfigResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UpdateQuestionConfigResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UpdateQuestionConfigResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UpdateQuestionConfigResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UpdateQuestionConfigResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UpdateQuestionConfigResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UpdateQuestionConfigResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UpdateQuestionConfigResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
