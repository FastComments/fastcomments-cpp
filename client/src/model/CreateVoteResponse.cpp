...
utility::string_t CreateVoteResponse::getVoteId() const
{
    return m_VoteId;
}


void CreateVoteResponse::setVoteId(const utility::string_t& value)
{
    m_VoteId = value;
    m_VoteIdIsSet = true;
}

bool CreateVoteResponse::voteIdIsSet() const
{
    return m_VoteIdIsSet;
}

void CreateVoteResponse::unsetVoteId()
{
    m_VoteIdIsSet = false;
}
bool CreateVoteResponse::isIsVerified() const
{
    return m_IsVerified;
}

void CreateVoteResponse::setIsVerified(bool value)
{
    m_IsVerified = value;
    m_IsVerifiedIsSet = true;
}

bool CreateVoteResponse::isVerifiedIsSet() const
{
    return m_IsVerifiedIsSet;
}

void CreateVoteResponse::unsetIsVerified()
{
    m_IsVerifiedIsSet = false;
}
std::shared_ptr<VoteResponseUser> CreateVoteResponse::getUser() const
{
    return m_User;
}


void CreateVoteResponse::setUser(const std::shared_ptr<VoteResponseUser>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool CreateVoteResponse::userIsSet() const
{
    return m_UserIsSet;
}

void CreateVoteResponse::unsetUser()
{
    m_UserIsSet = false;
}
utility::string_t CreateVoteResponse::getEditKey() const
{
    return m_EditKey;
}


void CreateVoteResponse::setEditKey(const utility::string_t& value)
{
    m_EditKey = value;
    m_EditKeyIsSet = true;
}

bool CreateVoteResponse::editKeyIsSet() const
{
    return m_EditKeyIsSet;
}

void CreateVoteResponse::unsetEditKey()
{
    m_EditKeyIsSet = false;
}
utility::string_t CreateVoteResponse::getReason() const
{
    return m_Reason;
}


void CreateVoteResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CreateVoteResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CreateVoteResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CreateVoteResponse::getCode() const
{
    return m_Code;
}


void CreateVoteResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CreateVoteResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void CreateVoteResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CreateVoteResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CreateVoteResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CreateVoteResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CreateVoteResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CreateVoteResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void CreateVoteResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CreateVoteResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CreateVoteResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CreateVoteResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CreateVoteResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CreateVoteResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CreateVoteResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CreateVoteResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void CreateVoteResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CreateVoteResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CreateVoteResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CreateVoteResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void CreateVoteResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CreateVoteResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CreateVoteResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
