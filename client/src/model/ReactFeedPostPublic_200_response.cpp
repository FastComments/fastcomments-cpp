...
ReactFeedPostPublic_200_response::ReactFeedPostPublic_200_response()
{
    m_StatusIsSet = false;
...
void ReactFeedPostPublic_200_response::validate()
{
    // TODO: implement validation
}

web::json::value ReactFeedPostPublic_200_response::toJson() const
{
...
bool ReactFeedPostPublic_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ReactFeedPostPublic_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ReactFeedPostPublic_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<ImportedAPIStatus_FAILED> ReactFeedPostPublic_200_response::getStatus() const
{
    return m_Status;
}


void ReactFeedPostPublic_200_response::setStatus(const std::shared_ptr<ImportedAPIStatus_FAILED>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ReactFeedPostPublic_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void ReactFeedPostPublic_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t ReactFeedPostPublic_200_response::getReactType() const
{
    return m_ReactType;
}


void ReactFeedPostPublic_200_response::setReactType(const utility::string_t& value)
{
    m_ReactType = value;
    m_ReactTypeIsSet = true;
}

bool ReactFeedPostPublic_200_response::reactTypeIsSet() const
{
    return m_ReactTypeIsSet;
}

void ReactFeedPostPublic_200_response::unsetReactType()
{
    m_ReactTypeIsSet = false;
}
bool ReactFeedPostPublic_200_response::isIsUndo() const
{
    return m_IsUndo;
}

void ReactFeedPostPublic_200_response::setIsUndo(bool value)
{
    m_IsUndo = value;
    m_IsUndoIsSet = true;
}

bool ReactFeedPostPublic_200_response::isUndoIsSet() const
{
    return m_IsUndoIsSet;
}

void ReactFeedPostPublic_200_response::unsetIsUndo()
{
    m_IsUndoIsSet = false;
}
utility::string_t ReactFeedPostPublic_200_response::getReason() const
{
    return m_Reason;
}


void ReactFeedPostPublic_200_response::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool ReactFeedPostPublic_200_response::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void ReactFeedPostPublic_200_response::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t ReactFeedPostPublic_200_response::getCode() const
{
    return m_Code;
}


void ReactFeedPostPublic_200_response::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool ReactFeedPostPublic_200_response::codeIsSet() const
{
    return m_CodeIsSet;
}

void ReactFeedPostPublic_200_response::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t ReactFeedPostPublic_200_response::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void ReactFeedPostPublic_200_response::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool ReactFeedPostPublic_200_response::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void ReactFeedPostPublic_200_response::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t ReactFeedPostPublic_200_response::getBannedUntil() const
{
    return m_BannedUntil;
}

void ReactFeedPostPublic_200_response::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool ReactFeedPostPublic_200_response::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void ReactFeedPostPublic_200_response::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t ReactFeedPostPublic_200_response::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void ReactFeedPostPublic_200_response::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool ReactFeedPostPublic_200_response::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void ReactFeedPostPublic_200_response::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t ReactFeedPostPublic_200_response::getTranslatedError() const
{
    return m_TranslatedError;
}


void ReactFeedPostPublic_200_response::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool ReactFeedPostPublic_200_response::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void ReactFeedPostPublic_200_response::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> ReactFeedPostPublic_200_response::getCustomConfig() const
{
    return m_CustomConfig;
}


void ReactFeedPostPublic_200_response::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool ReactFeedPostPublic_200_response::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void ReactFeedPostPublic_200_response::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
