...
PostSetCommentTextResponse::PostSetCommentTextResponse()
{
...
void PostSetCommentTextResponse::validate()
{
    // TODO: implement validation
}

web::json::value PostSetCommentTextResponse::toJson() const
{
...
bool PostSetCommentTextResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PostSetCommentTextResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PostSetCommentTextResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PostSetCommentTextResponse::getNewCommentTextHTML() const
{
    return m_NewCommentTextHTML;
}


void PostSetCommentTextResponse::setNewCommentTextHTML(const utility::string_t& value)
{
    m_NewCommentTextHTML = value;
    m_NewCommentTextHTMLIsSet = true;
}

bool PostSetCommentTextResponse::newCommentTextHTMLIsSet() const
{
    return m_NewCommentTextHTMLIsSet;
}

void PostSetCommentTextResponse::unsetNewCommentTextHTML()
{
    m_NewCommentTextHTMLIsSet = false;
}
std::shared_ptr<APIStatus> PostSetCommentTextResponse::getStatus() const
{
    return m_Status;
}


void PostSetCommentTextResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PostSetCommentTextResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PostSetCommentTextResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PostSetCommentTextResponse::getReason() const
{
    return m_Reason;
}


void PostSetCommentTextResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PostSetCommentTextResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PostSetCommentTextResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PostSetCommentTextResponse::getCode() const
{
    return m_Code;
}


void PostSetCommentTextResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PostSetCommentTextResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PostSetCommentTextResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PostSetCommentTextResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PostSetCommentTextResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PostSetCommentTextResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PostSetCommentTextResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PostSetCommentTextResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PostSetCommentTextResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PostSetCommentTextResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PostSetCommentTextResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PostSetCommentTextResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PostSetCommentTextResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PostSetCommentTextResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PostSetCommentTextResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PostSetCommentTextResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PostSetCommentTextResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PostSetCommentTextResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PostSetCommentTextResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PostSetCommentTextResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PostSetCommentTextResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PostSetCommentTextResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PostSetCommentTextResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
