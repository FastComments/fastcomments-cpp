...
GetUserBadgeProgressByIdResponse::GetUserBadgeProgressByIdResponse()
{
    m_StatusIsSet = false;
...
void GetUserBadgeProgressByIdResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetUserBadgeProgressByIdResponse::toJson() const
{
...
bool GetUserBadgeProgressByIdResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetUserBadgeProgressByIdResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetUserBadgeProgressByIdResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetUserBadgeProgressByIdResponse::getStatus() const
{
    return m_Status;
}


void GetUserBadgeProgressByIdResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetUserBadgeProgressByIdResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetUserBadgeProgressByIdResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<UserBadgeProgress> GetUserBadgeProgressByIdResponse::getUserBadgeProgress() const
{
    return m_UserBadgeProgress;
}


void GetUserBadgeProgressByIdResponse::setUserBadgeProgress(const std::shared_ptr<UserBadgeProgress>& value)
{
    m_UserBadgeProgress = value;
    m_UserBadgeProgressIsSet = true;
}

bool GetUserBadgeProgressByIdResponse::userBadgeProgressIsSet() const
{
    return m_UserBadgeProgressIsSet;
}

void GetUserBadgeProgressByIdResponse::unsetUserBadgeProgress()
{
    m_UserBadgeProgressIsSet = false;
}
utility::string_t GetUserBadgeProgressByIdResponse::getReason() const
{
    return m_Reason;
}


void GetUserBadgeProgressByIdResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetUserBadgeProgressByIdResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetUserBadgeProgressByIdResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetUserBadgeProgressByIdResponse::getCode() const
{
    return m_Code;
}


void GetUserBadgeProgressByIdResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetUserBadgeProgressByIdResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetUserBadgeProgressByIdResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetUserBadgeProgressByIdResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetUserBadgeProgressByIdResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetUserBadgeProgressByIdResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetUserBadgeProgressByIdResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetUserBadgeProgressByIdResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetUserBadgeProgressByIdResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetUserBadgeProgressByIdResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetUserBadgeProgressByIdResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetUserBadgeProgressByIdResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetUserBadgeProgressByIdResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetUserBadgeProgressByIdResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetUserBadgeProgressByIdResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetUserBadgeProgressByIdResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetUserBadgeProgressByIdResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetUserBadgeProgressByIdResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetUserBadgeProgressByIdResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetUserBadgeProgressByIdResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetUserBadgeProgressByIdResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetUserBadgeProgressByIdResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetUserBadgeProgressByIdResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
