...
ChangeTicketStateResponse_1::ChangeTicketStateResponse_1()
{
    m_StatusIsSet = false;
    m_TicketIsSet = false;
...
void ChangeTicketStateResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value ChangeTicketStateResponse_1::toJson() const
{
...
bool ChangeTicketStateResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ChangeTicketStateResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ChangeTicketStateResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> ChangeTicketStateResponse_1::getStatus() const
{
    return m_Status;
}


void ChangeTicketStateResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ChangeTicketStateResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void ChangeTicketStateResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<APITicket> ChangeTicketStateResponse_1::getTicket() const
{
    return m_Ticket;
}


void ChangeTicketStateResponse_1::setTicket(const std::shared_ptr<APITicket>& value)
{
    m_Ticket = value;
    m_TicketIsSet = true;
}

bool ChangeTicketStateResponse_1::ticketIsSet() const
{
    return m_TicketIsSet;
}

void ChangeTicketStateResponse_1::unsetTicket()
{
    m_TicketIsSet = false;
}
utility::string_t ChangeTicketStateResponse_1::getReason() const
{
    return m_Reason;
}


void ChangeTicketStateResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool ChangeTicketStateResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void ChangeTicketStateResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t ChangeTicketStateResponse_1::getCode() const
{
    return m_Code;
}


void ChangeTicketStateResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool ChangeTicketStateResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void ChangeTicketStateResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t ChangeTicketStateResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void ChangeTicketStateResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool ChangeTicketStateResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void ChangeTicketStateResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t ChangeTicketStateResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void ChangeTicketStateResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool ChangeTicketStateResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void ChangeTicketStateResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t ChangeTicketStateResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void ChangeTicketStateResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool ChangeTicketStateResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void ChangeTicketStateResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t ChangeTicketStateResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void ChangeTicketStateResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool ChangeTicketStateResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void ChangeTicketStateResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> ChangeTicketStateResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void ChangeTicketStateResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool ChangeTicketStateResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void ChangeTicketStateResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
