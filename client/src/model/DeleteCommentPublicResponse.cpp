...
DeleteCommentPublicResponse::DeleteCommentPublicResponse()
{
...
void DeleteCommentPublicResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteCommentPublicResponse::toJson() const
{
...
bool DeleteCommentPublicResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteCommentPublicResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteCommentPublicResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<DeletedCommentResultComment> DeleteCommentPublicResponse::getComment() const
{
    return m_Comment;
}


void DeleteCommentPublicResponse::setComment(const std::shared_ptr<DeletedCommentResultComment>& value)
{
    m_Comment = value;
    m_CommentIsSet = true;
}

bool DeleteCommentPublicResponse::commentIsSet() const
{
    return m_CommentIsSet;
}

void DeleteCommentPublicResponse::unsetComment()
{
    m_CommentIsSet = false;
}
bool DeleteCommentPublicResponse::isHardRemoved() const
{
    return m_HardRemoved;
}

void DeleteCommentPublicResponse::setHardRemoved(bool value)
{
    m_HardRemoved = value;
    m_HardRemovedIsSet = true;
}

bool DeleteCommentPublicResponse::hardRemovedIsSet() const
{
    return m_HardRemovedIsSet;
}

void DeleteCommentPublicResponse::unsetHardRemoved()
{
    m_HardRemovedIsSet = false;
}
std::shared_ptr<APIStatus> DeleteCommentPublicResponse::getStatus() const
{
    return m_Status;
}


void DeleteCommentPublicResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteCommentPublicResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteCommentPublicResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteCommentPublicResponse::getReason() const
{
    return m_Reason;
}


void DeleteCommentPublicResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteCommentPublicResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteCommentPublicResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteCommentPublicResponse::getCode() const
{
    return m_Code;
}


void DeleteCommentPublicResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteCommentPublicResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteCommentPublicResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteCommentPublicResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteCommentPublicResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteCommentPublicResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteCommentPublicResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteCommentPublicResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteCommentPublicResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteCommentPublicResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteCommentPublicResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteCommentPublicResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteCommentPublicResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteCommentPublicResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteCommentPublicResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteCommentPublicResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteCommentPublicResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteCommentPublicResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteCommentPublicResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteCommentPublicResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteCommentPublicResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteCommentPublicResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteCommentPublicResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
