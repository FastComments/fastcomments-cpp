...
void DeleteCommentResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteCommentResponse::toJson() const
{
...
bool DeleteCommentResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteCommentResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteCommentResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<DeleteCommentAction> DeleteCommentResponse::getAction() const
{
    return m_Action;
}


void DeleteCommentResponse::setAction(const std::shared_ptr<DeleteCommentAction>& value)
{
    m_Action = value;
    m_ActionIsSet = true;
}

bool DeleteCommentResponse::actionIsSet() const
{
    return m_ActionIsSet;
}

void DeleteCommentResponse::unsetAction()
{
    m_ActionIsSet = false;
}
std::shared_ptr<APIStatus> DeleteCommentResponse::getStatus() const
{
    return m_Status;
}


void DeleteCommentResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteCommentResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteCommentResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteCommentResponse::getReason() const
{
    return m_Reason;
}


void DeleteCommentResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteCommentResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteCommentResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteCommentResponse::getCode() const
{
    return m_Code;
}


void DeleteCommentResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteCommentResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteCommentResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteCommentResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteCommentResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteCommentResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteCommentResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteCommentResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteCommentResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteCommentResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteCommentResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteCommentResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteCommentResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteCommentResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteCommentResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteCommentResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteCommentResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteCommentResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteCommentResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteCommentResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteCommentResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteCommentResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteCommentResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
