...
CheckedCommentsForBlockedResponse::CheckedCommentsForBlockedResponse()
{
...
void CheckedCommentsForBlockedResponse::validate()
{
    // TODO: implement validation
}

web::json::value CheckedCommentsForBlockedResponse::toJson() const
{
...
bool CheckedCommentsForBlockedResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CheckedCommentsForBlockedResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CheckedCommentsForBlockedResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::map<utility::string_t, bool> CheckedCommentsForBlockedResponse::getCommentStatuses() const
{
    return m_CommentStatuses;
}

void CheckedCommentsForBlockedResponse::setCommentStatuses(std::map<utility::string_t, bool> value)
{
    m_CommentStatuses = value;
    m_CommentStatusesIsSet = true;
}

bool CheckedCommentsForBlockedResponse::commentStatusesIsSet() const
{
    return m_CommentStatusesIsSet;
}

void CheckedCommentsForBlockedResponse::unsetCommentStatuses()
{
    m_CommentStatusesIsSet = false;
}
std::shared_ptr<APIStatus> CheckedCommentsForBlockedResponse::getStatus() const
{
    return m_Status;
}


void CheckedCommentsForBlockedResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool CheckedCommentsForBlockedResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void CheckedCommentsForBlockedResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t CheckedCommentsForBlockedResponse::getReason() const
{
    return m_Reason;
}


void CheckedCommentsForBlockedResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool CheckedCommentsForBlockedResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void CheckedCommentsForBlockedResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t CheckedCommentsForBlockedResponse::getCode() const
{
    return m_Code;
}


void CheckedCommentsForBlockedResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool CheckedCommentsForBlockedResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void CheckedCommentsForBlockedResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t CheckedCommentsForBlockedResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void CheckedCommentsForBlockedResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool CheckedCommentsForBlockedResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void CheckedCommentsForBlockedResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t CheckedCommentsForBlockedResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void CheckedCommentsForBlockedResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool CheckedCommentsForBlockedResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void CheckedCommentsForBlockedResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t CheckedCommentsForBlockedResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void CheckedCommentsForBlockedResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool CheckedCommentsForBlockedResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void CheckedCommentsForBlockedResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t CheckedCommentsForBlockedResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void CheckedCommentsForBlockedResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool CheckedCommentsForBlockedResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void CheckedCommentsForBlockedResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> CheckedCommentsForBlockedResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void CheckedCommentsForBlockedResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool CheckedCommentsForBlockedResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void CheckedCommentsForBlockedResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
