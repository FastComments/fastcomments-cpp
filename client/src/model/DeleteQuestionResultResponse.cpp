...
DeleteQuestionResultResponse::DeleteQuestionResultResponse()
{
    m_StatusIsSet = false;
...
void DeleteQuestionResultResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteQuestionResultResponse::toJson() const
{
...
bool DeleteQuestionResultResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteQuestionResultResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteQuestionResultResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteQuestionResultResponse::getStatus() const
{
    return m_Status;
}


void DeleteQuestionResultResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteQuestionResultResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteQuestionResultResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteQuestionResultResponse::getReason() const
{
    return m_Reason;
}


void DeleteQuestionResultResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteQuestionResultResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteQuestionResultResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteQuestionResultResponse::getCode() const
{
    return m_Code;
}


void DeleteQuestionResultResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteQuestionResultResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteQuestionResultResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteQuestionResultResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteQuestionResultResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteQuestionResultResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteQuestionResultResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteQuestionResultResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteQuestionResultResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteQuestionResultResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteQuestionResultResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteQuestionResultResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteQuestionResultResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteQuestionResultResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteQuestionResultResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteQuestionResultResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteQuestionResultResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteQuestionResultResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteQuestionResultResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteQuestionResultResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteQuestionResultResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteQuestionResultResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteQuestionResultResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
