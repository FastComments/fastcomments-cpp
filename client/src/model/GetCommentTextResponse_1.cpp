...
GetCommentTextResponse_1::GetCommentTextResponse_1()
{
    m_StatusIsSet = false;
...
void GetCommentTextResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetCommentTextResponse_1::toJson() const
{
...
bool GetCommentTextResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetCommentTextResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetCommentTextResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetCommentTextResponse_1::getStatus() const
{
    return m_Status;
}


void GetCommentTextResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetCommentTextResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetCommentTextResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetCommentTextResponse_1::getCommentText() const
{
    return m_CommentText;
}


void GetCommentTextResponse_1::setCommentText(const utility::string_t& value)
{
    m_CommentText = value;
    m_CommentTextIsSet = true;
}

bool GetCommentTextResponse_1::commentTextIsSet() const
{
    return m_CommentTextIsSet;
}

void GetCommentTextResponse_1::unsetCommentText()
{
    m_CommentTextIsSet = false;
}
utility::string_t GetCommentTextResponse_1::getSanitizedCommentText() const
{
    return m_SanitizedCommentText;
}


void GetCommentTextResponse_1::setSanitizedCommentText(const utility::string_t& value)
{
    m_SanitizedCommentText = value;
    m_SanitizedCommentTextIsSet = true;
}

bool GetCommentTextResponse_1::sanitizedCommentTextIsSet() const
{
    return m_SanitizedCommentTextIsSet;
}

void GetCommentTextResponse_1::unsetSanitizedCommentText()
{
    m_SanitizedCommentTextIsSet = false;
}
utility::string_t GetCommentTextResponse_1::getReason() const
{
    return m_Reason;
}


void GetCommentTextResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetCommentTextResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetCommentTextResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetCommentTextResponse_1::getCode() const
{
    return m_Code;
}


void GetCommentTextResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetCommentTextResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetCommentTextResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetCommentTextResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetCommentTextResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetCommentTextResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetCommentTextResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetCommentTextResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetCommentTextResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetCommentTextResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetCommentTextResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetCommentTextResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetCommentTextResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetCommentTextResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetCommentTextResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetCommentTextResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetCommentTextResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetCommentTextResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetCommentTextResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetCommentTextResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetCommentTextResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetCommentTextResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetCommentTextResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
