...
GetModerationCommentTextResponse::GetModerationCommentTextResponse()
{
    m_StatusIsSet = false;
...
void GetModerationCommentTextResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetModerationCommentTextResponse::toJson() const
{
...
bool GetModerationCommentTextResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetModerationCommentTextResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetModerationCommentTextResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t GetModerationCommentTextResponse::getComment() const
{
    return m_Comment.get();
}


void GetModerationCommentTextResponse::setComment(const utility::string_t& value)
{
    m_Comment = value;
}

bool GetModerationCommentTextResponse::commentIsSet() const
{
    return m_Comment.has_value();
}

void GetModerationCommentTextResponse::unsetComment()
{
    m_Comment.reset();
}
std::shared_ptr<APIStatus> GetModerationCommentTextResponse::getStatus() const
{
    return m_Status;
}


void GetModerationCommentTextResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetModerationCommentTextResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetModerationCommentTextResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetModerationCommentTextResponse::getReason() const
{
    return m_Reason;
}


void GetModerationCommentTextResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetModerationCommentTextResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetModerationCommentTextResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetModerationCommentTextResponse::getCode() const
{
    return m_Code;
}


void GetModerationCommentTextResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetModerationCommentTextResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetModerationCommentTextResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetModerationCommentTextResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetModerationCommentTextResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetModerationCommentTextResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetModerationCommentTextResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetModerationCommentTextResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetModerationCommentTextResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetModerationCommentTextResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetModerationCommentTextResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetModerationCommentTextResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetModerationCommentTextResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetModerationCommentTextResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetModerationCommentTextResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetModerationCommentTextResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetModerationCommentTextResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetModerationCommentTextResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetModerationCommentTextResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetModerationCommentTextResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetModerationCommentTextResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetModerationCommentTextResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetModerationCommentTextResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
