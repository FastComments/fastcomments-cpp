...
GetPendingWebhookEventsResponse_1::GetPendingWebhookEventsResponse_1()
{
    m_StatusIsSet = false;
...
void GetPendingWebhookEventsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetPendingWebhookEventsResponse_1::toJson() const
{
...
bool GetPendingWebhookEventsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetPendingWebhookEventsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetPendingWebhookEventsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetPendingWebhookEventsResponse_1::getStatus() const
{
    return m_Status;
}


void GetPendingWebhookEventsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetPendingWebhookEventsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetPendingWebhookEventsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<PendingCommentToSyncOutbound>> GetPendingWebhookEventsResponse_1::getPendingWebhookEvents() const
{
    return m_PendingWebhookEvents;
}


void GetPendingWebhookEventsResponse_1::setPendingWebhookEvents(const std::vector<std::shared_ptr<PendingCommentToSyncOutbound>>& value)
{
    m_PendingWebhookEvents = value;
    m_PendingWebhookEventsIsSet = true;
}

bool GetPendingWebhookEventsResponse_1::pendingWebhookEventsIsSet() const
{
    return m_PendingWebhookEventsIsSet;
}

void GetPendingWebhookEventsResponse_1::unsetPendingWebhookEvents()
{
    m_PendingWebhookEventsIsSet = false;
}
utility::string_t GetPendingWebhookEventsResponse_1::getReason() const
{
    return m_Reason;
}


void GetPendingWebhookEventsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetPendingWebhookEventsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetPendingWebhookEventsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetPendingWebhookEventsResponse_1::getCode() const
{
    return m_Code;
}


void GetPendingWebhookEventsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetPendingWebhookEventsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetPendingWebhookEventsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetPendingWebhookEventsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetPendingWebhookEventsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetPendingWebhookEventsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetPendingWebhookEventsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetPendingWebhookEventsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetPendingWebhookEventsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetPendingWebhookEventsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetPendingWebhookEventsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetPendingWebhookEventsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetPendingWebhookEventsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetPendingWebhookEventsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetPendingWebhookEventsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetPendingWebhookEventsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetPendingWebhookEventsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetPendingWebhookEventsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetPendingWebhookEventsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetPendingWebhookEventsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetPendingWebhookEventsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetPendingWebhookEventsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetPendingWebhookEventsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
