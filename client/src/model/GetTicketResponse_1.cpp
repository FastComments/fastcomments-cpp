...
GetTicketResponse_1::GetTicketResponse_1()
{
    m_StatusIsSet = false;
    m_TicketIsSet = false;
...
void GetTicketResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetTicketResponse_1::toJson() const
{
...
bool GetTicketResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetTicketResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetTicketResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetTicketResponse_1::getStatus() const
{
    return m_Status;
}


void GetTicketResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetTicketResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetTicketResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::shared_ptr<APITicketDetail> GetTicketResponse_1::getTicket() const
{
    return m_Ticket;
}


void GetTicketResponse_1::setTicket(const std::shared_ptr<APITicketDetail>& value)
{
    m_Ticket = value;
    m_TicketIsSet = true;
}

bool GetTicketResponse_1::ticketIsSet() const
{
    return m_TicketIsSet;
}

void GetTicketResponse_1::unsetTicket()
{
    m_TicketIsSet = false;
}
std::vector<double> GetTicketResponse_1::getAvailableStates() const
{
    return m_AvailableStates;
}

void GetTicketResponse_1::setAvailableStates(std::vector<double> value)
{
    m_AvailableStates = value;
    m_AvailableStatesIsSet = true;
}

bool GetTicketResponse_1::availableStatesIsSet() const
{
    return m_AvailableStatesIsSet;
}

void GetTicketResponse_1::unsetAvailableStates()
{
    m_AvailableStatesIsSet = false;
}
utility::string_t GetTicketResponse_1::getReason() const
{
    return m_Reason;
}


void GetTicketResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetTicketResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetTicketResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetTicketResponse_1::getCode() const
{
    return m_Code;
}


void GetTicketResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetTicketResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetTicketResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetTicketResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetTicketResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetTicketResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetTicketResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetTicketResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetTicketResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetTicketResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetTicketResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetTicketResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetTicketResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetTicketResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetTicketResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetTicketResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetTicketResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetTicketResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetTicketResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetTicketResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetTicketResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetTicketResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetTicketResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
