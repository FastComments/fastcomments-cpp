...
GetUserPresenceStatusesResponse_1::GetUserPresenceStatusesResponse_1()
{
    m_StatusIsSet = false;
...
void GetUserPresenceStatusesResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetUserPresenceStatusesResponse_1::toJson() const
{
...
bool GetUserPresenceStatusesResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetUserPresenceStatusesResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetUserPresenceStatusesResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetUserPresenceStatusesResponse_1::getStatus() const
{
    return m_Status;
}


void GetUserPresenceStatusesResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetUserPresenceStatusesResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetUserPresenceStatusesResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::map<utility::string_t, bool> GetUserPresenceStatusesResponse_1::getUserIdsOnline() const
{
    return m_UserIdsOnline;
}

void GetUserPresenceStatusesResponse_1::setUserIdsOnline(std::map<utility::string_t, bool> value)
{
    m_UserIdsOnline = value;
    m_UserIdsOnlineIsSet = true;
}

bool GetUserPresenceStatusesResponse_1::userIdsOnlineIsSet() const
{
    return m_UserIdsOnlineIsSet;
}

void GetUserPresenceStatusesResponse_1::unsetUserIdsOnline()
{
    m_UserIdsOnlineIsSet = false;
}
utility::string_t GetUserPresenceStatusesResponse_1::getReason() const
{
    return m_Reason;
}


void GetUserPresenceStatusesResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetUserPresenceStatusesResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetUserPresenceStatusesResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetUserPresenceStatusesResponse_1::getCode() const
{
    return m_Code;
}


void GetUserPresenceStatusesResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetUserPresenceStatusesResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetUserPresenceStatusesResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetUserPresenceStatusesResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetUserPresenceStatusesResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetUserPresenceStatusesResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetUserPresenceStatusesResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetUserPresenceStatusesResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetUserPresenceStatusesResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetUserPresenceStatusesResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetUserPresenceStatusesResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetUserPresenceStatusesResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetUserPresenceStatusesResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetUserPresenceStatusesResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetUserPresenceStatusesResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetUserPresenceStatusesResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetUserPresenceStatusesResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetUserPresenceStatusesResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetUserPresenceStatusesResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetUserPresenceStatusesResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetUserPresenceStatusesResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetUserPresenceStatusesResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetUserPresenceStatusesResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
