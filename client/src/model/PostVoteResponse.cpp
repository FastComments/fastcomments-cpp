...
PostVoteResponse::PostVoteResponse()
{
    m_StatusIsSet = false;
...
void PostVoteResponse::validate()
{
    // TODO: implement validation
}

web::json::value PostVoteResponse::toJson() const
{
...
bool PostVoteResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PostVoteResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PostVoteResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> PostVoteResponse::getStatus() const
{
    return m_Status;
}


void PostVoteResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool PostVoteResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void PostVoteResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t PostVoteResponse::getVoteId() const
{
    return m_VoteId;
}


void PostVoteResponse::setVoteId(const utility::string_t& value)
{
    m_VoteId = value;
    m_VoteIdIsSet = true;
}

bool PostVoteResponse::voteIdIsSet() const
{
    return m_VoteIdIsSet;
}

void PostVoteResponse::unsetVoteId()
{
    m_VoteIdIsSet = false;
}
bool PostVoteResponse::isIsVerified() const
{
    return m_IsVerified;
}

void PostVoteResponse::setIsVerified(bool value)
{
    m_IsVerified = value;
    m_IsVerifiedIsSet = true;
}

bool PostVoteResponse::isVerifiedIsSet() const
{
    return m_IsVerifiedIsSet;
}

void PostVoteResponse::unsetIsVerified()
{
    m_IsVerifiedIsSet = false;
}
std::shared_ptr<VoteResponseUser> PostVoteResponse::getUser() const
{
    return m_User;
}


void PostVoteResponse::setUser(const std::shared_ptr<VoteResponseUser>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool PostVoteResponse::userIsSet() const
{
    return m_UserIsSet;
}

void PostVoteResponse::unsetUser()
{
    m_UserIsSet = false;
}
utility::string_t PostVoteResponse::getEditKey() const
{
    return m_EditKey;
}


void PostVoteResponse::setEditKey(const utility::string_t& value)
{
    m_EditKey = value;
    m_EditKeyIsSet = true;
}

bool PostVoteResponse::editKeyIsSet() const
{
    return m_EditKeyIsSet;
}

void PostVoteResponse::unsetEditKey()
{
    m_EditKeyIsSet = false;
}
utility::string_t PostVoteResponse::getReason() const
{
    return m_Reason;
}


void PostVoteResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool PostVoteResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void PostVoteResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t PostVoteResponse::getCode() const
{
    return m_Code;
}


void PostVoteResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool PostVoteResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void PostVoteResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t PostVoteResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void PostVoteResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool PostVoteResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void PostVoteResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t PostVoteResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void PostVoteResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool PostVoteResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void PostVoteResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t PostVoteResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void PostVoteResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool PostVoteResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void PostVoteResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t PostVoteResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void PostVoteResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool PostVoteResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void PostVoteResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> PostVoteResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void PostVoteResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool PostVoteResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void PostVoteResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
