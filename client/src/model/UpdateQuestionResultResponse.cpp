...
UpdateQuestionResultResponse::UpdateQuestionResultResponse()
{
    m_StatusIsSet = false;
...
void UpdateQuestionResultResponse::validate()
{
    // TODO: implement validation
}

web::json::value UpdateQuestionResultResponse::toJson() const
{
...
bool UpdateQuestionResultResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateQuestionResultResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateQuestionResultResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> UpdateQuestionResultResponse::getStatus() const
{
    return m_Status;
}


void UpdateQuestionResultResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UpdateQuestionResultResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UpdateQuestionResultResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t UpdateQuestionResultResponse::getReason() const
{
    return m_Reason;
}


void UpdateQuestionResultResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool UpdateQuestionResultResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void UpdateQuestionResultResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t UpdateQuestionResultResponse::getCode() const
{
    return m_Code;
}


void UpdateQuestionResultResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool UpdateQuestionResultResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void UpdateQuestionResultResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t UpdateQuestionResultResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void UpdateQuestionResultResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool UpdateQuestionResultResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void UpdateQuestionResultResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t UpdateQuestionResultResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void UpdateQuestionResultResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool UpdateQuestionResultResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void UpdateQuestionResultResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t UpdateQuestionResultResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void UpdateQuestionResultResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool UpdateQuestionResultResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void UpdateQuestionResultResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t UpdateQuestionResultResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void UpdateQuestionResultResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool UpdateQuestionResultResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void UpdateQuestionResultResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> UpdateQuestionResultResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void UpdateQuestionResultResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool UpdateQuestionResultResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void UpdateQuestionResultResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
