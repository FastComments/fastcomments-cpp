...
void DeleteVoteResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteVoteResponse::toJson() const
{
...
bool DeleteVoteResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteVoteResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteVoteResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteVoteResponse::getStatus() const
{
    return m_Status;
}


void DeleteVoteResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteVoteResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteVoteResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
bool DeleteVoteResponse::isWasPendingVote() const
{
    return m_WasPendingVote;
}

void DeleteVoteResponse::setWasPendingVote(bool value)
{
    m_WasPendingVote = value;
    m_WasPendingVoteIsSet = true;
}

bool DeleteVoteResponse::wasPendingVoteIsSet() const
{
    return m_WasPendingVoteIsSet;
}

void DeleteVoteResponse::unsetWasPendingVote()
{
    m_WasPendingVoteIsSet = false;
}
utility::string_t DeleteVoteResponse::getReason() const
{
    return m_Reason;
}


void DeleteVoteResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteVoteResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteVoteResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteVoteResponse::getCode() const
{
    return m_Code;
}


void DeleteVoteResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteVoteResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteVoteResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteVoteResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteVoteResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteVoteResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteVoteResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteVoteResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteVoteResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteVoteResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteVoteResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteVoteResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteVoteResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteVoteResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteVoteResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteVoteResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteVoteResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteVoteResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteVoteResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteVoteResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteVoteResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteVoteResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteVoteResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
