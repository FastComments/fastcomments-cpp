...
std::map<utility::string_t, web::json::value> DeleteVoteResponse::getAdditionalProperties() const
{
    return m_AdditionalProperties;
}

void DeleteVoteResponse::setAdditionalProperties(const std::map<utility::string_t, web::json::value>& value)
{
    m_AdditionalProperties = value;
    m_AdditionalPropertiesIsSet = true;
}

void DeleteVoteResponse::addAdditionalProperty(const utility::string_t& key, const web::json::value& value)
{
    m_AdditionalProperties[key] = value;
    m_AdditionalPropertiesIsSet = true;
}

bool DeleteVoteResponse::additionalPropertiesIsSet() const
{
    return m_AdditionalPropertiesIsSet;
}

void DeleteVoteResponse::unsetAdditionalProperties()
{
