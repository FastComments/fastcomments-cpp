...
DeleteHashTagResponse::DeleteHashTagResponse()
{
    m_StatusIsSet = false;
...
void DeleteHashTagResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteHashTagResponse::toJson() const
{
...
bool DeleteHashTagResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteHashTagResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteHashTagResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteHashTagResponse::getStatus() const
{
    return m_Status;
}


void DeleteHashTagResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteHashTagResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteHashTagResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteHashTagResponse::getReason() const
{
    return m_Reason;
}


void DeleteHashTagResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteHashTagResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteHashTagResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteHashTagResponse::getCode() const
{
    return m_Code;
}


void DeleteHashTagResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteHashTagResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteHashTagResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteHashTagResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteHashTagResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteHashTagResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteHashTagResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteHashTagResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteHashTagResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteHashTagResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteHashTagResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteHashTagResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteHashTagResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteHashTagResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteHashTagResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteHashTagResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteHashTagResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteHashTagResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteHashTagResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteHashTagResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteHashTagResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteHashTagResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteHashTagResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
