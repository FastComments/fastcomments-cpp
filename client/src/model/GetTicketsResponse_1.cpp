...
GetTicketsResponse_1::GetTicketsResponse_1()
{
    m_StatusIsSet = false;
...
void GetTicketsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetTicketsResponse_1::toJson() const
{
...
bool GetTicketsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetTicketsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetTicketsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetTicketsResponse_1::getStatus() const
{
    return m_Status;
}


void GetTicketsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetTicketsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetTicketsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<APITicket>> GetTicketsResponse_1::getTickets() const
{
    return m_Tickets;
}


void GetTicketsResponse_1::setTickets(const std::vector<std::shared_ptr<APITicket>>& value)
{
    m_Tickets = value;
    m_TicketsIsSet = true;
}

bool GetTicketsResponse_1::ticketsIsSet() const
{
    return m_TicketsIsSet;
}

void GetTicketsResponse_1::unsetTickets()
{
    m_TicketsIsSet = false;
}
utility::string_t GetTicketsResponse_1::getReason() const
{
    return m_Reason;
}


void GetTicketsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetTicketsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetTicketsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetTicketsResponse_1::getCode() const
{
    return m_Code;
}


void GetTicketsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetTicketsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetTicketsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetTicketsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetTicketsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetTicketsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetTicketsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetTicketsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetTicketsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetTicketsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetTicketsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetTicketsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetTicketsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetTicketsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetTicketsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetTicketsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetTicketsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetTicketsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetTicketsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetTicketsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetTicketsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetTicketsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetTicketsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
