...
GetTenantPackagesResponse_1::GetTenantPackagesResponse_1()
{
    m_StatusIsSet = false;
...
void GetTenantPackagesResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetTenantPackagesResponse_1::toJson() const
{
...
bool GetTenantPackagesResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetTenantPackagesResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetTenantPackagesResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetTenantPackagesResponse_1::getStatus() const
{
    return m_Status;
}


void GetTenantPackagesResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetTenantPackagesResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetTenantPackagesResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<TenantPackage>> GetTenantPackagesResponse_1::getTenantPackages() const
{
    return m_TenantPackages;
}


void GetTenantPackagesResponse_1::setTenantPackages(const std::vector<std::shared_ptr<TenantPackage>>& value)
{
    m_TenantPackages = value;
    m_TenantPackagesIsSet = true;
}

bool GetTenantPackagesResponse_1::tenantPackagesIsSet() const
{
    return m_TenantPackagesIsSet;
}

void GetTenantPackagesResponse_1::unsetTenantPackages()
{
    m_TenantPackagesIsSet = false;
}
utility::string_t GetTenantPackagesResponse_1::getReason() const
{
    return m_Reason;
}


void GetTenantPackagesResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetTenantPackagesResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetTenantPackagesResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetTenantPackagesResponse_1::getCode() const
{
    return m_Code;
}


void GetTenantPackagesResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetTenantPackagesResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetTenantPackagesResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetTenantPackagesResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetTenantPackagesResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetTenantPackagesResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetTenantPackagesResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetTenantPackagesResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetTenantPackagesResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetTenantPackagesResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetTenantPackagesResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetTenantPackagesResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetTenantPackagesResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetTenantPackagesResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetTenantPackagesResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetTenantPackagesResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetTenantPackagesResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetTenantPackagesResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetTenantPackagesResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetTenantPackagesResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetTenantPackagesResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetTenantPackagesResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetTenantPackagesResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
