...
DeleteNotificationCountResponse::DeleteNotificationCountResponse()
{
    m_StatusIsSet = false;
...
void DeleteNotificationCountResponse::validate()
{
    // TODO: implement validation
}

web::json::value DeleteNotificationCountResponse::toJson() const
{
...
bool DeleteNotificationCountResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteNotificationCountResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteNotificationCountResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> DeleteNotificationCountResponse::getStatus() const
{
    return m_Status;
}


void DeleteNotificationCountResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool DeleteNotificationCountResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void DeleteNotificationCountResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t DeleteNotificationCountResponse::getReason() const
{
    return m_Reason;
}


void DeleteNotificationCountResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool DeleteNotificationCountResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void DeleteNotificationCountResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t DeleteNotificationCountResponse::getCode() const
{
    return m_Code;
}


void DeleteNotificationCountResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool DeleteNotificationCountResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void DeleteNotificationCountResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t DeleteNotificationCountResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void DeleteNotificationCountResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool DeleteNotificationCountResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void DeleteNotificationCountResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t DeleteNotificationCountResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void DeleteNotificationCountResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool DeleteNotificationCountResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void DeleteNotificationCountResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t DeleteNotificationCountResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void DeleteNotificationCountResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool DeleteNotificationCountResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void DeleteNotificationCountResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t DeleteNotificationCountResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void DeleteNotificationCountResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool DeleteNotificationCountResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void DeleteNotificationCountResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> DeleteNotificationCountResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void DeleteNotificationCountResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool DeleteNotificationCountResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void DeleteNotificationCountResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
