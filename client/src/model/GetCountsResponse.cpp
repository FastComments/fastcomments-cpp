...
GetCountsResponse::GetCountsResponse()
{
    m_TotalCount = 0.0;
...
void GetCountsResponse::validate()
{
    // TODO: implement validation
}

web::json::value GetCountsResponse::toJson() const
{
...
bool GetCountsResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetCountsResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetCountsResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
double GetCountsResponse::getTotalCount() const
{
    return m_TotalCount;
}

void GetCountsResponse::setTotalCount(double value)
{
    m_TotalCount = value;
    m_TotalCountIsSet = true;
}

bool GetCountsResponse::totalCountIsSet() const
{
    return m_TotalCountIsSet;
}

void GetCountsResponse::unsetTotalCount()
{
    m_TotalCountIsSet = false;
}
std::shared_ptr<APIStatus> GetCountsResponse::getStatus() const
{
    return m_Status;
}


void GetCountsResponse::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetCountsResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetCountsResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetCountsResponse::getReason() const
{
    return m_Reason;
}


void GetCountsResponse::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetCountsResponse::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetCountsResponse::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetCountsResponse::getCode() const
{
    return m_Code;
}


void GetCountsResponse::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetCountsResponse::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetCountsResponse::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetCountsResponse::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetCountsResponse::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetCountsResponse::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetCountsResponse::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetCountsResponse::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetCountsResponse::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetCountsResponse::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetCountsResponse::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetCountsResponse::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetCountsResponse::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetCountsResponse::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetCountsResponse::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetCountsResponse::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetCountsResponse::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetCountsResponse::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetCountsResponse::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetCountsResponse::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetCountsResponse::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetCountsResponse::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetCountsResponse::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
