...
GetFeedPostsResponse_1::GetFeedPostsResponse_1()
{
    m_StatusIsSet = false;
...
void GetFeedPostsResponse_1::validate()
{
    // TODO: implement validation
}

web::json::value GetFeedPostsResponse_1::toJson() const
{
...
bool GetFeedPostsResponse_1::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void GetFeedPostsResponse_1::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetFeedPostsResponse_1::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
std::shared_ptr<APIStatus> GetFeedPostsResponse_1::getStatus() const
{
    return m_Status;
}


void GetFeedPostsResponse_1::setStatus(const std::shared_ptr<APIStatus>& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetFeedPostsResponse_1::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetFeedPostsResponse_1::unsetStatus()
{
    m_StatusIsSet = false;
}
std::vector<std::shared_ptr<FeedPost>> GetFeedPostsResponse_1::getFeedPosts() const
{
    return m_FeedPosts;
}


void GetFeedPostsResponse_1::setFeedPosts(const std::vector<std::shared_ptr<FeedPost>>& value)
{
    m_FeedPosts = value;
    m_FeedPostsIsSet = true;
}

bool GetFeedPostsResponse_1::feedPostsIsSet() const
{
    return m_FeedPostsIsSet;
}

void GetFeedPostsResponse_1::unsetFeedPosts()
{
    m_FeedPostsIsSet = false;
}
utility::string_t GetFeedPostsResponse_1::getReason() const
{
    return m_Reason;
}


void GetFeedPostsResponse_1::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool GetFeedPostsResponse_1::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void GetFeedPostsResponse_1::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t GetFeedPostsResponse_1::getCode() const
{
    return m_Code;
}


void GetFeedPostsResponse_1::setCode(const utility::string_t& value)
{
    m_Code = value;
    m_CodeIsSet = true;
}

bool GetFeedPostsResponse_1::codeIsSet() const
{
    return m_CodeIsSet;
}

void GetFeedPostsResponse_1::unsetCode()
{
    m_CodeIsSet = false;
}
utility::string_t GetFeedPostsResponse_1::getSecondaryCode() const
{
    return m_SecondaryCode;
}


void GetFeedPostsResponse_1::setSecondaryCode(const utility::string_t& value)
{
    m_SecondaryCode = value;
    m_SecondaryCodeIsSet = true;
}

bool GetFeedPostsResponse_1::secondaryCodeIsSet() const
{
    return m_SecondaryCodeIsSet;
}

void GetFeedPostsResponse_1::unsetSecondaryCode()
{
    m_SecondaryCodeIsSet = false;
}
int64_t GetFeedPostsResponse_1::getBannedUntil() const
{
    return m_BannedUntil;
}

void GetFeedPostsResponse_1::setBannedUntil(int64_t value)
{
    m_BannedUntil = value;
    m_BannedUntilIsSet = true;
}

bool GetFeedPostsResponse_1::bannedUntilIsSet() const
{
    return m_BannedUntilIsSet;
}

void GetFeedPostsResponse_1::unsetBannedUntil()
{
    m_BannedUntilIsSet = false;
}
int32_t GetFeedPostsResponse_1::getMaxCharacterLength() const
{
    return m_MaxCharacterLength;
}

void GetFeedPostsResponse_1::setMaxCharacterLength(int32_t value)
{
    m_MaxCharacterLength = value;
    m_MaxCharacterLengthIsSet = true;
}

bool GetFeedPostsResponse_1::maxCharacterLengthIsSet() const
{
    return m_MaxCharacterLengthIsSet;
}

void GetFeedPostsResponse_1::unsetMaxCharacterLength()
{
    m_MaxCharacterLengthIsSet = false;
}
utility::string_t GetFeedPostsResponse_1::getTranslatedError() const
{
    return m_TranslatedError;
}


void GetFeedPostsResponse_1::setTranslatedError(const utility::string_t& value)
{
    m_TranslatedError = value;
    m_TranslatedErrorIsSet = true;
}

bool GetFeedPostsResponse_1::translatedErrorIsSet() const
{
    return m_TranslatedErrorIsSet;
}

void GetFeedPostsResponse_1::unsetTranslatedError()
{
    m_TranslatedErrorIsSet = false;
}
std::shared_ptr<CustomConfigParameters> GetFeedPostsResponse_1::getCustomConfig() const
{
    return m_CustomConfig;
}


void GetFeedPostsResponse_1::setCustomConfig(const std::shared_ptr<CustomConfigParameters>& value)
{
    m_CustomConfig = value;
    m_CustomConfigIsSet = true;
}

bool GetFeedPostsResponse_1::customConfigIsSet() const
{
    return m_CustomConfigIsSet;
}

void GetFeedPostsResponse_1::unsetCustomConfig()
{
    m_CustomConfigIsSet = false;
}
