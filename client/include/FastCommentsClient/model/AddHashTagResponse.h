...
/*
 * AddHashTagResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_AddHashTagResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_AddHashTagResponse_H_
...
class  AddHashTagResponse
    : public ModelBase
{
public:
    AddHashTagResponse();
    virtual ~AddHashTagResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_AddHashTagResponse_H_ */
