...
/*
 * GetHashTagsResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetHashTagsResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetHashTagsResponse_1_H_
...
class  GetHashTagsResponse_1
    : public ModelBase
{
public:
    GetHashTagsResponse_1();
    virtual ~GetHashTagsResponse_1();
    ...
    std::vector<std::shared_ptr<TenantHashTag>> getHashTags() const;
    bool hashTagsIsSet() const;
    void unsetHashTags();
    void setHashTags(const std::vector<std::shared_ptr<TenantHashTag>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<TenantHashTag>> m_HashTags;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetHashTagsResponse_1_H_ */
