...
/*
 * PutAwardBadgeResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PutAwardBadgeResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PutAwardBadgeResponse_H_
...
class  PutAwardBadgeResponse
    : public ModelBase
{
public:
    PutAwardBadgeResponse();
    virtual ~PutAwardBadgeResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PutAwardBadgeResponse_H_ */
