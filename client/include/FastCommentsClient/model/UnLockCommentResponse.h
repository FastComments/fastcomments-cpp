...
/*
 * UnLockCommentResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UnLockCommentResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UnLockCommentResponse_H_
...
class  UnLockCommentResponse
    : public ModelBase
{
public:
    UnLockCommentResponse();
    virtual ~UnLockCommentResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UnLockCommentResponse_H_ */
