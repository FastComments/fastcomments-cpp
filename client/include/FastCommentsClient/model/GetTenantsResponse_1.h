...
/*
 * GetTenantsResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetTenantsResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetTenantsResponse_1_H_
...
class  GetTenantsResponse_1
    : public ModelBase
{
public:
    GetTenantsResponse_1();
    virtual ~GetTenantsResponse_1();
    ...
    std::vector<std::shared_ptr<APITenant>> getTenants() const;
    bool tenantsIsSet() const;
    void unsetTenants();
    void setTenants(const std::vector<std::shared_ptr<APITenant>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<APITenant>> m_Tenants;
    bool m_TenantsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetTenantsResponse_1_H_ */
