...
/*
 * SetTrustFactorResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SetTrustFactorResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SetTrustFactorResponse_H_
...
class  SetTrustFactorResponse
    : public ModelBase
{
public:
    SetTrustFactorResponse();
    virtual ~SetTrustFactorResponse();
    ...
    /////////////////////////////////////////////
    /// SetTrustFactorResponse members


    double getPreviousManualTrustFactor() const;
    bool previousManualTrustFactorIsSet() const;
    void unsetPreviousManualTrustFactor();
    void setPreviousManualTrustFactor(double value);
...
protected:
    double m_PreviousManualTrustFactor;
    bool m_PreviousManualTrustFactorIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SetTrustFactorResponse_H_ */
