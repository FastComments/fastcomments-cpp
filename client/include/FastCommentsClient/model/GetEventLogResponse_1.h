...
/*
 * GetEventLogResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetEventLogResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetEventLogResponse_1_H_
...
class  GetEventLogResponse_1
    : public ModelBase
{
public:
    GetEventLogResponse_1();
    virtual ~GetEventLogResponse_1();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetEventLogResponse_1_H_ */
