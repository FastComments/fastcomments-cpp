...
/*
 * CreateTenantPackageResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CreateTenantPackageResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CreateTenantPackageResponse_1_H_
...
class  CreateTenantPackageResponse_1
    : public ModelBase
{
public:
    CreateTenantPackageResponse_1();
    virtual ~CreateTenantPackageResponse_1();
    ...
    /////////////////////////////////////////////
    /// CreateTenantPackageResponse_1 members
    ...
    std::shared_ptr<TenantPackage> getTenantPackage() const;
    bool tenantPackageIsSet() const;
    void unsetTenantPackage();
    void setTenantPackage(const std::shared_ptr<TenantPackage>& value);
...
protected:
    ...
    std::shared_ptr<TenantPackage> m_TenantPackage;
    bool m_TenantPackageIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CreateTenantPackageResponse_1_H_ */
