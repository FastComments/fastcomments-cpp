...
/*
 * GetTicketResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetTicketResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetTicketResponse_1_H_
...
class  GetTicketResponse_1
    : public ModelBase
{
public:
    GetTicketResponse_1();
    virtual ~GetTicketResponse_1();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetTicketResponse_1_H_ */
