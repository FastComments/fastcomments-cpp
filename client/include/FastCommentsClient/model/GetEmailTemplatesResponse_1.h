...
/*
 * GetEmailTemplatesResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetEmailTemplatesResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetEmailTemplatesResponse_1_H_
...
class  GetEmailTemplatesResponse_1
    : public ModelBase
{
public:
    GetEmailTemplatesResponse_1();
    virtual ~GetEmailTemplatesResponse_1();
    ...
    /////////////////////////////////////////////
    /// GetEmailTemplatesResponse_1 members
    ...
    std::vector<std::shared_ptr<CustomEmailTemplate>> getEmailTemplates() const;
    bool emailTemplatesIsSet() const;
    void unsetEmailTemplates();
    void setEmailTemplates(const std::vector<std::shared_ptr<CustomEmailTemplate>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<CustomEmailTemplate>> m_EmailTemplates;
    bool m_EmailTemplatesIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetEmailTemplatesResponse_1_H_ */
