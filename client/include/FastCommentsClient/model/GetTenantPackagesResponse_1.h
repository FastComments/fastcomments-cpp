...
/*
 * GetTenantPackagesResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetTenantPackagesResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetTenantPackagesResponse_1_H_
...
class  GetTenantPackagesResponse_1
    : public ModelBase
{
public:
    GetTenantPackagesResponse_1();
    virtual ~GetTenantPackagesResponse_1();
    ...
    /////////////////////////////////////////////
    /// GetTenantPackagesResponse_1 members
    ...
    std::vector<std::shared_ptr<TenantPackage>> getTenantPackages() const;
    bool tenantPackagesIsSet() const;
    void unsetTenantPackages();
    void setTenantPackages(const std::vector<std::shared_ptr<TenantPackage>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<TenantPackage>> m_TenantPackages;
    bool m_TenantPackagesIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetTenantPackagesResponse_1_H_ */
