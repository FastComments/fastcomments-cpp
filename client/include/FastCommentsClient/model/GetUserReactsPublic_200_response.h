...
/*
 * GetUserReactsPublic_200_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetUserReactsPublic_200_response_H_
...
class  GetUserReactsPublic_200_response
    : public ModelBase
{
public:
    GetUserReactsPublic_200_response();
    virtual ~GetUserReactsPublic_200_response();
