...
/*
 * PostAdjustCommentVotesResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PostAdjustCommentVotesResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PostAdjustCommentVotesResponse_H_
...
class  PostAdjustCommentVotesResponse
    : public ModelBase
{
public:
    PostAdjustCommentVotesResponse();
    virtual ~PostAdjustCommentVotesResponse();
    ...
    /////////////////////////////////////////////
    /// PostAdjustCommentVotesResponse members
    ...
    int32_t getNewCommentVotes() const;
    bool newCommentVotesIsSet() const;
    void unsetNewCommentVotes();
    void setNewCommentVotes(int32_t value);
...
protected:
    ...
    int32_t m_NewCommentVotes;
    bool m_NewCommentVotesIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PostAdjustCommentVotesResponse_H_ */
