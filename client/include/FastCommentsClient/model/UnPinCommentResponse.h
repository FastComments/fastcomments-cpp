...
/*
 * UnPinCommentResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UnPinCommentResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UnPinCommentResponse_H_
...
class  UnPinCommentResponse
    : public ModelBase
{
public:
    UnPinCommentResponse();
    virtual ~UnPinCommentResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UnPinCommentResponse_H_ */
