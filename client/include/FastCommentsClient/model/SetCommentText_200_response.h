...
/*
 * SetCommentText_200_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SetCommentText_200_response_H_
...
class  SetCommentText_200_response
    : public ModelBase
{
public:
    SetCommentText_200_response();
    virtual ~SetCommentText_200_response();
