...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetCountsResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetCountsResponse_H_
...
class  GetCountsResponse
    : public ModelBase
{
public:
    GetCountsResponse();
    virtual ~GetCountsResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetCountsResponse_H_ */
