...
/*
 * LockCommentResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_LockCommentResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_LockCommentResponse_H_
...
class  LockCommentResponse
    : public ModelBase
{
public:
    LockCommentResponse();
    virtual ~LockCommentResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_LockCommentResponse_H_ */
