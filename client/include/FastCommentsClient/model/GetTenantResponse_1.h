...
/*
 * GetTenantResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetTenantResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetTenantResponse_1_H_
...
class  GetTenantResponse_1
    : public ModelBase
{
public:
    GetTenantResponse_1();
    virtual ~GetTenantResponse_1();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetTenantResponse_1_H_ */
