...
/*
 * GetManualBadgesForUserResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetManualBadgesForUserResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetManualBadgesForUserResponse_H_
...
class  GetManualBadgesForUserResponse
    : public ModelBase
{
public:
    GetManualBadgesForUserResponse();
    virtual ~GetManualBadgesForUserResponse();
    ...
    /////////////////////////////////////////////
    /// GetManualBadgesForUserResponse members


    std::vector<std::shared_ptr<UserBadge>> getBadges() const;
    bool badgesIsSet() const;
    void unsetBadges();
    void setBadges(const std::vector<std::shared_ptr<UserBadge>>& value);
...
protected:
    std::vector<std::shared_ptr<UserBadge>> m_Badges;
    bool m_BadgesIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetManualBadgesForUserResponse_H_ */
