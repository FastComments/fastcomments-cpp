...
/*
 * GetVotesResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetVotesResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetVotesResponse_1_H_
...
class  GetVotesResponse_1
    : public ModelBase
{
public:
    GetVotesResponse_1();
    virtual ~GetVotesResponse_1();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetVotesResponse_1_H_ */
