...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetUserResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetUserResponse_1_H_
...
class  GetUserResponse_1
    : public ModelBase
{
public:
    GetUserResponse_1();
    virtual ~GetUserResponse_1();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetUserResponse_1_H_ */
