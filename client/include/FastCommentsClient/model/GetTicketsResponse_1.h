...
/*
 * GetTicketsResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetTicketsResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetTicketsResponse_1_H_
...
class  GetTicketsResponse_1
    : public ModelBase
{
public:
    GetTicketsResponse_1();
    virtual ~GetTicketsResponse_1();
    ...
    std::vector<std::shared_ptr<APITicket>> getTickets() const;
    bool ticketsIsSet() const;
    void unsetTickets();
    void setTickets(const std::vector<std::shared_ptr<APITicket>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<APITicket>> m_Tickets;
    bool m_TicketsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetTicketsResponse_1_H_ */
