...
/*
 * SendLoginLinkResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SendLoginLinkResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SendLoginLinkResponse_H_
...
class  SendLoginLinkResponse
    : public ModelBase
{
public:
    SendLoginLinkResponse();
    virtual ~SendLoginLinkResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SendLoginLinkResponse_H_ */
