...
/*
 * GetGifLargeResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetGifLargeResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetGifLargeResponse_H_
...
class  GetGifLargeResponse
    : public ModelBase
{
public:
    GetGifLargeResponse();
    virtual ~GetGifLargeResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetGifLargeResponse_H_ */
