...
/*
 * DeleteHashTagResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_DeleteHashTagResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_DeleteHashTagResponse_H_
...
class  DeleteHashTagResponse
    : public ModelBase
{
public:
    DeleteHashTagResponse();
    virtual ~DeleteHashTagResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_DeleteHashTagResponse_H_ */
