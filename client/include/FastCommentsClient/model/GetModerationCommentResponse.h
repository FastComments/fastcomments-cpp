...
/*
 * GetModerationCommentResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetModerationCommentResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetModerationCommentResponse_H_
...
class  GetModerationCommentResponse
    : public ModelBase
{
public:
    GetModerationCommentResponse();
    virtual ~GetModerationCommentResponse();
    ...
    /////////////////////////////////////////////
    /// GetModerationCommentResponse members


    std::shared_ptr<ModerationAPIComment> getComment() const;
    bool commentIsSet() const;
    void unsetComment();
    void setComment(const std::shared_ptr<ModerationAPIComment>& value);
...
protected:
    std::shared_ptr<ModerationAPIComment> m_Comment;
    bool m_CommentIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetModerationCommentResponse_H_ */
