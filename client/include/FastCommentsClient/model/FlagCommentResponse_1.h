...
/*
 * FlagCommentResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_FlagCommentResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_FlagCommentResponse_1_H_
...
class  FlagCommentResponse_1
    : public ModelBase
{
public:
    FlagCommentResponse_1();
    virtual ~FlagCommentResponse_1();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_FlagCommentResponse_1_H_ */
