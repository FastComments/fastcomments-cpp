...
/*
 * GetNotificationsResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetNotificationsResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetNotificationsResponse_1_H_
...
class  GetNotificationsResponse_1
    : public ModelBase
{
public:
    GetNotificationsResponse_1();
    virtual ~GetNotificationsResponse_1();
    ...
    /////////////////////////////////////////////
    /// GetNotificationsResponse_1 members
    ...
    std::vector<std::shared_ptr<UserNotification>> getNotifications() const;
    bool notificationsIsSet() const;
    void unsetNotifications();
    void setNotifications(const std::vector<std::shared_ptr<UserNotification>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<UserNotification>> m_Notifications;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetNotificationsResponse_1_H_ */
