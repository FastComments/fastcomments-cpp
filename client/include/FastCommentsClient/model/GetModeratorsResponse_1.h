...
/*
 * GetModeratorsResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetModeratorsResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetModeratorsResponse_1_H_
...
class  GetModeratorsResponse_1
    : public ModelBase
{
public:
    GetModeratorsResponse_1();
    virtual ~GetModeratorsResponse_1();
    ...
    /////////////////////////////////////////////
    /// GetModeratorsResponse_1 members
    ...
    std::vector<std::shared_ptr<Moderator>> getModerators() const;
    bool moderatorsIsSet() const;
    void unsetModerators();
    void setModerators(const std::vector<std::shared_ptr<Moderator>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<Moderator>> m_Moderators;
    bool m_ModeratorsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetModeratorsResponse_1_H_ */
