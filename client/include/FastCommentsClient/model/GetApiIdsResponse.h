...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetApiIdsResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetApiIdsResponse_H_
...
class  GetApiIdsResponse
    : public ModelBase
{
public:
    GetApiIdsResponse();
    virtual ~GetApiIdsResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetApiIdsResponse_H_ */
