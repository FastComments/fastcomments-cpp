...
/*
 * GetCommentsForUserResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetCommentsForUserResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetCommentsForUserResponse_1_H_
...
class  GetCommentsForUserResponse_1
    : public ModelBase
{
public:
    GetCommentsForUserResponse_1();
    virtual ~GetCommentsForUserResponse_1();
    ...
    /////////////////////////////////////////////
    /// GetCommentsForUserResponse_1 members


    std::vector<utility::string_t> getModeratingTenantIds() const;
    bool moderatingTenantIdsIsSet() const;
    void unsetModeratingTenantIds();
    void setModeratingTenantIds(const std::vector<utility::string_t>& value);
...
protected:
    std::vector<utility::string_t> m_ModeratingTenantIds;
    bool m_ModeratingTenantIdsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetCommentsForUserResponse_1_H_ */
