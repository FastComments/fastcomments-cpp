...
/*
 * PatchHashTagResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PatchHashTagResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PatchHashTagResponse_H_
...
class  PatchHashTagResponse
    : public ModelBase
{
public:
    PatchHashTagResponse();
    virtual ~PatchHashTagResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PatchHashTagResponse_H_ */
