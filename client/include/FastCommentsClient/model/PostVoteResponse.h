...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PostVoteResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PostVoteResponse_H_
...
class  PostVoteResponse
    : public ModelBase
{
public:
    PostVoteResponse();
    virtual ~PostVoteResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PostVoteResponse_H_ */
