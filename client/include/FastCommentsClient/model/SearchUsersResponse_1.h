...
/*
 * SearchUsersResponse_1.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_SearchUsersResponse_1_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_SearchUsersResponse_1_H_
...
class  SearchUsersResponse_1
    : public ModelBase
{
public:
    SearchUsersResponse_1();
    virtual ~SearchUsersResponse_1();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_SearchUsersResponse_1_H_ */
