...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetLogsResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetLogsResponse_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// GetLogsResponse members


    std::vector<std::shared_ptr<ModerationAPICommentLog>> getLogs() const;
    bool logsIsSet() const;
    void unsetLogs();
    void setLogs(const std::vector<std::shared_ptr<ModerationAPICommentLog>>& value);
...
protected:
    std::vector<std::shared_ptr<ModerationAPICommentLog>> m_Logs;
    bool m_LogsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetLogsResponse_H_ */
