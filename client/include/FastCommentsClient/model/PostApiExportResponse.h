...
/*
 * PostApiExportResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PostApiExportResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PostApiExportResponse_H_
...
class  PostApiExportResponse
    : public ModelBase
{
public:
    PostApiExportResponse();
    virtual ~PostApiExportResponse();
    ...
    utility::string_t getBatchJobId() const;
    bool batchJobIdIsSet() const;
    void unsetBatchJobId();
    void setBatchJobId(const utility::string_t& value);
...
protected:
    ...
    utility::string_t m_BatchJobId;
    bool m_BatchJobIdIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PostApiExportResponse_H_ */
