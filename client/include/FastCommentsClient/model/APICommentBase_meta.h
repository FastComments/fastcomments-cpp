...
/*
 * APICommentBase_meta.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_APICommentBase_meta_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_APICommentBase_meta_H_
...
class  APICommentBase_meta
    : public ModelBase
{
public:
    APICommentBase_meta();
    virtual ~APICommentBase_meta();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_APICommentBase_meta_H_ */
