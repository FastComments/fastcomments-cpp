...
/*
 * PostSetCommentTextResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PostSetCommentTextResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PostSetCommentTextResponse_H_
...
class  PostSetCommentTextResponse
    : public ModelBase
{
public:
    PostSetCommentTextResponse();
    virtual ~PostSetCommentTextResponse();
    ...
    /////////////////////////////////////////////
    /// PostSetCommentTextResponse members


    utility::string_t getNewCommentTextHTML() const;
    bool newCommentTextHTMLIsSet() const;
    void unsetNewCommentTextHTML();
    void setNewCommentTextHTML(const utility::string_t& value);
...
protected:
    utility::string_t m_NewCommentTextHTML;
    bool m_NewCommentTextHTMLIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PostSetCommentTextResponse_H_ */
