...
/*
 * PinCommentResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PinCommentResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PinCommentResponse_H_
...
class  PinCommentResponse
    : public ModelBase
{
public:
    PinCommentResponse();
    virtual ~PinCommentResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PinCommentResponse_H_ */
