...
/*
 * GetUserBadgeResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetUserBadgeResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetUserBadgeResponse_H_
...
class  GetUserBadgeResponse
    : public ModelBase
{
public:
    GetUserBadgeResponse();
    virtual ~GetUserBadgeResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetUserBadgeResponse_H_ */
