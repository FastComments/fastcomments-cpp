...
/*
 * GetUserBadgesResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetUserBadgesResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetUserBadgesResponse_H_
...
class  GetUserBadgesResponse
    : public ModelBase
{
public:
    GetUserBadgesResponse();
    virtual ~GetUserBadgesResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetUserBadgesResponse_H_ */
