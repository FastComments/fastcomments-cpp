...
/*
 * UnFlagCommentResponse.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UnFlagCommentResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UnFlagCommentResponse_H_
...
class  UnFlagCommentResponse
    : public ModelBase
{
public:
    UnFlagCommentResponse();
    virtual ~UnFlagCommentResponse();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UnFlagCommentResponse_H_ */
